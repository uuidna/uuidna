...
/-- AN OBSTRUCTION AT MODULUS 7, REDUCED EXPONENT 3. For every unit a in [1,2,3,4,5,6] and every unit b coprime
    ...
    infinitely many triples sharing a factor with 7 pass through untouched, so the coprime half is what it
...
/-- AN OBSTRUCTION AT MODULUS 28, REDUCED EXPONENT 1. For every unit a in [1,3,5,9,11,13,15,17,19,23,25,27] and
    ...
    triples sharing a factor with 28 pass through untouched, so the coprime half is what it decides and the
...
/-- AN OBSTRUCTION AT MODULUS 28, REDUCED EXPONENT 6. For every unit a in [1,3,5,9,11,13,15,17,19,23,25,27] and
    ...
    classically Case I — and infinitely many triples sharing a factor with 28 pass through untouched, so the
...
/-- AN OBSTRUCTION AT MODULUS 49, REDUCED EXPONENT 3. For every unit a in
    ...
    a factor with 49 pass through untouched, so the coprime half is what it decides and the other half is
    untouched. -/
...
/-- AN OBSTRUCTION AT MODULUS 49, REDUCED EXPONENT 14. For every unit a in
    ...
    only — classically Case I — and infinitely many triples sharing a factor with 49 pass through untouched, so
...
/-- AN OBSTRUCTION AT MODULUS 70, REDUCED EXPONENT 1. For every unit a in
    ...
    I — and infinitely many triples sharing a factor with 70 pass through untouched, so the coprime half is what
...
/-- AN OBSTRUCTION AT MODULUS 70, REDUCED EXPONENT 3. For every unit a in
    ...
    Case I — and infinitely many triples sharing a factor with 70 pass through untouched, so the coprime half is
...
/-- AN OBSTRUCTION AT MODULUS 70, REDUCED EXPONENT 4. For every unit a in
    ...
    infinitely many triples sharing a factor with 70 pass through untouched, so the coprime half is what it
    decides and the other half is untouched. -/
...
/-- AN OBSTRUCTION AT MODULUS 70, REDUCED EXPONENT 12. For every unit a in
    ...
    conclusion from a finite table. It settles the coprime case only — classically Case I — and infinitely many
    triples sharing a factor with 70 pass through untouched, so the coprime half is what it decides and the
    other half is untouched. -/
...
/-- AN OBSTRUCTION AT MODULUS 91, REDUCED EXPONENT 3 — part 1 of 3. For every unit a in
    ...
    with 91 pass through untouched, so the coprime half is what it decides and the other half is untouched. -/
...
/-- AN OBSTRUCTION AT MODULUS 91, REDUCED EXPONENT 6 — part 1 of 3. For every unit a in
    ...
    classically Case I — and infinitely many triples sharing a factor with 91 pass through untouched, so the
    coprime half is what it decides and the other half is untouched. -/
...
/-- AN OBSTRUCTION AT MODULUS 112, REDUCED EXPONENT 3. For every unit a in
    ...
    sharing a factor with 112 pass through untouched, so the coprime half is what it decides and the other half
    is untouched. -/
