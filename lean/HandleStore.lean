...
/-- THE FOLDERS ARE THE NAME, NOT A ROUTE TO IT. Four levels of two hexadecimal digits concatenate to the
    ...
    the path spells the handle in 5,512 of 5,512 leaves. -/
...
/-- AND THE CAPACITY IS NOT A CLAIM ABOUT WHAT IS WRITTEN. The store carries 5,512 leaves against 4,294,967,296
    ...
    overstating itself by a factor of nearly eight hundred thousand. -/
theorem the_store_holds_far_less_than_it_admits : 5512 < 2 ^ 32 := by decide
