-- lean/Ring.lean — GENERATED by scripts/lean-tables.mjs. The RING ℤ/9 (the vortex) —
-- its full multiplication, addition and power tables. 234 theorems, every one `by decide`, sorry-free, no
