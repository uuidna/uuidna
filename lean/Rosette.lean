-- lean/Rosette.lean — GENERATED by scripts/lean-tables.mjs. The ROSETTE ℤ/7 (the Pliska group) —
-- its full multiplication, addition and power tables. 145 theorems, every one `by decide`, sorry-free, no
