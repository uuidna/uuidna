...
/-- THE STORE AS IT STANDS, WALKED RATHER THAN QUOTED. 71,639 leaves, 71,638 parent links, 2,566,037,341 pairs
    available — the tree uses one link for every 35,819 pairs its own leaves already permit. Stated as an
...
theorem the_measured_store_uses_a_vanishing_share : (2566037341 = (71639 * (71639 - 1)) / 2) ∧ (2566037341 > 2000 * 71638) := by decide
...
/-- AND THE FILES INSIDE ARE PLURAL, MEASURED. Of 71,639 leaves, 689 carry no theorem key, 70,870 carry 1 key,
...
theorem the_leaf_is_not_one_uuid_but_a_folder : (689 + 70870 + 75 + 5 = 71639) ∧ (80 > 0) := by decide

/-- THE FOLDERS ARE NOT ALL THE SAME THING EITHER: 70950 chunk, 437 page, 252 publication, summing to 71,639
...
theorem three_kinds_partition_the_store : 70950 + 437 + 252 = 71639 := by decide
