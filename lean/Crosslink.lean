...
/-- THE STORE AS IT STANDS, WALKED RATHER THAN QUOTED. 71,508 leaves, 71,507 parent links, 2,556,661,278 pairs
    available — the tree uses one link for every 35,754 pairs its own leaves already permit. Stated as an
...
theorem the_measured_store_uses_a_vanishing_share : (2556661278 = (71508 * (71508 - 1)) / 2) ∧ (2556661278 > 2000 * 71507) := by decide
...
/-- AND THE FILES INSIDE ARE PLURAL, MEASURED. Of 71,508 leaves, 661 carry no theorem key, 70,768 carry 1 key,
...
theorem the_leaf_is_not_one_uuid_but_a_folder : (661 + 70768 + 74 + 5 = 71508) ∧ (79 > 0) := by decide

/-- THE FOLDERS ARE NOT ALL THE SAME THING EITHER: 70847 chunk, 422 page, 239 publication, summing to 71,508
...
theorem three_kinds_partition_the_store : 70847 + 422 + 239 = 71508 := by decide
