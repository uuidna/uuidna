...
/-- THE STORE AS IT STANDS, WALKED RATHER THAN QUOTED. 71,626 leaves, 71,625 parent links, 2,565,106,125 pairs
    available — the tree uses one link for every 35,813 pairs its own leaves already permit. Stated as an
...
theorem the_measured_store_uses_a_vanishing_share : (2565106125 = (71626 * (71626 - 1)) / 2) ∧ (2565106125 > 2000 * 71625) := by decide
...
/-- AND THE FILES INSIDE ARE PLURAL, MEASURED. Of 71,626 leaves, 689 carry no theorem key, 70,857 carry 1 key,
...
theorem the_leaf_is_not_one_uuid_but_a_folder : (689 + 70857 + 75 + 5 = 71626) ∧ (80 > 0) := by decide

/-- THE FOLDERS ARE NOT ALL THE SAME THING EITHER: 70937 chunk, 437 page, 252 publication, summing to 71,626
...
theorem three_kinds_partition_the_store : 70937 + 437 + 252 = 71626 := by decide
