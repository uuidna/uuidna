...
/-- THE STORE AS IT STANDS, WALKED RATHER THAN QUOTED. 71,521 leaves, 71,520 parent links, 2,557,590,960 pairs
    available — the tree uses one link for every 35,760 pairs its own leaves already permit. Stated as an
...
theorem the_measured_store_uses_a_vanishing_share : (2557590960 = (71521 * (71521 - 1)) / 2) ∧ (2557590960 > 2000 * 71520) := by decide
...
/-- AND THE FILES INSIDE ARE PLURAL, MEASURED. Of 71,521 leaves, 667 carry no theorem key, 70,775 carry 1 key,
    74 carry 2 keys, 5 carry 3 keys — 79 carry more than one, so a handle folder is a folder and not a synonym
...
theorem the_leaf_is_not_one_uuid_but_a_folder : (667 + 70775 + 74 + 5 = 71521) ∧ (79 > 0) := by decide

/-- THE FOLDERS ARE NOT ALL THE SAME THING EITHER: 70854 chunk, 425 page, 242 publication, summing to 71,521
...
theorem three_kinds_partition_the_store : 70854 + 425 + 242 = 71521 := by decide
