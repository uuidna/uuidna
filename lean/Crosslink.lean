...
/-- THE STORE AS IT STANDS, WALKED RATHER THAN QUOTED. 71,366 leaves, 71,365 parent links, 2,546,517,295 pairs
    available — the tree uses one link for every 35,683 pairs its own leaves already permit. Stated as an
...
theorem the_measured_store_uses_a_vanishing_share : (2546517295 = (71366 * (71366 - 1)) / 2) ∧ (2546517295 > 2000 * 71365) := by decide
...
/-- AND THE FILES INSIDE ARE PLURAL, MEASURED. Of 71,366 leaves, 539 carry no theorem key, 70,749 carry 1 key,
    73 carry 2 keys, 5 carry 3 keys — 78 carry more than one, so a handle folder is a folder and not a synonym
...
theorem the_leaf_is_not_one_uuid_but_a_folder : (539 + 70749 + 73 + 5 = 71366) ∧ (78 > 0) := by decide

/-- THE FOLDERS ARE NOT ALL THE SAME THING EITHER: 70827 chunk, 361 page, 178 publication, summing to 71,366
...
theorem three_kinds_partition_the_store : 70827 + 361 + 178 = 71366 := by decide
