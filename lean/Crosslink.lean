...
/-- THE STORE AS IT STANDS, WALKED RATHER THAN QUOTED. 71,622 leaves, 71,621 parent links, 2,564,819,631 pairs
    available — the tree uses one link for every 35,811 pairs its own leaves already permit. Stated as an
...
theorem the_measured_store_uses_a_vanishing_share : (2564819631 = (71622 * (71622 - 1)) / 2) ∧ (2564819631 > 2000 * 71621) := by decide
...
/-- AND THE FILES INSIDE ARE PLURAL, MEASURED. Of 71,622 leaves, 689 carry no theorem key, 70,853 carry 1 key,
...
theorem the_leaf_is_not_one_uuid_but_a_folder : (689 + 70853 + 75 + 5 = 71622) ∧ (80 > 0) := by decide

/-- THE FOLDERS ARE NOT ALL THE SAME THING EITHER: 70933 chunk, 437 page, 252 publication, summing to 71,622
...
theorem three_kinds_partition_the_store : 70933 + 437 + 252 = 71622 := by decide
