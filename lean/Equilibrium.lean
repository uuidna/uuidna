...
/-- AND THE TRANSLATION IS AN AUTOMORPHISM, for the translation by 0: translating both ends of a pair by the
    ...
    all four thousand and ninety-six ordered pairs. Transitivity needs both halves — a map that reaches every
...
/-- AND THE TRANSLATION IS AN AUTOMORPHISM, for the translation by 24: translating both ends of a pair by the
    same cell leaves their difference unchanged, so an edge stays an edge and a non-edge stays a non-edge, over
    all four thousand and ninety-six ordered pairs. Transitivity needs both halves — a map that reaches every
    vertex but does not preserve the edges is not a symmetry of the graph, and reaching was shown separately. -/
theorem xor_translation_preserves_adjacency_24 : (List.range 64).all (fun c => (List.range 64).all (fun d => lxor (lxor c 24) (lxor d 24) == lxor c d)) := by decide

/-- AND THE TRANSLATION IS AN AUTOMORPHISM, for the translation by 25: translating both ends of a pair by the
    same cell leaves their difference unchanged, so an edge stays an edge and a non-edge stays a non-edge, over
    all four thousand and ninety-six ordered pairs. Transitivity needs both halves — a map that reaches every
    vertex but does not preserve the edges is not a symmetry of the graph, and reaching was shown separately. -/
theorem xor_translation_preserves_adjacency_25 : (List.range 64).all (fun c => (List.range 64).all (fun d => lxor (lxor c 25) (lxor d 25) == lxor c d)) := by decide

/-- AND THE TRANSLATION IS AN AUTOMORPHISM, for the translation by 26: translating both ends of a pair by the
    same cell leaves their difference unchanged, so an edge stays an edge and a non-edge stays a non-edge, over
    all four thousand and ninety-six ordered pairs. Transitivity needs both halves — a map that reaches every
    vertex but does not preserve the edges is not a symmetry of the graph, and reaching was shown separately. -/
theorem xor_translation_preserves_adjacency_26 : (List.range 64).all (fun c => (List.range 64).all (fun d => lxor (lxor c 26) (lxor d 26) == lxor c d)) := by decide

/-- AND THE TRANSLATION IS AN AUTOMORPHISM, for the translation by 27: translating both ends of a pair by the
    same cell leaves their difference unchanged, so an edge stays an edge and a non-edge stays a non-edge, over
    all four thousand and ninety-six ordered pairs. Transitivity needs both halves — a map that reaches every
    vertex but does not preserve the edges is not a symmetry of the graph, and reaching was shown separately. -/
theorem xor_translation_preserves_adjacency_27 : (List.range 64).all (fun c => (List.range 64).all (fun d => lxor (lxor c 27) (lxor d 27) == lxor c d)) := by decide

/-- AND THE TRANSLATION IS AN AUTOMORPHISM, for the translation by 28: translating both ends of a pair by the
    same cell leaves their difference unchanged, so an edge stays an edge and a non-edge stays a non-edge, over
    all four thousand and ninety-six ordered pairs. Transitivity needs both halves — a map that reaches every
    vertex but does not preserve the edges is not a symmetry of the graph, and reaching was shown separately. -/
theorem xor_translation_preserves_adjacency_28 : (List.range 64).all (fun c => (List.range 64).all (fun d => lxor (lxor c 28) (lxor d 28) == lxor c d)) := by decide

/-- AND THE TRANSLATION IS AN AUTOMORPHISM, for the translation by 29: translating both ends of a pair by the
    same cell leaves their difference unchanged, so an edge stays an edge and a non-edge stays a non-edge, over
    all four thousand and ninety-six ordered pairs. Transitivity needs both halves — a map that reaches every
    vertex but does not preserve the edges is not a symmetry of the graph, and reaching was shown separately. -/
theorem xor_translation_preserves_adjacency_29 : (List.range 64).all (fun c => (List.range 64).all (fun d => lxor (lxor c 29) (lxor d 29) == lxor c d)) := by decide

/-- AND THE TRANSLATION IS AN AUTOMORPHISM, for the translation by 30: translating both ends of a pair by the
    same cell leaves their difference unchanged, so an edge stays an edge and a non-edge stays a non-edge, over
    all four thousand and ninety-six ordered pairs. Transitivity needs both halves — a map that reaches every
    vertex but does not preserve the edges is not a symmetry of the graph, and reaching was shown separately. -/
theorem xor_translation_preserves_adjacency_30 : (List.range 64).all (fun c => (List.range 64).all (fun d => lxor (lxor c 30) (lxor d 30) == lxor c d)) := by decide

/-- AND THE TRANSLATION IS AN AUTOMORPHISM, for the translation by 31: translating both ends of a pair by the
    same cell leaves their difference unchanged, so an edge stays an edge and a non-edge stays a non-edge, over
    all four thousand and ninety-six ordered pairs. Transitivity needs both halves — a map that reaches every
    vertex but does not preserve the edges is not a symmetry of the graph, and reaching was shown separately. -/
theorem xor_translation_preserves_adjacency_31 : (List.range 64).all (fun c => (List.range 64).all (fun d => lxor (lxor c 31) (lxor d 31) == lxor c d)) := by decide
...
/-- AND THE TRANSLATION IS AN AUTOMORPHISM, for the translation by 40: translating both ends of a pair by the
    same cell leaves their difference unchanged, so an edge stays an edge and a non-edge stays a non-edge, over
    all four thousand and ninety-six ordered pairs. Transitivity needs both halves — a map that reaches every
    vertex but does not preserve the edges is not a symmetry of the graph, and reaching was shown separately. -/
theorem xor_translation_preserves_adjacency_40 : (List.range 64).all (fun c => (List.range 64).all (fun d => lxor (lxor c 40) (lxor d 40) == lxor c d)) := by decide

/-- AND THE TRANSLATION IS AN AUTOMORPHISM, for the translation by 41: translating both ends of a pair by the
    same cell leaves their difference unchanged, so an edge stays an edge and a non-edge stays a non-edge, over
    all four thousand and ninety-six ordered pairs. Transitivity needs both halves — a map that reaches every
    vertex but does not preserve the edges is not a symmetry of the graph, and reaching was shown separately. -/
theorem xor_translation_preserves_adjacency_41 : (List.range 64).all (fun c => (List.range 64).all (fun d => lxor (lxor c 41) (lxor d 41) == lxor c d)) := by decide

/-- AND THE TRANSLATION IS AN AUTOMORPHISM, for the translation by 42: translating both ends of a pair by the
    same cell leaves their difference unchanged, so an edge stays an edge and a non-edge stays a non-edge, over
    all four thousand and ninety-six ordered pairs. Transitivity needs both halves — a map that reaches every
    vertex but does not preserve the edges is not a symmetry of the graph, and reaching was shown separately. -/
theorem xor_translation_preserves_adjacency_42 : (List.range 64).all (fun c => (List.range 64).all (fun d => lxor (lxor c 42) (lxor d 42) == lxor c d)) := by decide

/-- AND THE TRANSLATION IS AN AUTOMORPHISM, for the translation by 43: translating both ends of a pair by the
    same cell leaves their difference unchanged, so an edge stays an edge and a non-edge stays a non-edge, over
    all four thousand and ninety-six ordered pairs. Transitivity needs both halves — a map that reaches every
    vertex but does not preserve the edges is not a symmetry of the graph, and reaching was shown separately. -/
theorem xor_translation_preserves_adjacency_43 : (List.range 64).all (fun c => (List.range 64).all (fun d => lxor (lxor c 43) (lxor d 43) == lxor c d)) := by decide

/-- AND THE TRANSLATION IS AN AUTOMORPHISM, for the translation by 44: translating both ends of a pair by the
    same cell leaves their difference unchanged, so an edge stays an edge and a non-edge stays a non-edge, over
    all four thousand and ninety-six ordered pairs. Transitivity needs both halves — a map that reaches every
    vertex but does not preserve the edges is not a symmetry of the graph, and reaching was shown separately. -/
theorem xor_translation_preserves_adjacency_44 : (List.range 64).all (fun c => (List.range 64).all (fun d => lxor (lxor c 44) (lxor d 44) == lxor c d)) := by decide

/-- AND THE TRANSLATION IS AN AUTOMORPHISM, for the translation by 45: translating both ends of a pair by the
    same cell leaves their difference unchanged, so an edge stays an edge and a non-edge stays a non-edge, over
    all four thousand and ninety-six ordered pairs. Transitivity needs both halves — a map that reaches every
    vertex but does not preserve the edges is not a symmetry of the graph, and reaching was shown separately. -/
theorem xor_translation_preserves_adjacency_45 : (List.range 64).all (fun c => (List.range 64).all (fun d => lxor (lxor c 45) (lxor d 45) == lxor c d)) := by decide

/-- AND THE TRANSLATION IS AN AUTOMORPHISM, for the translation by 46: translating both ends of a pair by the
    same cell leaves their difference unchanged, so an edge stays an edge and a non-edge stays a non-edge, over
    all four thousand and ninety-six ordered pairs. Transitivity needs both halves — a map that reaches every
    vertex but does not preserve the edges is not a symmetry of the graph, and reaching was shown separately. -/
theorem xor_translation_preserves_adjacency_46 : (List.range 64).all (fun c => (List.range 64).all (fun d => lxor (lxor c 46) (lxor d 46) == lxor c d)) := by decide

/-- AND THE TRANSLATION IS AN AUTOMORPHISM, for the translation by 47: translating both ends of a pair by the
    same cell leaves their difference unchanged, so an edge stays an edge and a non-edge stays a non-edge, over
    all four thousand and ninety-six ordered pairs. Transitivity needs both halves — a map that reaches every
    vertex but does not preserve the edges is not a symmetry of the graph, and reaching was shown separately. -/
theorem xor_translation_preserves_adjacency_47 : (List.range 64).all (fun c => (List.range 64).all (fun d => lxor (lxor c 47) (lxor d 47) == lxor c d)) := by decide
...
/-- AND THE TRANSLATION IS AN AUTOMORPHISM, for the translation by 56: translating both ends of a pair by the
    same cell leaves their difference unchanged, so an edge stays an edge and a non-edge stays a non-edge, over
    all four thousand and ninety-six ordered pairs. Transitivity needs both halves — a map that reaches every
    vertex but does not preserve the edges is not a symmetry of the graph, and reaching was shown separately. -/
theorem xor_translation_preserves_adjacency_56 : (List.range 64).all (fun c => (List.range 64).all (fun d => lxor (lxor c 56) (lxor d 56) == lxor c d)) := by decide

/-- AND THE TRANSLATION IS AN AUTOMORPHISM, for the translation by 57: translating both ends of a pair by the
    same cell leaves their difference unchanged, so an edge stays an edge and a non-edge stays a non-edge, over
    all four thousand and ninety-six ordered pairs. Transitivity needs both halves — a map that reaches every
    vertex but does not preserve the edges is not a symmetry of the graph, and reaching was shown separately. -/
theorem xor_translation_preserves_adjacency_57 : (List.range 64).all (fun c => (List.range 64).all (fun d => lxor (lxor c 57) (lxor d 57) == lxor c d)) := by decide

/-- AND THE TRANSLATION IS AN AUTOMORPHISM, for the translation by 58: translating both ends of a pair by the
    same cell leaves their difference unchanged, so an edge stays an edge and a non-edge stays a non-edge, over
    all four thousand and ninety-six ordered pairs. Transitivity needs both halves — a map that reaches every
    vertex but does not preserve the edges is not a symmetry of the graph, and reaching was shown separately. -/
theorem xor_translation_preserves_adjacency_58 : (List.range 64).all (fun c => (List.range 64).all (fun d => lxor (lxor c 58) (lxor d 58) == lxor c d)) := by decide

/-- AND THE TRANSLATION IS AN AUTOMORPHISM, for the translation by 59: translating both ends of a pair by the
    same cell leaves their difference unchanged, so an edge stays an edge and a non-edge stays a non-edge, over
    all four thousand and ninety-six ordered pairs. Transitivity needs both halves — a map that reaches every
    vertex but does not preserve the edges is not a symmetry of the graph, and reaching was shown separately. -/
theorem xor_translation_preserves_adjacency_59 : (List.range 64).all (fun c => (List.range 64).all (fun d => lxor (lxor c 59) (lxor d 59) == lxor c d)) := by decide

/-- AND THE TRANSLATION IS AN AUTOMORPHISM, for the translation by 60: translating both ends of a pair by the
    same cell leaves their difference unchanged, so an edge stays an edge and a non-edge stays a non-edge, over
    all four thousand and ninety-six ordered pairs. Transitivity needs both halves — a map that reaches every
    vertex but does not preserve the edges is not a symmetry of the graph, and reaching was shown separately. -/
theorem xor_translation_preserves_adjacency_60 : (List.range 64).all (fun c => (List.range 64).all (fun d => lxor (lxor c 60) (lxor d 60) == lxor c d)) := by decide

/-- AND THE TRANSLATION IS AN AUTOMORPHISM, for the translation by 61: translating both ends of a pair by the
    same cell leaves their difference unchanged, so an edge stays an edge and a non-edge stays a non-edge, over
    all four thousand and ninety-six ordered pairs. Transitivity needs both halves — a map that reaches every
    vertex but does not preserve the edges is not a symmetry of the graph, and reaching was shown separately. -/
theorem xor_translation_preserves_adjacency_61 : (List.range 64).all (fun c => (List.range 64).all (fun d => lxor (lxor c 61) (lxor d 61) == lxor c d)) := by decide

/-- AND THE TRANSLATION IS AN AUTOMORPHISM, for the translation by 62: translating both ends of a pair by the
    same cell leaves their difference unchanged, so an edge stays an edge and a non-edge stays a non-edge, over
    all four thousand and ninety-six ordered pairs. Transitivity needs both halves — a map that reaches every
    vertex but does not preserve the edges is not a symmetry of the graph, and reaching was shown separately. -/
theorem xor_translation_preserves_adjacency_62 : (List.range 64).all (fun c => (List.range 64).all (fun d => lxor (lxor c 62) (lxor d 62) == lxor c d)) := by decide

/-- AND THE TRANSLATION IS AN AUTOMORPHISM, for the translation by 63: translating both ends of a pair by the
    same cell leaves their difference unchanged, so an edge stays an edge and a non-edge stays a non-edge, over
    all four thousand and ninety-six ordered pairs. Transitivity needs both halves — a map that reaches every
    vertex but does not preserve the edges is not a symmetry of the graph, and reaching was shown separately. -/
theorem xor_translation_preserves_adjacency_63 : (List.range 64).all (fun c => (List.range 64).all (fun d => lxor (lxor c 63) (lxor d 63) == lxor c d)) := by decide
