...
def rootfsNibbles : List Nat := [4, 1, 15, 7, 3, 14, 3, 12, 15, 5, 15, 10, 9, 1, 9, 11, 8, 10, 10, 5, 12, 10, 6, 11, 3, 0, 13, 12, 4, 8, 15, 0, 13, 10, 2, 7, 2, 0, 7, 7, 6, 13, 7, 4, 2, 3, 14, 2, 10, 7, 7, 4, 8, 2, 1, 1, 4, 5, 6, 15, 14, 0, 8, 1]
-- the pinned tuple (version, arch, flavor, digest) folded to its content-address, the same 32 states a spec wears
def releaseAddress : List Nat := [8, 11, 15, 4, 5, 2, 8, 7, 6, 5, 10, 6, 8, 4, 8, 15, 11, 5, 7, 10, 3, 6, 4, 8, 1, 8, 15, 6, 11, 7, 11, 15]
...
/-- THE SEAL NAMES WHICH BYTES, NOT ONLY WHICH RELEASE. This install set is the dependency closure of a
    ...
    Alpine PUBLISHED for it: 41f73e3cf5fa919b8aa5ca6b30dc48f0da2720776d7423e2a7748211456fe081 — Alpine
    3.24.1/x86_64, alpine-minirootfs-3.24.1-x86_64.tar.gz. It is sealed here compiled to the lattice everything
    else in this wing is compiled to: 64 nibbles of 16 states, 64 · 4 = 256 bits, a SHA-256 exactly. The pinned
    tuple (version, arch, flavor, digest) folds to 8bf45287-65a6-848f-b57a-364818f6b7bf, carried as its 32
