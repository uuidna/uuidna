...
/-- every generated theorem carries prose IN the Lean — 2539 of 2539 documented across 111 wings, 0 without; the
...
/-- the prose round-trips exactly — 2539 of 2539 doc comments re-wrap through the emitter and re-read to the
...
/-- no doc comment contains an unescaped -\/ — 0 found across 2539; the terminator would close the comment early
...
/-- prose that says more than the statement OUTNUMBERS prose that repeats it — 2539 informative against 0 bare,
    of 2539; a doc comment identical to its own Lean statement carries nothing the proof did not already say,
...
/-- the whole prose corpus folds to ONE ℤ/9 receipt — 672058 characters across 2539 doc comments in 111 wings
