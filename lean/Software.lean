...
/-- A NEIGHBOURHOOD SEALS EXACTLY WHEN IT IS WHOLE, AND AT NO OTHER COUNT. The sealing rule is seal(held, size)
    ...
    own size and NOT one short of it — and folds their sizes to 70851, a total appearing nowhere among them.
...
theorem cube_seals_at_completeness_only : (((List.range 178).filter (fun k => k == 177)).length = 1) ∧ (((List.range 177).filter (fun k => k == 177)).length = 0) ∧ ([[6,6,6,9,13,8,11,18,11,6,29,17,6,5],[15,5,6,9,13,24,33,8,6,9,25,19,7,4],[5,64,6,11,9,16,13,8,10,6,14,4,13,8],[65,8,8,8,8,8,8,8,8,12,10,35,57,69],[71,96,66,76,82,82,79,78,55,58,58,46,63,72],[73,82,63,75,83,567,10,6,6,6,6,18,8,4096],[4096,4096,4096,4096,4096,4096,4096,4096,4096,4096,4096,4096,4096,4096],[4096,22,6,13,12,6,353,10,6,5,8,11,7,7],[5,8,18,93,6,2,6,6,9,9,8,13,6,6],[8,10,6,10,5,6,8,58,5,17,25,11,14,6],[6,10,8,7,6,234,148,10,7,6,9,33,5,15],[11,11,8,6,9,6,4,6,6,6,11,6,18,8],[6,13,7,2,15,18,16,932,18]].all (fun c => c.all (fun n => (n == n) && !(n - 1 == n)))) ∧ ((([[6,6,6,9,13,8,11,18,11,6,29,17,6,5],[15,5,6,9,13,24,33,8,6,9,25,19,7,4],[5,64,6,11,9,16,13,8,10,6,14,4,13,8],[65,8,8,8,8,8,8,8,8,12,10,35,57,69],[71,96,66,76,82,82,79,78,55,58,58,46,63,72],[73,82,63,75,83,567,10,6,6,6,6,18,8,4096],[4096,4096,4096,4096,4096,4096,4096,4096,4096,4096,4096,4096,4096,4096],[4096,22,6,13,12,6,353,10,6,5,8,11,7,7],[5,8,18,93,6,2,6,6,9,9,8,13,6,6],[8,10,6,10,5,6,8,58,5,17,25,11,14,6],[6,10,8,7,6,234,148,10,7,6,9,33,5,15],[11,11,8,6,9,6,4,6,6,6,11,6,18,8],[6,13,7,2,15,18,16,932,18]].map (fun c => c.foldl (· + ·) 0)).foldl (· + ·) 0) = 70851) := by decide

/-- THE NEIGHBOURHOODS PARTITION THE LEDGER, AND THE MEMORY IS ONE LINE PER NEIGHBOURHOOD. The kernel folds the
    177 measured wing counts and lands on 70851 — the whole ledger, nothing counted twice and nothing lost —
...
theorem cubes_partition_ledger : ((([[6,6,6,9,13,8,11,18,11,6,29,17,6,5],[15,5,6,9,13,24,33,8,6,9,25,19,7,4],[5,64,6,11,9,16,13,8,10,6,14,4,13,8],[65,8,8,8,8,8,8,8,8,12,10,35,57,69],[71,96,66,76,82,82,79,78,55,58,58,46,63,72],[73,82,63,75,83,567,10,6,6,6,6,18,8,4096],[4096,4096,4096,4096,4096,4096,4096,4096,4096,4096,4096,4096,4096,4096],[4096,22,6,13,12,6,353,10,6,5,8,11,7,7],[5,8,18,93,6,2,6,6,9,9,8,13,6,6],[8,10,6,10,5,6,8,58,5,17,25,11,14,6],[6,10,8,7,6,234,148,10,7,6,9,33,5,15],[11,11,8,6,9,6,4,6,6,6,11,6,18,8],[6,13,7,2,15,18,16,932,18]].map (fun c => c.foldl (· + ·) 0)).foldl (· + ·) 0) = 70851) ∧ (([[6,6,6,9,13,8,11,18,11,6,29,17,6,5],[15,5,6,9,13,24,33,8,6,9,25,19,7,4],[5,64,6,11,9,16,13,8,10,6,14,4,13,8],[65,8,8,8,8,8,8,8,8,12,10,35,57,69],[71,96,66,76,82,82,79,78,55,58,58,46,63,72],[73,82,63,75,83,567,10,6,6,6,6,18,8,4096],[4096,4096,4096,4096,4096,4096,4096,4096,4096,4096,4096,4096,4096,4096],[4096,22,6,13,12,6,353,10,6,5,8,11,7,7],[5,8,18,93,6,2,6,6,9,9,8,13,6,6],[8,10,6,10,5,6,8,58,5,17,25,11,14,6],[6,10,8,7,6,234,148,10,7,6,9,33,5,15],[11,11,8,6,9,6,4,6,6,6,11,6,18,8],[6,13,7,2,15,18,16,932,18]].map (fun c => c.length)).foldl (· + ·) 0 = 177) ∧ (177 < 70851) := by decide
