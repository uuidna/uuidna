...
Every theorem below is proven `by decide` in Lean, verified sorry-free by `npm run lean` — **1049 theorems** in
...
17. **The two coins & the 64** — `lean/Coins.lean` · **7** theorems
