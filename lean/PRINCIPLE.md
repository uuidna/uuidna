...
Every theorem below is proven `by decide` in Lean, verified sorry-free by `npm run lean` — **1195 theorems** in
...
6. **The sequence & reflection group** — `lean/Sequence.lean` · **20** theorems
