...
Every theorem below is proven `by decide` in Lean, verified sorry-free by `npm run lean` — **1254 theorems** in
...
6. **The sequence & reflection group** — `lean/Sequence.lean` · **26** theorems
...
17. **The two coins & the 64** — `lean/Coins.lean` · **15** theorems
...
53. **The cut** — `lean/Editing.lean` · **14** theorems
...
54. **The exposure** — `lean/Photography.lean` · **8** theorems
...
55. **The instrument** — `lean/Psychology.lean` · **8** theorems
...
56. **The spectrum** — `lean/Spectrum.lean` · **8** theorems
...
57. **The colour wheel** — `lean/Colour.lean` · **15** theorems
...
58. **The harmony of pairs** — `lean/Harmony.lean` · **8** theorems
...
59. **The report** — `lean/Report.lean` · **8** theorems
...
60. **The matching** — `lean/Matching.lean` · **8** theorems
...
61. **The rules of inference** — `lean/Reasoning.lean` · **18** theorems
...
62. **The layered defence** — `lean/Security.lean` · **7** theorems
...
63. **The mix** — `lean/Production.lean` · **10** theorems
...
64. **One leap** — `lean/OneLeap.lean` · **1** theorems
   the whole vortex proved in a single by decide

65. **Anti-fraud detection** — `lean/AntiFraud.lean` · **26** theorems
...
66. **Quantum sailing seals** — `lean/SailingSeals.lean` · **13** theorems
...
67. **The honest court** — `lean/DisputedTopics.lean` · **15** theorems
