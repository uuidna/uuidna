...
18. **The exploit folds** — `lean/Exploits.lean` · **13** theorems
...
19. **The sanitise standards** — `lean/Sanitize.lean` · **7** theorems
...
20. **The Platonic solids in every dimension** — `lean/Solids.lean` · **12** theorems
...
21. **The algebra of the neuron** — `lean/Neuro.lean` · **9** theorems
...
22. **Propulsion — Newtonian & bounded** — `lean/Propulsion.lean` · **5** theorems
...
23. **Navigation — bounded geometry** — `lean/Navigation.lean` · **5** theorems
...
24. **The lay of the land** — `lean/Topography.lean` · **13** theorems
...
25. **Command authentication** — `lean/Command.lean` · **7** theorems
...
26. **The fixed stars** — `lean/Astronomy.lean` · **7** theorems
...
27. **Diving — trimix gas laws** — `lean/Diving.lean` · **8** theorems
...
28. **The light domain** — `lean/Optics.lean` · **8** theorems
...
29. **The sound domain** — `lean/Acoustics.lean` · **8** theorems
...
30. **The reactions domain** — `lean/Chemistry.lean` · **8** theorems
...
31. **The energy domain** — `lean/Thermodynamics.lean` · **8** theorems
...
32. **The bond domain** — `lean/Molecular.lean` · **8** theorems
...
33. **The field domain** — `lean/Electromagnetism.lean` · **8** theorems
...
34. **The structures domain** — `lean/Statics.lean` · **8** theorems
...
35. **The points-of-sail domain** — `lean/Sailing.lean` · **8** theorems
...
36. **The spacetime domain** — `lean/Relativity.lean` · **8** theorems
...
37. **The Glagolitic numerals & Pliska rosette** — `lean/Glagolitic.lean` · **6** theorems
...
38. **The time coordinate** — `lean/Ephemeris.lean` · **8** theorems
...
39. **The pentagram & the Fibonacci digits** — `lean/Pentagram.lean` · **13** theorems
...
40. **The chessboard** — `lean/Chess.lean` · **8** theorems
...
41. **The chess horizon** — `lean/Chessgames.lean` · **24** theorems
...
42. **The heaps** — `lean/Nim.lean` · **93** theorems
...
43. **The document fold** — `lean/Editor.lean` · **4** theorems
...
44. **The error-correcting codes** — `lean/Codes.lean` · **8** theorems
...
45. **The identifiers** — `lean/Identifiers.lean` · **6** theorems
...
46. **The tides** — `lean/Tides.lean` · **7** theorems
...
47. **The calendar** — `lean/Calendar.lean` · **9** theorems
...
48. **The measures of type** — `lean/Typesetting.lean` · **14** theorems
...
49. **The cut** — `lean/Editing.lean` · **9** theorems
...
50. **The exposure** — `lean/Photography.lean` · **8** theorems
...
51. **The instrument** — `lean/Psychology.lean` · **8** theorems
...
52. **The spectrum** — `lean/Spectrum.lean` · **8** theorems
...
53. **The colour wheel** — `lean/Colour.lean` · **8** theorems
...
54. **The harmony of pairs** — `lean/Harmony.lean` · **8** theorems
...
55. **The report** — `lean/Report.lean` · **8** theorems
...
56. **The matching** — `lean/Matching.lean` · **8** theorems
...
57. **The rules of inference** — `lean/Reasoning.lean` · **9** theorems
...
58. **The layered defence** — `lean/Security.lean` · **6** theorems
...
59. **The mix** — `lean/Production.lean` · **10** theorems
...
60. **One leap** — `lean/OneLeap.lean` · **1** theorems
