...
Every theorem below is proven `by decide` in Lean, verified sorry-free by `npm run lean` — **845 theorems** in
...
42. **The harmony of pairs** — `lean/Harmony.lean` · **8** theorems
...
43. **The matching** — `lean/Matching.lean` · **8** theorems
...
44. **The rules of inference** — `lean/Reasoning.lean` · **9** theorems
...
45. **The layered defence** — `lean/Security.lean` · **6** theorems
...
46. **The mix** — `lean/Production.lean` · **10** theorems
...
47. **One leap** — `lean/OneLeap.lean` · **1** theorems
