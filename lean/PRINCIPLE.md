...
Every theorem below is proven `by decide` in Lean, verified sorry-free by `npm run lean` — **729 theorems** in
...
33. **The pentagram & the Fibonacci digits** — `lean/Pentagram.lean` · **8** theorems
