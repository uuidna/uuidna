...
Every theorem below is proven `by decide` in Lean, verified sorry-free by `npm run lean` — **896 theorems** in
...
47. **The report** — `lean/Report.lean` · **8** theorems
...
48. **The matching** — `lean/Matching.lean` · **8** theorems
...
49. **The rules of inference** — `lean/Reasoning.lean` · **9** theorems
...
50. **The layered defence** — `lean/Security.lean` · **6** theorems
...
51. **The mix** — `lean/Production.lean` · **10** theorems
...
52. **One leap** — `lean/OneLeap.lean` · **1** theorems
