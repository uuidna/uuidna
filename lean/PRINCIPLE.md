...
Every theorem below is proven `by decide` in Lean, verified sorry-free by `npm run lean` — **1135 theorems** in
...
60. **The rules of inference** — `lean/Reasoning.lean` · **16** theorems
