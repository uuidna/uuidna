...
/-- A STORE'S COST TO ITS HOST IS COUNTED IN INODES, NOT RECORDS. Leaving out this wing's own 3 records, 71,592
    leaves sit under 256 + 43,535 + 71,433 + 71,592 folders across the 4 levels, so with the root the store
    occupies 258,409 inodes — more than three for every record it holds. The floor is two by construction: the
...
theorem the_store_footprint_is_its_folders : (71592 + 256 + 43535 + 71433 + 71592 + 1 = 258409) ∧ (258409 > 3 * 71592) := by decide
