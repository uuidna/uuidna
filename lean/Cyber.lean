...
/-- A STORE'S COST TO ITS HOST IS COUNTED IN INODES, NOT RECORDS. Leaving out this wing's own 3 records, 71,623
    leaves sit under 256 + 43,530 + 71,465 + 71,623 folders across the 4 levels, so with the root the store
    occupies 258,498 inodes — more than three for every record it holds. The floor is two by construction: the
...
theorem the_store_footprint_is_its_folders : (71623 + 256 + 43530 + 71465 + 71623 + 1 = 258498) ∧ (258498 > 3 * 71623) := by decide
