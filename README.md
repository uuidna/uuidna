# uuidna — 2,432 distinct theorems under 2,515 keys · 2 coins · one receipt

`b10ef0f4-6838-8f01-b874-442a72536fbc`
...
Board: **2,432** distinct / **2,515** keys · **112** skills · **115** Lean files · receipt `8af489bc-6741-8875-bd73-131675c9d67e`.
...
| --- | ---: | --- |
| Distinct theorems | 2,432 | statement census (a Lean statement sealed under two keys is one theorem) |
| Theorem keys | 2,515 | `theorems().length` |
...
| Ledger decided mass | 115,110 superpositions (4 hexbits) | sum of `by decide` domains |
...
| Shor chunks on uuid | 16 × GHZ(16) = 1,048,576 amplitudes | `uuidna_os` · `uuidna_quantum`; 184 ms — under 1 s |
...
| Conserved price paid | 5,030 coins | 2515 × 2 |
...
The ledger covers **115,110** superpositions across **115** wings.
...
- **115,110** superpositions decided across the ledger
- **5,030** coins paid (conserved denomination 2 — [two_coins](https://uuidna.com/theorem/two_coins))
...
column in **55 ms** and the uuid column in **184 ms**
