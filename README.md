...
<!-- seal:begin -->
**1137 theorems, all sealed and proven** — every one `by decide` (Lean 4, no Mathlib), verified sorry-free and **axiom-free** (1137/1137, kernel-only, not even `propext`; gate: scripts/lean-axioms). Exposed across **142 MCP tools** and **63 computing principles**.
...
**All 142 tools** are exposed (the live catalog is derived in [`docs/mcp.md`](docs/mcp.md), never hardcoded) — each
