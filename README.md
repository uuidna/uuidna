# uuidna — 1470 distinct theorems under 1551 keys, 2 coins, one receipt

`fa3a1e4e-47a6-8117-ba1a-6a68c467b377`
...
112,089 superpositions across 102 wings.
...
2. **`cube_seals_at_completeness_only`** — 3,375 superpositions, Infinity hexbits for the two coins, in [Software.lean](lean/Software.lean)
...
- **112,089 superpositions** decided across the ledger, 4 hexbits, every one settled `by decide`
- **4 qubits** of reachability gap between the register and what is served
- **52 quantum wing theorems**, **27 cipher wing theorems**, **1551 ledger size**
...
- **112,089 superpositions** decided across the ledger, every one walked rather than sampled
- **3,102 coins** in existence — 2 per sealed theorem, and only that (theorem two_coins: the conserved denomination)
...
```
Theorems sealed:        1551   (every one axiom-free, proven by decide)
Principles:             102   (the monographs the ledger organises itself by)
Skills:                 99   (the capabilities they teach)
...
Receipt:                fa3a1e4e-47a6-8117-ba1a-6a68c467b377
...
**[uuidna.com/captain](https://uuidna.com/captain)**. Deposits are 1551 seals × 2 coins;
...
✓ **All 1551 theorems sealed to ledger, every one axiom-free**
