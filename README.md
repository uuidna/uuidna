...
<!-- seal:begin -->
**1086 theorems, all sealed and proven** — every one `by decide` (Lean 4, no Mathlib), verified sorry-free and **axiom-free** (1086/1086, kernel-only, not even `propext`; gate: scripts/lean-axioms). Exposed across **112 MCP tools** and **60 computing principles**.
...
**All 112 tools** are exposed (the live catalog is derived in [`docs/mcp.md`](docs/mcp.md), never hardcoded) — each
...
**Every theorem in the ledger** (**1086** across **60** principles), all proven `by decide` (Lean 4,
...
…and 54 more principles (physics, games, arts, language, security, the exploit folds), each a verified
