...
<!-- seal:begin -->
**1132 theorems, all sealed and proven** — every one `by decide` (Lean 4, no Mathlib), verified sorry-free and **axiom-free** (1132/1132, kernel-only, not even `propext`; gate: scripts/lean-axioms). Exposed across **132 MCP tools** and **63 computing principles**.
