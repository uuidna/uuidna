# uuidna — 2,515 distinct theorems under 2,598 keys · 2 coins · one receipt

`f74df977-56a7-8bf8-a3f7-27b4f5152594`
...
Board: **2,515** distinct / **2,598** keys · **113** skills · **116** Lean files · receipt `1d751d5f-1327-881c-851d-49b8d6e645a7`.
...
| --- | ---: | --- |
| Distinct theorems | 2,515 | statement census (a Lean statement sealed under two keys is one theorem) |
| Theorem keys | 2,598 | `theorems().length` |
...
| Ledger decided mass | 130,263 superpositions (4 hexbits) | sum of `by decide` domains |
...
| Conserved price paid | 5,196 coins | 2598 × 2 |
...
The ledger covers **130,263** superpositions across **116** wings.
...
- **130,263** superpositions decided across the ledger
- **5,196** coins paid (conserved denomination 2 — [two_coins](https://uuidna.com/theorem/two_coins))
