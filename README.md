...
`07bb1244-cc3c-831b-be9f-ba1016a8f846`
...
| Shor chunks on handle | 4 × GHZ(16) = 262,144 amplitudes | `uuidna_os` capacity.shor · `uuidna_quantum` GHZ; 54 ms on this CPU |
| Shor chunks on uuid | 16 × GHZ(16) = 1,048,576 amplitudes | `uuidna_os` · `uuidna_quantum`; 174 ms — under 1 s |
...
column in **54 ms** and the uuid column in **174 ms**
