...
| Ledger decided mass | 132,049 superpositions (4 hexbits) | sum of `by decide` domains |
...
The ledger covers **132,049** superpositions across **118** wings.
...
- **132,049** superpositions decided across the ledger
