...
<!-- seal:begin -->
**1050 theorems, all sealed and proven** — every one `by decide` (Lean 4, no Mathlib), verified sorry-free and **axiom-free** (1050/1050, kernel-only, not even `propext`; gate: scripts/lean-axioms). Exposed across **106 MCP tools** and **57 computing principles**.
