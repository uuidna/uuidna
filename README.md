# uuidna — 2,505 distinct theorems under 2,588 keys · 2 coins · one receipt

`86bb58c9-5a5f-8b2f-bdf0-e06844008eea`
...
Board: **2,505** distinct / **2,588** keys · **112** skills · **115** Lean files · receipt `7885f31d-2821-864e-ac70-54a0e55cd1bb`.
...
| --- | ---: | --- |
| Distinct theorems | 2,505 | statement census (a Lean statement sealed under two keys is one theorem) |
| Theorem keys | 2,588 | `theorems().length` |
...
| Ledger decided mass | 126,166 superpositions (4 hexbits) | sum of `by decide` domains |
...
| Conserved price paid | 5,176 coins | 2588 × 2 |
...
The ledger covers **126,166** superpositions across **115** wings.
...
- **126,166** superpositions decided across the ledger
- **5,176** coins paid (conserved denomination 2 — [two_coins](https://uuidna.com/theorem/two_coins))
