# uuidna — 2,513 distinct theorems under 2,596 keys · 2 coins · one receipt

`f2768511-a90f-8fd4-9110-d91c97c30749`
...
Board: **2,513** distinct / **2,596** keys · **113** skills · **116** Lean files · receipt `3d515997-2976-88b5-956d-d3ca12683fe2`.
...
| --- | ---: | --- |
| Distinct theorems | 2,513 | statement census (a Lean statement sealed under two keys is one theorem) |
| Theorem keys | 2,596 | `theorems().length` |
...
| Ledger decided mass | 130,261 superpositions (4 hexbits) | sum of `by decide` domains |
...
| Conserved price paid | 5,192 coins | 2596 × 2 |
...
The ledger covers **130,261** superpositions across **116** wings.
...
- **130,261** superpositions decided across the ledger
- **5,192** coins paid (conserved denomination 2 — [two_coins](https://uuidna.com/theorem/two_coins))
