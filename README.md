...
1. **5,124 theorems and 171,734,515 decided cases, every one decided by the Lean 4 kernel** — sorry-free, no Mathlib, and depending on **no axiom at all**, not even propext. Recompute the whole thing with `npm run lean`.
...
Board: **5,041** distinct / **5,124** keys · **117** skills · **145** Lean files · receipt `88c36a32-acae-8a98-925c-b2cf79a48e6e`.
...
| --- | ---: | --- |
| Distinct theorems | 5,041 | statement census (a Lean statement sealed under two keys is one theorem) |
| Theorem keys | 5,124 | `theorems().length` |
...
| Ledger decided mass | 171,734,515 superpositions (6 hexbits) | sum of `by decide` domains |
...
| Conserved price paid | 10,248 coins | 5124 × 2 |
...
The ledger covers **171,734,515** superpositions across **145** wings.
...
- **171,734,515** superpositions decided across the ledger
- **10,248** coins paid (conserved denomination 2 — [two_coins](https://uuidna.com/theorem/two_coins))
- Floored coverage **16,757** superpositions per coin
