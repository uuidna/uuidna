# uuidna — 1557 distinct theorems under 1639 keys, 2 coins, one receipt

`e94a6db7-f58f-8d4f-9aa0-fc53cca96950`
...
113,079 superpositions across 111 wings.
...
2. **`cube_seals_at_completeness_only`** — 3,578 superpositions, Infinity hexbits for the two coins, in [Software.lean](lean/Software.lean)
...
- **113,079 superpositions** decided across the ledger, 4 hexbits, every one settled `by decide`
- **4 qubits** of reachability gap between the register and what is served
- **52 quantum wing theorems**, **27 cipher wing theorems**, **1639 ledger size**
...
- **113,079 superpositions** decided across the ledger, every one walked rather than sampled
- **3,278 coins paid** — the CONSERVED PRICE, 2 per sealed theorem (theorem two_coins: the fixed denomination paid IN). But each theorem carries its own PRICE TAG — its decided mass, from 1 to 55,986 superpositions — so what the coins BUY is never flat: the cost is 2 every time, the value never is
...
```
Theorems sealed:        1639   (every one axiom-free, proven by decide)
Principles:             111   (the monographs the ledger organises itself by)
Skills:                 108   (the capabilities they teach)
...
Receipt:                e94a6db7-f58f-8d4f-9aa0-fc53cca96950
...
**[uuidna.com/captain](https://uuidna.com/captain)**. Deposits are 1639 seals × 2 coins;
...
✓ **All 1639 theorems sealed to ledger, every one axiom-free**
