...
<!-- seal:begin -->
**1130 theorems, all sealed and proven** — every one `by decide` (Lean 4, no Mathlib), verified sorry-free and **axiom-free** (1130/1130, kernel-only, not even `propext`; gate: scripts/lean-axioms). Exposed across **130 MCP tools** and **63 computing principles**.
...
**All 130 tools** are exposed (the live catalog is derived in [`docs/mcp.md`](docs/mcp.md), never hardcoded) — each
...
**Every theorem in the ledger** (**1130** across **63** principles), all proven `by decide` (Lean 4,
