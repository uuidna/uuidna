...
Board: **2,575** distinct / **2,658** keys · **115** skills · **118** Lean files · receipt `006d4b65-900c-808c-8021-2e0d35cd6b5b`.
...
| --- | ---: | --- |
| Distinct theorems | 2,575 | statement census (a Lean statement sealed under two keys is one theorem) |
| Theorem keys | 2,658 | `theorems().length` |
...
| Ledger decided mass | 132,907 superpositions (4 hexbits) | sum of `by decide` domains |
...
| Conserved price paid | 5,316 coins | 2658 × 2 |
...
The ledger covers **132,907** superpositions across **118** wings.
...
- **132,907** superpositions decided across the ledger
- **5,316** coins paid (conserved denomination 2 — [two_coins](https://uuidna.com/theorem/two_coins))
