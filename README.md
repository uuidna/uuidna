# uuidna — 2,132 distinct theorems under 2,215 keys · 2 coins · one receipt

`8ad1491a-940f-8982-b1aa-2c13f939c0a3`
...
Board: **2,132** distinct / **2,215** keys · **112** skills · **115** Lean files · receipt `b35364e6-00d5-83b0-b368-93b343c10f68`.
...
| --- | ---: | --- |
| Distinct theorems | 2,132 | statement census (a Lean statement sealed under two keys is one theorem) |
| Theorem keys | 2,215 | `theorems().length` |
...
| Ledger decided mass | 114,807 superpositions (4 hexbits) | sum of `by decide` domains |
...
| Shor chunks on handle | 4 × GHZ(16) = 262,144 amplitudes | `uuidna_os` capacity.shor · `uuidna_quantum` GHZ; 51 ms on this CPU |
| Shor chunks on uuid | 16 × GHZ(16) = 1,048,576 amplitudes | `uuidna_os` · `uuidna_quantum`; 181 ms — under 1 s |
...
| Conserved price paid | 4,430 coins | 2215 × 2 |
...
The ledger covers **114,807** superpositions across **115** wings.
...
- **114,807** superpositions decided across the ledger
- **4,430** coins paid (conserved denomination 2 — [two_coins](https://uuidna.com/theorem/two_coins))
...
column in **51 ms** and the uuid column in **181 ms**
