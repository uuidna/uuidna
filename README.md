...
1. **5,253 theorems and 172,097,011 decided cases, every one decided by the Lean 4 kernel** — sorry-free, no Mathlib, and depending on **no axiom at all**, not even propext. Recompute the whole thing with `npm run lean`.
...
> Captain PhD — concept (Clay 8, DNA 8, gravity true, demos true) ∧ work (search 0, digest 256, Grover 128, codons 64) ∧ thesis (ok false, gaps 130) → **complete false**. Thesis wave 24 / 24. Receipt `a9e0530e-ac31-8287-a45d-44781cf708cd`.
...
Board: **5,170** distinct / **5,253** keys · **117** skills · **146** Lean files · receipt `58b6c842-22bf-838c-82cc-2f98ee196fcc`.
...
| --- | ---: | --- |
| Distinct theorems | 5,170 | statement census (a Lean statement sealed under two keys is one theorem) |
| Theorem keys | 5,253 | `theorems().length` |
| Principles / wings | 146 / 146 | PRINCIPLES + wing ratings |
...
| Captain PhD — complete | false · receipt `a9e0530e-ac31-8287-a45d-44781cf708cd` | concept ∧ work ∧ thesis |
| Ledger decided mass | 172,097,011 superpositions (6 hexbits) | sum of `by decide` domains |
...
| Conserved price paid | 10,506 coins | 5253 × 2 |
...
The ledger covers **172,097,011** superpositions across **146** wings.
...
- **172,097,011** superpositions decided across the ledger
- **10,506** coins paid (conserved denomination 2 — [two_coins](https://uuidna.com/theorem/two_coins))
- Floored coverage **16,380** superpositions per coin
