...
<!-- seal:begin -->
**1129 theorems, all sealed and proven** — every one `by decide` (Lean 4, no Mathlib), verified sorry-free and **axiom-free** (1129/1129, kernel-only, not even `propext`; gate: scripts/lean-axioms). Exposed across **130 MCP tools** and **63 computing principles**.
...
**Every theorem in the ledger** (**1129** across **63** principles), all proven `by decide` (Lean 4,
