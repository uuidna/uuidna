# uuidna — 1585 distinct theorems under 1666 keys, 2 coins, one receipt

`11d1a6c8-6e83-810f-a371-a463156dd83f`
...
113,160 superpositions across 112 wings.
...
2. **`cube_seals_at_completeness_only`** — 3,635 superpositions, Infinity hexbits for the two coins, in [Software.lean](lean/Software.lean)
...
- **113,160 superpositions** decided across the ledger, 4 hexbits, every one settled `by decide`
- **4 qubits** of reachability gap between the register and what is served
- **52 quantum wing theorems**, **27 cipher wing theorems**, **1666 ledger size**
...
- **113,160 superpositions** decided across the ledger, every one walked rather than sampled
- **3,332 coins paid** — the CONSERVED PRICE, 2 per sealed theorem (theorem two_coins: the fixed denomination paid IN). But each theorem carries its own PRICE TAG — its decided mass, from 1 to 55,986 superpositions — so what the coins BUY is never flat: the cost is 2 every time, the value never is
...
```
Theorems sealed:        1666   (every one axiom-free, proven by decide)
...
Receipt:                11d1a6c8-6e83-810f-a371-a463156dd83f
...
**[uuidna.com/captain](https://uuidna.com/captain)**. Deposits are 1666 seals × 2 coins;
...
✓ **All 1666 theorems sealed to ledger, every one axiom-free**
