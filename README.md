# uuidna — 2,419 distinct theorems under 2,502 keys · 2 coins · one receipt

`09b15259-595f-85aa-9e47-2893db559b7e`
...
Board: **2,419** distinct / **2,502** keys · **112** skills · **115** Lean files · receipt `c0a2daea-1eb5-89bd-b915-913f6f197b77`.
...
| --- | ---: | --- |
| Distinct theorems | 2,419 | statement census (a Lean statement sealed under two keys is one theorem) |
| Theorem keys | 2,502 | `theorems().length` |
...
| Ledger decided mass | 115,094 superpositions (4 hexbits) | sum of `by decide` domains |
...
| Conserved price paid | 5,004 coins | 2502 × 2 |
...
The ledger covers **115,094** superpositions across **115** wings.
...
- **115,094** superpositions decided across the ledger
- **5,004** coins paid (conserved denomination 2 — [two_coins](https://uuidna.com/theorem/two_coins))
- Floored coverage **23** superpositions per coin
...
column in **52 ms** and the uuid column in **190 ms**
