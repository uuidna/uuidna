# uuidna — 1540 distinct theorems under 1622 keys, 2 coins, one receipt

`7fd449c3-ecd4-8860-aa93-469d24c0de2e`
...
113,018 superpositions across 110 wings.
...
2. **`cube_seals_at_completeness_only`** — 3,541 superpositions, Infinity hexbits for the two coins, in [Software.lean](lean/Software.lean)
...
- **113,018 superpositions** decided across the ledger, 4 hexbits, every one settled `by decide`
- **4 qubits** of reachability gap between the register and what is served
- **52 quantum wing theorems**, **27 cipher wing theorems**, **1622 ledger size**
...
- **113,018 superpositions** decided across the ledger, every one walked rather than sampled
- **3,244 coins paid** — the CONSERVED PRICE, 2 per sealed theorem (theorem two_coins: the fixed denomination paid IN). But each theorem carries its own PRICE TAG — its decided mass, from 1 to 55,986 superpositions — so what the coins BUY is never flat: the cost is 2 every time, the value never is
...
```
Theorems sealed:        1622   (every one axiom-free, proven by decide)
...
Receipt:                7fd449c3-ecd4-8860-aa93-469d24c0de2e
...
**[uuidna.com/captain](https://uuidna.com/captain)**. Deposits are 1622 seals × 2 coins;
...
✓ **All 1622 theorems sealed to ledger, every one axiom-free**
