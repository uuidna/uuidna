# uuidna — 1541 distinct theorems under 1623 keys, 2 coins, one receipt

`6f1b8bf8-1949-823e-9d09-1e48295aeb45`
...
113,021 superpositions across 110 wings.
...
2. **`cube_seals_at_completeness_only`** — 3,543 superpositions, Infinity hexbits for the two coins, in [Software.lean](lean/Software.lean)
...
- **113,021 superpositions** decided across the ledger, 4 hexbits, every one settled `by decide`
- **4 qubits** of reachability gap between the register and what is served
- **52 quantum wing theorems**, **27 cipher wing theorems**, **1623 ledger size**
...
- **113,021 superpositions** decided across the ledger, every one walked rather than sampled
- **3,246 coins paid** — the CONSERVED PRICE, 2 per sealed theorem (theorem two_coins: the fixed denomination paid IN). But each theorem carries its own PRICE TAG — its decided mass, from 1 to 55,986 superpositions — so what the coins BUY is never flat: the cost is 2 every time, the value never is
...
```
Theorems sealed:        1623   (every one axiom-free, proven by decide)
...
Receipt:                6f1b8bf8-1949-823e-9d09-1e48295aeb45
...
**[uuidna.com/captain](https://uuidna.com/captain)**. Deposits are 1623 seals × 2 coins;
...
✓ **All 1623 theorems sealed to ledger, every one axiom-free**
