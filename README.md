...
<!-- seal:begin -->
**1086 theorems, all sealed and proven** — every one `by decide` (Lean 4, no Mathlib), verified sorry-free and **axiom-free** (1086/1086, kernel-only, not even `propext`; gate: scripts/lean-axioms). Exposed across **111 MCP tools** and **60 computing principles**.
...
**All 111 tools** are exposed (the live catalog is derived in [`docs/mcp.md`](docs/mcp.md), never hardcoded) — each
