# uuidna — 2,441 distinct theorems under 2,524 keys · 2 coins · one receipt

`add2b10f-4817-824b-8f2a-c071e9580128`
...
Board: **2,441** distinct / **2,524** keys · **112** skills · **115** Lean files · receipt `1d91812d-6323-819b-9c75-8bcd4a49bdb2`.
...
| --- | ---: | --- |
| Distinct theorems | 2,441 | statement census (a Lean statement sealed under two keys is one theorem) |
| Theorem keys | 2,524 | `theorems().length` |
...
| Ledger decided mass | 115,122 superpositions (4 hexbits) | sum of `by decide` domains |
...
| Shor chunks on handle | 4 × GHZ(16) = 262,144 amplitudes | `uuidna_os` capacity.shor · `uuidna_quantum` GHZ; 55 ms on this CPU |
| Shor chunks on uuid | 16 × GHZ(16) = 1,048,576 amplitudes | `uuidna_os` · `uuidna_quantum`; 179 ms — under 1 s |
...
| Conserved price paid | 5,048 coins | 2524 × 2 |
...
The ledger covers **115,122** superpositions across **115** wings.
...
- **115,122** superpositions decided across the ledger
- **5,048** coins paid (conserved denomination 2 — [two_coins](https://uuidna.com/theorem/two_coins))
...
column in **55 ms** and the uuid column in **179 ms**
