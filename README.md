# uuidna — 2,518 distinct theorems under 2,601 keys · 2 coins · one receipt
...
Board: **2,518** distinct / **2,601** keys · **113** skills · **116** Lean files · receipt `352b1151-ed85-886d-84e3-2a73ba5c3e54`.
...
| --- | ---: | --- |
| Distinct theorems | 2,518 | statement census (a Lean statement sealed under two keys is one theorem) |
| Theorem keys | 2,601 | `theorems().length` |
...
| Ledger decided mass | 130,266 superpositions (4 hexbits) | sum of `by decide` domains |
...
| Conserved price paid | 5,202 coins | 2601 × 2 |
...
The ledger covers **130,266** superpositions across **116** wings.
...
- **130,266** superpositions decided across the ledger
- **5,202** coins paid (conserved denomination 2 — [two_coins](https://uuidna.com/theorem/two_coins))
