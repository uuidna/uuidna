# uuidna — 2,514 distinct theorems under 2,597 keys · 2 coins · one receipt

`f451c66d-8743-8584-9e0b-f4a06a90fa81`
...
Board: **2,514** distinct / **2,597** keys · **113** skills · **116** Lean files · receipt `eb579055-24ae-84a0-b796-3d4976ee38b4`.
...
| --- | ---: | --- |
| Distinct theorems | 2,514 | statement census (a Lean statement sealed under two keys is one theorem) |
| Theorem keys | 2,597 | `theorems().length` |
...
| Ledger decided mass | 130,262 superpositions (4 hexbits) | sum of `by decide` domains |
...
| Conserved price paid | 5,194 coins | 2597 × 2 |
...
The ledger covers **130,262** superpositions across **116** wings.
...
- **130,262** superpositions decided across the ledger
- **5,194** coins paid (conserved denomination 2 — [two_coins](https://uuidna.com/theorem/two_coins))
