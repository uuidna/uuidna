...
Board: **2,576** distinct / **2,659** keys · **115** skills · **118** Lean files · receipt `d3b6af27-4993-859d-95e2-849f360363b0`.
...
| --- | ---: | --- |
| Distinct theorems | 2,576 | statement census (a Lean statement sealed under two keys is one theorem) |
| Theorem keys | 2,659 | `theorems().length` |
...
| Ledger decided mass | 134,052 superpositions (4 hexbits) | sum of `by decide` domains |
...
| Conserved price paid | 5,318 coins | 2659 × 2 |
...
The ledger covers **134,052** superpositions across **118** wings.
...
- **134,052** superpositions decided across the ledger
- **5,318** coins paid (conserved denomination 2 — [two_coins](https://uuidna.com/theorem/two_coins))
