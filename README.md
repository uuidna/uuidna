...
```
Theorems Sealed:        1288   (computed from the ledger at generation — never typed)
...
```
Deposits sealed:        1288 theorems × 2 coins = 2576 coins deposited (theorem two_coins — each seal pays the trial's fee)
...
✓ **All 1288 theorems sealed to ledger**
