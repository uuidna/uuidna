...
`6234c13f-3fa8-8c5d-a125-f12e1b942352`
...
| Ledger decided mass | 115,113 superpositions (4 hexbits) | sum of `by decide` domains |
...
| Shor chunks on handle | 4 × GHZ(16) = 262,144 amplitudes | `uuidna_os` capacity.shor · `uuidna_quantum` GHZ; 70 ms on this CPU |
| Shor chunks on uuid | 16 × GHZ(16) = 1,048,576 amplitudes | `uuidna_os` · `uuidna_quantum`; 185 ms — under 1 s |
...
The ledger covers **115,113** superpositions across **115** wings.
...
- **115,113** superpositions decided across the ledger
...
column in **70 ms** and the uuid column in **185 ms**
