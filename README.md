...
<!-- seal:begin -->
**1167 theorems, all sealed and proven** — every one `by decide` (Lean 4, no Mathlib), verified sorry-free and **axiom-free** (1167/1167, kernel-only, not even `propext`; gate: scripts/lean-axioms). Exposed across **154 MCP tools** and **64 computing principles**.
