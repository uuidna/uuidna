...
Board: **2,570** distinct / **2,653** keys · **115** skills · **118** Lean files · receipt `d8918223-4451-80b9-9a5c-311d10873317`.
...
| --- | ---: | --- |
| Distinct theorems | 2,570 | statement census (a Lean statement sealed under two keys is one theorem) |
| Theorem keys | 2,653 | `theorems().length` |
...
| Ledger decided mass | 130,268 superpositions (4 hexbits) | sum of `by decide` domains |
...
| Conserved price paid | 5,306 coins | 2653 × 2 |
...
The ledger covers **130,268** superpositions across **118** wings.
...
- **130,268** superpositions decided across the ledger
- **5,306** coins paid (conserved denomination 2 — [two_coins](https://uuidna.com/theorem/two_coins))
