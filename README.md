...
<!-- seal:begin -->
**1127 theorems, all sealed and proven** — every one `by decide` (Lean 4, no Mathlib), verified sorry-free and **axiom-free** (1127/1127, kernel-only, not even `propext`; gate: scripts/lean-axioms). Exposed across **128 MCP tools** and **63 computing principles**.
