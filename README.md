...
Board: **2,529** distinct / **2,612** keys · **113** skills · **116** Lean files · receipt `1d59620b-01d3-8d9b-a548-787b79d71778`.
...
| --- | ---: | --- |
| Distinct theorems | 2,529 | statement census (a Lean statement sealed under two keys is one theorem) |
| Theorem keys | 2,612 | `theorems().length` |
...
| Ledger decided mass | 130,533 superpositions (4 hexbits) | sum of `by decide` domains |
...
| Conserved price paid | 5,224 coins | 2612 × 2 |
...
The ledger covers **130,533** superpositions across **116** wings.
...
- **130,533** superpositions decided across the ledger
- **5,224** coins paid (conserved denomination 2 — [two_coins](https://uuidna.com/theorem/two_coins))
