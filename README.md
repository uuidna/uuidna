# uuidna — 1620 distinct theorems under 1701 keys, 2 coins, one receipt

`98330c4c-91bb-8f08-ba78-720950de9b3b`
...
116,681 superpositions across 115 wings.
...
2. **`cube_seals_at_completeness_only`** — 3,712 superpositions, Infinity hexbits for the two coins, in [Software.lean](lean/Software.lean)
...
- **116,681 superpositions** decided across the ledger, 4 hexbits, every one settled `by decide`
- **4 qubits** of reachability gap between the register and what is served
- **52 quantum wing theorems**, **27 cipher wing theorems**, **1701 ledger size**
...
- **116,681 superpositions** decided across the ledger, every one walked rather than sampled
- **3,402 coins paid** — the CONSERVED PRICE, 2 per sealed theorem (theorem two_coins: the fixed denomination paid IN). But each theorem carries its own PRICE TAG — its decided mass, from 1 to 55,986 superpositions — so what the coins BUY is never flat: the cost is 2 every time, the value never is
...
```
Theorems sealed:        1701   (every one axiom-free, proven by decide)
...
Receipt:                98330c4c-91bb-8f08-ba78-720950de9b3b
...
**[uuidna.com/captain](https://uuidna.com/captain)**. Deposits are 1701 seals × 2 coins;
...
✓ **All 1701 theorems sealed to ledger, every one axiom-free**
...
(measured over the 1701-theorem ledger on the build host, each seed folded fresh)**, while demonstrated
