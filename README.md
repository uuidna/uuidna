...
<!-- seal:begin -->
**1129 theorems, all sealed and proven** — every one `by decide` (Lean 4, no Mathlib), verified sorry-free and **axiom-free** (1129/1129, kernel-only, not even `propext`; gate: scripts/lean-axioms). Exposed across **129 MCP tools** and **63 computing principles**.
