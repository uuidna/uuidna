# uuidna — 2,437 distinct theorems under 2,520 keys · 2 coins · one receipt

`222f9861-0913-8515-b46f-7ab8b238e114`
...
Board: **2,437** distinct / **2,520** keys · **112** skills · **115** Lean files · receipt `ba10e5c4-b4fb-8681-b0f3-97025a6baa2d`.
...
| --- | ---: | --- |
| Distinct theorems | 2,437 | statement census (a Lean statement sealed under two keys is one theorem) |
| Theorem keys | 2,520 | `theorems().length` |
...
| Ledger decided mass | 115,118 superpositions (4 hexbits) | sum of `by decide` domains |
...
| Shor chunks on handle | 4 × GHZ(16) = 262,144 amplitudes | `uuidna_os` capacity.shor · `uuidna_quantum` GHZ; 60 ms on this CPU |
| Shor chunks on uuid | 16 × GHZ(16) = 1,048,576 amplitudes | `uuidna_os` · `uuidna_quantum`; 200 ms — under 1 s |
...
| Conserved price paid | 5,040 coins | 2520 × 2 |
...
The ledger covers **115,118** superpositions across **115** wings.
...
- **115,118** superpositions decided across the ledger
- **5,040** coins paid (conserved denomination 2 — [two_coins](https://uuidna.com/theorem/two_coins))
...
column in **60 ms** and the uuid column in **200 ms**
