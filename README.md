...
`82c22d3d-cda4-891d-b1ba-770571568263`
...
| Ledger decided mass | 114,816 superpositions (4 hexbits) | sum of `by decide` domains |
...
The ledger covers **114,816** superpositions across **115** wings.
...
- **114,816** superpositions decided across the ledger
...
column in **53 ms** and the uuid column in **174 ms**
