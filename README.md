...
Board: **2,574** distinct / **2,657** keys · **115** skills · **118** Lean files · receipt `8aa5f37a-bf36-80e0-87f3-cf96564efb48`.
...
| --- | ---: | --- |
| Distinct theorems | 2,574 | statement census (a Lean statement sealed under two keys is one theorem) |
| Theorem keys | 2,657 | `theorems().length` |
...
| Ledger decided mass | 132,905 superpositions (4 hexbits) | sum of `by decide` domains |
...
| Conserved price paid | 5,314 coins | 2657 × 2 |
...
The ledger covers **132,905** superpositions across **118** wings.
...
7. **[`a_spec_compiles_to_hexbits`](https://uuidna.com/theorem/a_spec_compiles_to_hexbits)** — 857 superpositions, unbound (0 hexbits per dependency), in [Installs.lean](lean/Installs.lean)
...
- **132,905** superpositions decided across the ledger
- **5,314** coins paid (conserved denomination 2 — [two_coins](https://uuidna.com/theorem/two_coins))
