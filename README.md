# uuidna — 2,434 distinct theorems under 2,517 keys · 2 coins · one receipt

`4c1ec61f-3036-85fa-b45a-81de60a8b48e`
...
Board: **2,434** distinct / **2,517** keys · **112** skills · **115** Lean files · receipt `d2aaa263-111e-8268-b38f-74e9afd158f1`.
...
| --- | ---: | --- |
| Distinct theorems | 2,434 | statement census (a Lean statement sealed under two keys is one theorem) |
| Theorem keys | 2,517 | `theorems().length` |
...
| Ledger decided mass | 115,112 superpositions (4 hexbits) | sum of `by decide` domains |
...
| Shor chunks on uuid | 16 × GHZ(16) = 1,048,576 amplitudes | `uuidna_os` · `uuidna_quantum`; 196 ms — under 1 s |
...
| Conserved price paid | 5,034 coins | 2517 × 2 |
...
The ledger covers **115,112** superpositions across **115** wings.
...
- **115,112** superpositions decided across the ledger
- **5,034** coins paid (conserved denomination 2 — [two_coins](https://uuidna.com/theorem/two_coins))
...
column in **54 ms** and the uuid column in **196 ms**
