# uuidna — 2,516 distinct theorems under 2,599 keys · 2 coins · one receipt

`0ba3a30e-1b84-88a2-8871-79bc7182a279`
...
Board: **2,516** distinct / **2,599** keys · **113** skills · **116** Lean files · receipt `63d3b671-170e-89ac-9ebf-c3bb71c98444`.
...
| --- | ---: | --- |
| Distinct theorems | 2,516 | statement census (a Lean statement sealed under two keys is one theorem) |
| Theorem keys | 2,599 | `theorems().length` |
...
| Conserved price paid | 5,198 coins | 2599 × 2 |
...
The ledger covers **130,264** superpositions across **116** wings.
...
- **5,198** coins paid (conserved denomination 2 — [two_coins](https://uuidna.com/theorem/two_coins))
