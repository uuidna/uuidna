# uuidna — 2,439 distinct theorems under 2,522 keys · 2 coins · one receipt

`f2a7fca5-adba-86a3-b7d0-4d33f66a3b18`
...
Board: **2,439** distinct / **2,522** keys · **112** skills · **115** Lean files · receipt `8ef7451f-4842-8a15-87dc-ccfcf26d513c`.
...
| --- | ---: | --- |
| Distinct theorems | 2,439 | statement census (a Lean statement sealed under two keys is one theorem) |
| Theorem keys | 2,522 | `theorems().length` |
...
| Ledger decided mass | 115,120 superpositions (4 hexbits) | sum of `by decide` domains |
...
| Shor chunks on handle | 4 × GHZ(16) = 262,144 amplitudes | `uuidna_os` capacity.shor · `uuidna_quantum` GHZ; 62 ms on this CPU |
| Shor chunks on uuid | 16 × GHZ(16) = 1,048,576 amplitudes | `uuidna_os` · `uuidna_quantum`; 190 ms — under 1 s |
...
| Conserved price paid | 5,044 coins | 2522 × 2 |
...
The ledger covers **115,120** superpositions across **115** wings.
...
- **115,120** superpositions decided across the ledger
- **5,044** coins paid (conserved denomination 2 — [two_coins](https://uuidna.com/theorem/two_coins))
...
column in **62 ms** and the uuid column in **190 ms**
