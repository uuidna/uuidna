...
<!-- seal:begin -->
**1135 theorems, all sealed and proven** — every one `by decide` (Lean 4, no Mathlib), verified sorry-free and **axiom-free** (1135/1135, kernel-only, not even `propext`; gate: scripts/lean-axioms). Exposed across **133 MCP tools** and **63 computing principles**.
