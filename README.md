...
| Ledger decided mass | 134,154 superpositions (4 hexbits) | sum of `by decide` domains |
...
The ledger covers **134,154** superpositions across **118** wings.
...
- **134,154** superpositions decided across the ledger
