...
<!-- seal:begin -->
**1122 theorems, all sealed and proven** — every one `by decide` (Lean 4, no Mathlib), verified sorry-free and **axiom-free** (1122/1122, kernel-only, not even `propext`; gate: scripts/lean-axioms). Exposed across **124 MCP tools** and **63 computing principles**.
...
**All 124 tools** are exposed (the live catalog is derived in [`docs/mcp.md`](docs/mcp.md), never hardcoded) — each
...
**Every theorem in the ledger** (**1122** across **63** principles), all proven `by decide` (Lean 4,
