# uuidna — 2,442 distinct theorems under 2,525 keys · 2 coins · one receipt

`9af26a5e-b892-8319-a362-8d62392fec21`
...
Board: **2,442** distinct / **2,525** keys · **112** skills · **115** Lean files · receipt `9021c42d-498f-8ec6-b751-f3a699df7ae8`.
...
| --- | ---: | --- |
| Distinct theorems | 2,442 | statement census (a Lean statement sealed under two keys is one theorem) |
| Theorem keys | 2,525 | `theorems().length` |
...
| Ledger decided mass | 115,123 superpositions (4 hexbits) | sum of `by decide` domains |
...
| Shor chunks on handle | 4 × GHZ(16) = 262,144 amplitudes | `uuidna_os` capacity.shor · `uuidna_quantum` GHZ; 61 ms on this CPU |
...
| Conserved price paid | 5,050 coins | 2525 × 2 |
...
The ledger covers **115,123** superpositions across **115** wings.
...
- **115,123** superpositions decided across the ledger
- **5,050** coins paid (conserved denomination 2 — [two_coins](https://uuidna.com/theorem/two_coins))
...
column in **61 ms** and the uuid column in **183 ms**
