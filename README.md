...
`3908c77e-df3f-8efa-ae12-0d79aedf5405`
...
| Ledger decided mass | 114,813 superpositions (4 hexbits) | sum of `by decide` domains |
...
The ledger covers **114,813** superpositions across **115** wings.
...
- **114,813** superpositions decided across the ledger
...
column in **56 ms** and the uuid column in **181 ms**
