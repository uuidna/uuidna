...
<!-- seal:begin -->
**1062 theorems, all sealed and proven** — every one `by decide` (Lean 4, no Mathlib), verified sorry-free and **axiom-free** (1062/1062, kernel-only, not even `propext`; gate: scripts/lean-axioms). Exposed across **107 MCP tools** and **58 computing principles**.
