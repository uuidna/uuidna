...
Board: **2,571** distinct / **2,654** keys · **115** skills · **118** Lean files · receipt `360097fc-96a4-8c76-80a9-a154a21f515c`.
...
| --- | ---: | --- |
| Distinct theorems | 2,571 | statement census (a Lean statement sealed under two keys is one theorem) |
| Theorem keys | 2,654 | `theorems().length` |
...
| Conserved price paid | 5,308 coins | 2654 × 2 |
...
The ledger covers **130,271** superpositions across **118** wings.
...
- **5,308** coins paid (conserved denomination 2 — [two_coins](https://uuidna.com/theorem/two_coins))
