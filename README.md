...
1. **71,018 theorems and 172,265,659 decided cases, every one decided by the Lean 4 kernel** — sorry-free, no Mathlib, and depending on **no axiom at all**, not even propext. Recompute the whole thing with `npm run lean`.
...
Board: **70,933** distinct / **71,018** keys · **122** skills · **252** Lean files · receipt `f5a4601b-d3d3-8bfb-9052-b2b520d0445a`.
...
| --- | ---: | --- |
| Distinct theorems | 70,933 | statement census (a Lean statement sealed under two keys is one theorem) |
| Theorem keys | 71,018 | `theorems().length` |
...
| Ledger decided mass | 172,265,659 superpositions (6 hexbits) | sum of `by decide` domains |
...
The ledger covers **172,265,659** superpositions across **252** wings.
...
- **172,265,659** superpositions decided across the ledger
- **142,036** coins paid (conserved denomination 2 — [two_coins](https://uuidna.com/theorem/two_coins))
