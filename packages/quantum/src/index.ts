...
export { discoverQuantumSailingAPIs, correlateWeatherToTheorems, simulateQuantumSailingWeather, serializeWeatherCorrelation, fetchOpenMeteoForecast, fetchNoaaTideHeight, type WeatherFact, type QuantumSailingWeatherCorrelation } from '@uuidna/uuidna'
