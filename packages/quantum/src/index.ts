...
// @uuidna/quantum — the CLASSICAL, EXACT quantum surface: exact Gaussian-integer state-vector computation
...
export { discoverQuantumSailingAPIs, correlateWeatherToTheorems, sampleQuantumSailingWeather, serializeWeatherCorrelation, fetchOpenMeteoForecast, fetchNoaaTideHeight, type WeatherFact, type QuantumSailingWeatherCorrelation } from '@uuidna/uuidna'
...
export { hostQuantumDevice, runWitnessBattery, LEVEL_PROBES, type QuantumDevice, type WitnessRun } from '@uuidna/uuidna'
export { portCatalogue, portApp, harmoniseOf, type AppPort, type AppCatalogue, type IndexPackage } from '@uuidna/uuidna'
export { fetchCernOpenData, cernPortSearch, renderCernPort, CERN_OD, CERN_PROBE_QUERY, type CernRecord, type CernFetchResult, type CernPortResult } from '@uuidna/uuidna'
