...
uuidna is **not a legal system**. It does not make law, rule, judge, prosecute, or enforce, and it does not certify
that anything is compliant or lawful — those are for legislatures, counsel, and courts. What it *is* is a **recomputable
evidence and integrity layer**: it protects by making claims **verifiable**, so a decision rests on something anyone can
recheck rather than on trust or authority.

## How it protects — by recomputation, not by ruling
...
- It does **not** rule, sentence, prosecute, or accuse a person. It hands humans recheckable facts; **the ruling is a
  human's and a court's.**
- It does **not** certify legal compliance — its own gate refuses "all laws met" as unbacked.
- It does **not** claim to protect everyone from everything. It protects the one thing a fold can: it makes the
