...
**Theorem:** `Colour.lean` (8 theorems, all `by decide`)

Wheel is ℤ/12. Complementary hues opposite (+6). Triads +4. Squares +3.
...
**The Question:** *Does the colour wheel explain why red and green clash beautifully?*
