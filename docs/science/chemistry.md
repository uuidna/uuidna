...
**Theorem:** `Chemistry.lean` (7 theorems, all `by decide`)

Balanced equations conserve atoms. Charge conservation. Oxidation states sum to charge.
...
**The Question:** *Is chemistry just applied physics, or does it have its own logic?*
...
[`Chemistry.lean`](../../lean/Chemistry.lean)
