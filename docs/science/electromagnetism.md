...
**Theorem:** `Electromagnetism.lean` (0 theorems, all `by decide`)
...
**The Question:** *Are fields real or mathematical convenience?*
...
[`Electromagnetism.lean`](../../lean/Electromagnetism.lean)
