...
**Theorem:** `Core.lean` (0 theorems, all `by decide`)
...
**The Question:** *Is the multiplication table the foundation of all number, or do we project meaning onto it?*
