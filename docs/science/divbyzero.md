...
**Theorem:** `DivByZero.lean` (0 theorems, all `by decide`)
...
**The Question:** *Why does mathematics need to make division-by-zero finite?*
...
[`DivByZero.lean`](../../lean/DivByZero.lean)
