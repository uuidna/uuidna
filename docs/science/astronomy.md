...
**Theorem:** `Astronomy.lean` (11 theorems, all `by decide`)

Kepler T²=a³. Metonic cycle 19 years = 235 months. Precession 72 years/degree.
...
**The Question:** *Are we in a special place/time, or is the Earth arbitrary in the cosmos?*
...
[`Astronomy.lean`](../../lean/Astronomy.lean)
