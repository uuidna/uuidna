...
**Theorem:** `Rosette.lean` (0 theorems, all `by decide`)
...
**The Question:** *Why is the seven-fold symmetry so prevalent in nature and culture?*
...
[`Rosette.lean`](../../lean/Rosette.lean)
