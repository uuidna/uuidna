# Life — Mechanism & Meaning

## The Sealed Truth

**Theorem:** `BioPhysics.lean` (16 theorems, all `by decide`)

DNA base-pairing (XOR self-inverse). Neurons fire by threshold. Bonds by electron count.
...
**The Question:** *Can life be completely mechanical AND completely meaningful?*
...
[`BioPhysics.lean`](../../lean/BioPhysics.lean)
