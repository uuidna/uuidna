...
**Theorem:** `SailingSeals.lean` (0 theorems, all `by decide`)
...
**The Question:** *What does Quantum sailing seals mean for how we understand the world?*
...
[`SailingSeals.lean`](../../lean/SailingSeals.lean)
