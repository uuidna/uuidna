...
// VitePress's OWN shipped variable values (read from the real theme-default/styles/vars.css this session, not
// hand-guessed) — the exact colours every component here, including ReferrerNav and ReadAloud, actually renders
// with via var(--vp-c-*). Two blocks: light and dark, since the site ships a real theme toggle.
export const VP_COLORS = {
  light: {
    bg: '#ffffff', bgSoft: '#f6f6f7', divider: '#e2e2e3',
    text1: '#3c3c43', text2: '#67676c', text3: '#929295',
    brand1: '#3451b2', // --vp-c-indigo-1, light
  },
  dark: {
    bg: '#1b1b1f', bgSoft: '#202127', divider: '#2e2e32',
    text1: '#dfdfd6', text2: '#98989f', text3: '#6a6a71',
    brand1: '#a8b1ff', // --vp-c-indigo-1, dark
  },
} as const
