...
that cites another sealed key IS a citation edge, 52 prerequisites over 59 edges at this
...
7. **Seal the input, never its pure function — and know where that stops** — a digest of f(x) moves exactly when
   ...
   **The boundary:** the same reasoning was turned on the 1522-frame aura film and it was wrong. The aura IS
...
## The wings — all 99, computed from the ledger

Every wing the ledger seals, largest first: 1522 theorems across 99 wings and 91 skills.
