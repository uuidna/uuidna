...
that cites another sealed key IS a citation edge, 88 prerequisites over 104 edges at this
...
| [`pythagorean_comma_is_the_drift`](/theorem/pythagorean_comma_is_the_drift) | 1 | [`the_comma_hides_below_hearing`](/theorem/the_comma_hides_below_hearing) |
...
7. **Seal the input, never its pure function — and know where that stops** — a digest of f(x) moves exactly when
   ...
   **The boundary:** the same reasoning was turned on the 1699-frame aura film and it was wrong. The aura IS
...
Every wing the ledger seals, largest first: 1699 theorems across 115 wings and 107 skills.
...
| The conveyor's first wave | `Wave.lean` | wave | 57 | [`a440_drift_is_heard`](/theorem/a440_drift_is_heard) |
...
| The calendar | `Calendar.lean` | calendar | 12 | [`century_leap_rule`](/theorem/century_leap_rule) |
