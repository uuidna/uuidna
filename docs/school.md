...
7. **Seal the input, never its pure function — and know where that stops** — a digest of f(x) moves exactly when
   ...
   **The boundary:** the same reasoning was turned on the 1446-frame aura film and it was wrong. The aura IS
...
Every wing the ledger seals, largest first: 1446 theorems across 94 wings and 86 skills.
...
| The two coins & the 64 | `Coins.lean` | coins | 22 | [`bill_never_negative`](/theorem/bill_never_negative) |
...
| Division by zero | `DivByZero.lean` | reflection | 11 | [`dz_bounded`](/theorem/dz_bounded) |
