...
that cites another sealed key IS a citation edge, 113 prerequisites over 134 edges at this
...
7. **Seal the input, never its pure function — and know where that stops** — a digest of f(x) moves exactly when
   ...
   **The boundary:** the same reasoning was turned on the 2105-frame aura film and it was wrong. The aura IS
...
Every wing the ledger seals, largest first: 2105 theorems across 115 wings and 107 skills.
...
| --- | --- | --- | ---: | --- |
| The conveyor's first wave | `Wave.lean` | wave | 466 | [`a440_drift_is_heard`](/theorem/a440_drift_is_heard) |
