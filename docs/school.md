...
7. **Seal the input, never its pure function — and know where that stops** — a digest of f(x) moves exactly when
   ...
   **The boundary:** the same reasoning was turned on the 1540-frame aura film and it was wrong. The aura IS
...
## The wings — all 101, computed from the ledger

Every wing the ledger seals, largest first: 1540 theorems across 101 wings and 93 skills.
...
| Waves.lean | `Waves.lean` | waves | 11 | [`buddy_pair_squares_the_failure`](/theorem/buddy_pair_squares_the_failure) |
