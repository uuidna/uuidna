...
7. **Seal the input, never its pure function — and know where that stops** — a digest of f(x) moves exactly when
   ...
   **The boundary:** the same reasoning was turned on the 1646-frame aura film and it was wrong. The aura IS
...
Every wing the ledger seals, largest first: 1646 theorems across 112 wings and 104 skills.
...
| The conveyor's first wave | `Wave.lean` | wave | 29 | [`a440_not_on_the_vortex`](/theorem/a440_not_on_the_vortex) |
