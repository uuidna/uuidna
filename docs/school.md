...
7. **Seal the input, never its pure function — and know where that stops** — a digest of f(x) moves exactly when
   ...
   **The boundary:** the same reasoning was turned on the 2654-frame aura film and it was wrong. The aura IS
...
Every wing the ledger seals, largest first: 2654 theorems across 118 wings and 110 skills.
...
| --- | ---: | ---: | ---: | --- |
| how many theorems are sealed? | 355,469 | 6 | 59,244× | `theorems().length` |
| what does the tree hold right now? | 375,989 | 225 | 1,671× | `npm run state` |
...
| the sealed ledger | 1,421,878 | 16 | 88,867× |
