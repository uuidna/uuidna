...
7. **Seal the input, never its pure function — and know where that stops** — a digest of f(x) moves exactly when
   ...
   **The boundary:** the same reasoning was turned on the 1439-frame aura film and it was wrong. The aura IS
...
Every wing the ledger seals, largest first: 1439 theorems across 94 wings and 86 skills.
...
| The quantum computer | `Quantum.lean` | quantum | 50 | [`all_signaling_duality`](/theorem/all_signaling_duality) |
...
| The two coins & the 64 | `Coins.lean` | coins | 19 | [`bill_never_negative`](/theorem/bill_never_negative) |
...
| VectorEquilibrium.lean | `VectorEquilibrium.lean` | vector-equilibrium | 12 | [`dz_involution_digits`](/theorem/dz_involution_digits) |
...
| The reactions domain | `Chemistry.lean` | chemistry | 8 | [`boyles_law`](/theorem/boyles_law) |
...
| Division by zero | `DivByZero.lean` | reflection | 8 | [`dz_bounded`](/theorem/dz_bounded) |
...
| Hexbit.lean | `Hexbit.lean` | hexbit | 8 | [`alphabet_names_each_nibble`](/theorem/alphabet_names_each_nibble) |
