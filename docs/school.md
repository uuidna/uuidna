...
7. **Seal the input, never its pure function — and know where that stops** — a digest of f(x) moves exactly when
   ...
   **The boundary:** the same reasoning was turned on the 2656-frame aura film and it was wrong. The aura IS
...
Every wing the ledger seals, largest first: 2656 theorems across 118 wings and 110 skills.
...
| --- | ---: | ---: | ---: | --- |
| how many theorems are sealed? | 356,524 | 6 | 59,420× | `theorems().length` |
| what does the tree hold right now? | 377,082 | 225 | 1,675× | `npm run state` |
...
| the sealed ledger | 1,426,097 | 16 | 89,131× |
