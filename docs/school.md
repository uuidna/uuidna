...
that cites another sealed key IS a citation edge, 53 prerequisites over 60 edges at this
...
7. **Seal the input, never its pure function — and know where that stops** — a digest of f(x) moves exactly when
   ...
   **The boundary:** the same reasoning was turned on the 1529-frame aura film and it was wrong. The aura IS
...
## The wings — all 100, computed from the ledger

Every wing the ledger seals, largest first: 1529 theorems across 100 wings and 92 skills.
