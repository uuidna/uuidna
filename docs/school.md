...
## Learn — lessons with checked exercises

**[Start learning →](/school/learn)** Every sealed theorem is a lesson: the wing's own words, the statement set as
mathematics, and a predict-the-value exercise checked against the sealed theorem the moment you answer. Keep your
progress under a pseudonymous handle, and seal a certificate when a course is mastered.

## Practice loop — drill, check, meter
...
| --- | --- | --- | --- |
| `uuidna_decide` | `{"input":"2^4=16"}` | [`n_qubit_dimension`](/theorem/n_qubit_dimension) | `verdict="EVALUATED_TRUE"`, `kind="decided-arithmetic"` |
| `uuidna_quantum` | `{"circuit":"bell"}` | [`n_qubit_dimension`](/theorem/n_qubit_dimension) | `circuit="bell"`, `qubits=2` |
| `uuidna_decide` | `{"input":"2^12=4096"}` | [`served_qubit_ceiling`](/theorem/served_qubit_ceiling) | `verdict="EVALUATED_TRUE"`, `kind="decided-arithmetic"` |
...
| --- | ---: | --- |
| [`ve_twentyfour_edges`](/theorem/ve_twentyfour_edges) | 16 | [`the_twelve_neighbours_are_an_independent_set_0`](/theorem/the_twelve_neighbours_are_an_independent_set_0), [`the_twelve_neighbours_are_an_independent_set_1`](/theorem/the_twelve_neighbours_are_an_independent_set_1), [`the_twelve_neighbours_are_an_independent_set_10`](/theorem/the_twelve_neighbours_are_an_independent_set_10) |
| [`n_qubit_dimension`](/theorem/n_qubit_dimension) | 4 | [`n_qubit_dimension_all`](/theorem/n_qubit_dimension_all), [`optimisation_space_is_qubit_dimension`](/theorem/optimisation_space_is_qubit_dimension), [`quantum_is_the_uuid_doubled`](/theorem/quantum_is_the_uuid_doubled) |
| [`rosette_and_vortex_are_coprime`](/theorem/rosette_and_vortex_are_coprime) | 4 | [`the_beam_energies_are_coprime_multiples_of_their_own_step`](/theorem/the_beam_energies_are_coprime_multiples_of_their_own_step), [`the_bounded_search_returns_the_sealed_gcd_verdict`](/theorem/the_bounded_search_returns_the_sealed_gcd_verdict), [`the_vortex_and_the_rosette_are_one_six_cycle`](/theorem/the_vortex_and_the_rosette_are_one_six_cycle) |
| [`rosette_quantum_doubling_is_two_coins`](/theorem/rosette_quantum_doubling_is_two_coins) | 4 | [`a_handle_is_eight_pairs_paid_it_is_sixteen`](/theorem/a_handle_is_eight_pairs_paid_it_is_sixteen), [`b2_is_trinity_rosette`](/theorem/b2_is_trinity_rosette), [`clay_gravity_equals_rosette`](/theorem/clay_gravity_equals_rosette) |
...
| [`alphabetic_three_ranks`](/theorem/alphabetic_three_ranks) | 3 | [`abjad_four_ranks`](/theorem/abjad_four_ranks), [`beast_number_fits_two_readings`](/theorem/beast_number_fits_two_readings), [`genesis_1_1_is_2701`](/theorem/genesis_1_1_is_2701) |
...
| [`digital_root`](/theorem/digital_root) | 3 | [`the_cern_division_survives_casting_out_nines`](/theorem/the_cern_division_survives_casting_out_nines), [`the_cern_totals_close_under_the_ledger_own_reduction`](/theorem/the_cern_totals_close_under_the_ledger_own_reduction), [`z9_digit_sum_folds_to_the_residue_in_three`](/theorem/z9_digit_sum_folds_to_the_residue_in_three) |
| [`gematria_forces_collisions`](/theorem/gematria_forces_collisions) | 3 | [`beast_number_fits_two_readings`](/theorem/beast_number_fits_two_readings), [`collisions_under_one`](/theorem/collisions_under_one), [`genesis_1_1_is_2701`](/theorem/genesis_1_1_is_2701) |
...
| [`agl_order_54`](/theorem/agl_order_54) | 2 | [`the_budget_census_exhausts_the_affine_group`](/theorem/the_budget_census_exhausts_the_affine_group), [`the_mirror_is_a_member_of_the_family_whose_budget_it_moves`](/theorem/the_mirror_is_a_member_of_the_family_whose_budget_it_moves) |
...
| [`a_new_tool_pays_at_most_the_mean_wire_cost`](/theorem/a_new_tool_pays_at_most_the_mean_wire_cost) | 1 | [`the_untested_hundred_pay_a_third_of_the_wire`](/theorem/the_untested_hundred_pay_a_third_of_the_wire) |
...
| [`add_right_cancel_by_induction`](/theorem/add_right_cancel_by_induction) | 1 | [`add_left_cancel_by_induction`](/theorem/add_left_cancel_by_induction) |
| [`alphabet_digital_root_is_nine`](/theorem/alphabet_digital_root_is_nine) | 1 | [`the_aura_pair_the_wheel_cannot_separate`](/theorem/the_aura_pair_the_wheel_cannot_separate) |
| [`alphabet_exceeds_wheel`](/theorem/alphabet_exceeds_wheel) | 1 | [`the_aura_pair_the_wheel_cannot_separate`](/theorem/the_aura_pair_the_wheel_cannot_separate) |
| [`alpine_binding_origins_overcount_16083`](/theorem/alpine_binding_origins_overcount_16083) | 1 | [`origin_surplus_class_by_class_is_the_catalogue_surplus`](/theorem/origin_surplus_class_by_class_is_the_catalogue_surplus) |
| [`alpine_bindings_partition_packages_28635`](/theorem/alpine_bindings_partition_packages_28635) | 1 | [`origin_surplus_class_by_class_is_the_catalogue_surplus`](/theorem/origin_surplus_class_by_class_is_the_catalogue_surplus) |
...
| [`anatomy_e92de628`](/theorem/anatomy_e92de628) | 1 | [`the_grid_widths_are_the_sealed_fortytwo_and_k432`](/theorem/the_grid_widths_are_the_sealed_fortytwo_and_k432) |
| [`aura_alphabet_is_pairwise_distinct`](/theorem/aura_alphabet_is_pairwise_distinct) | 1 | [`the_aura_pair_the_wheel_cannot_separate`](/theorem/the_aura_pair_the_wheel_cannot_separate) |
...
| [`captains_columns_sum_to_ten`](/theorem/captains_columns_sum_to_ten) | 1 | [`the_ten_complement_involutes_the_vortex_through_the_axis`](/theorem/the_ten_complement_involutes_the_vortex_through_the_axis) |
...
| [`closed_grid_differences_sum_to_zero`](/theorem/closed_grid_differences_sum_to_zero) | 1 | [`ring_divergence_is_zero`](/theorem/ring_divergence_is_zero) |
...
| [`cms_events_close_over_their_files`](/theorem/cms_events_close_over_their_files) | 1 | [`the_cern_division_survives_casting_out_nines`](/theorem/the_cern_division_survives_casting_out_nines) |
...
| [`doubling_collapses_nine`](/theorem/doubling_collapses_nine) | 1 | [`the_barren_claim_fails_exactly_at_the_dz_fixed_points`](/theorem/the_barren_claim_fails_exactly_at_the_dz_fixed_points) |
| [`drift_is_named_or_caught`](/theorem/drift_is_named_or_caught) | 1 | [`flat_drift_is_quadratic`](/theorem/flat_drift_is_quadratic) |
| [`dropframe_entangles_the_coins`](/theorem/dropframe_entangles_the_coins) | 1 | [`bell_agreement_carries_no_command`](/theorem/bell_agreement_carries_no_command) |
| [`dz_bounded`](/theorem/dz_bounded) | 1 | [`acceleration_finite`](/theorem/acceleration_finite) |
| [`dz_fixed_points`](/theorem/dz_fixed_points) | 1 | [`the_barren_claim_fails_exactly_at_the_dz_fixed_points`](/theorem/the_barren_claim_fails_exactly_at_the_dz_fixed_points) |
| [`dz_loses_nothing`](/theorem/dz_loses_nothing) | 1 | [`the_barren_claim_fails_exactly_at_the_dz_fixed_points`](/theorem/the_barren_claim_fails_exactly_at_the_dz_fixed_points) |
...
| [`five_is_the_developing_center`](/theorem/five_is_the_developing_center) | 1 | [`the_ten_complement_involutes_the_vortex_through_the_axis`](/theorem/the_ten_complement_involutes_the_vortex_through_the_axis) |
| [`five_is_the_exact_complement`](/theorem/five_is_the_exact_complement) | 1 | [`no_digit_is_an_exact_complement`](/theorem/no_digit_is_an_exact_complement) |
| [`five_orbit_reverses_doubling`](/theorem/five_orbit_reverses_doubling) | 1 | [`reverse_walks_inverse`](/theorem/reverse_walks_inverse) |
| [`five_returns_out_of_phase`](/theorem/five_returns_out_of_phase) | 1 | [`the_barren_claim_fails_exactly_at_the_dz_fixed_points`](/theorem/the_barren_claim_fails_exactly_at_the_dz_fixed_points) |
| [`flag_is_any_refutation`](/theorem/flag_is_any_refutation) | 1 | [`lead_b13fd37a_is_flagged_by_every_single_refuter`](/theorem/lead_b13fd37a_is_flagged_by_every_single_refuter) |
...
| [`gematria_ignores_order`](/theorem/gematria_ignores_order) | 1 | [`theology_counts_in_the_mirror_base`](/theorem/theology_counts_in_the_mirror_base) |
...
| [`involution_2d552f1f`](/theorem/involution_2d552f1f) | 1 | [`the_mirror_is_a_member_of_the_family_whose_budget_it_moves`](/theorem/the_mirror_is_a_member_of_the_family_whose_budget_it_moves) |
| [`involution_b13fd37a`](/theorem/involution_b13fd37a) | 1 | [`lead_b13fd37a_is_flagged_by_every_single_refuter`](/theorem/lead_b13fd37a_is_flagged_by_every_single_refuter) |
...
| [`involution_e92de628`](/theorem/involution_e92de628) | 1 | [`the_pair_grid_misses_the_seventh_factor_of_k432`](/theorem/the_pair_grid_misses_the_seventh_factor_of_k432) |
| [`involution_ef58b583`](/theorem/involution_ef58b583) | 1 | [`the_barren_claim_fails_exactly_at_the_dz_fixed_points`](/theorem/the_barren_claim_fails_exactly_at_the_dz_fixed_points) |
...
| [`llm_folds_to_hexbit_pairs`](/theorem/llm_folds_to_hexbit_pairs) | 1 | [`intelligence_without_the_artificial_is_lean`](/theorem/intelligence_without_the_artificial_is_lean) |
...
| [`maps_differ_in_reach`](/theorem/maps_differ_in_reach) | 1 | [`the_barren_claim_fails_exactly_at_the_dz_fixed_points`](/theorem/the_barren_claim_fails_exactly_at_the_dz_fixed_points) |
| [`mass_coord_clay_seven_has_centre`](/theorem/mass_coord_clay_seven_has_centre) | 1 | [`two_coins_make_a_coil_and_seven_coils_are_one_and_six`](/theorem/two_coins_make_a_coil_and_seven_coils_are_one_and_six) |
| [`mcp_tool_coverage_partition_244`](/theorem/mcp_tool_coverage_partition_244) | 1 | [`the_untested_hundred_pay_a_third_of_the_wire`](/theorem/the_untested_hundred_pay_a_third_of_the_wire) |
...
| [`minting_is_two_per_theorem`](/theorem/minting_is_two_per_theorem) | 1 | [`blockchain_is_the_ledger_of_two_coins`](/theorem/blockchain_is_the_ledger_of_two_coins) |
| [`mirror_congruence`](/theorem/mirror_congruence) | 1 | [`the_mirror_is_a_member_of_the_family_whose_budget_it_moves`](/theorem/the_mirror_is_a_member_of_the_family_whose_budget_it_moves) |
...
| [`mul_add_by_induction`](/theorem/mul_add_by_induction) | 1 | [`mul_assoc_by_induction`](/theorem/mul_assoc_by_induction) |
| [`mul_assoc_by_induction`](/theorem/mul_assoc_by_induction) | 1 | [`shl_pow`](/theorem/shl_pow) |
| [`n_qubit_dimension_all`](/theorem/n_qubit_dimension_all) | 1 | [`shift_is_the_dimension`](/theorem/shift_is_the_dimension) |
...
| [`not_dvd_of_bound_e92de628`](/theorem/not_dvd_of_bound_e92de628) | 1 | [`the_bounded_search_returns_the_sealed_gcd_verdict`](/theorem/the_bounded_search_returns_the_sealed_gcd_verdict) |
...
| [`oos_physical_sidechannel`](/theorem/oos_physical_sidechannel) | 1 | [`absence_defeats_the_algorithm_and_not_the_machine`](/theorem/absence_defeats_the_algorithm_and_not_the_machine) |
...
| [`partition_six_three`](/theorem/partition_six_three) | 1 | [`the_budget_census_exhausts_the_affine_group`](/theorem/the_budget_census_exhausts_the_affine_group) |
...
| [`reconciled_b13fd37a`](/theorem/reconciled_b13fd37a) | 1 | [`reconciled_generator_sat_inside_the_truncated_run`](/theorem/reconciled_generator_sat_inside_the_truncated_run) |
...
| [`ring_divergence_is_zero`](/theorem/ring_divergence_is_zero) | 1 | [`ring_shift_preserves_sum`](/theorem/ring_shift_preserves_sum) |
...
| [`shl_pow`](/theorem/shl_pow) | 1 | [`shift_is_the_dimension`](/theorem/shift_is_the_dimension) |
...
| [`three_refuters_monotone`](/theorem/three_refuters_monotone) | 1 | [`lead_b13fd37a_is_flagged_by_every_single_refuter`](/theorem/lead_b13fd37a_is_flagged_by_every_single_refuter) |
...
| [`zero_closes_in_phase`](/theorem/zero_closes_in_phase) | 1 | [`the_barren_claim_fails_exactly_at_the_dz_fixed_points`](/theorem/the_barren_claim_fails_exactly_at_the_dz_fixed_points) |
<!-- /prereqs -->
...
7. **Seal the input, never its pure function — and know where that stops** — a digest of f(x) moves exactly when
   ...
   **The boundary:** the same reasoning was turned on the 71022-frame aura film and it was wrong. The aura IS
...
Every wing the ledger seals, largest first: 71022 theorems across 252 wings and 118 skills.
...
| --- | --- | --- | ---: | --- |
| The four-hex span, part 1 | `HexSpan1.lean` | wave | 4096 | [`enumeration_hex4_0000`](/theorem/enumeration_hex4_0000) |
| The four-hex span, part 10 | `HexSpan10.lean` | wave | 4096 | [`enumeration_hex4_9000`](/theorem/enumeration_hex4_9000) |
| The four-hex span, part 11 | `HexSpan11.lean` | wave | 4096 | [`enumeration_hex4_a000`](/theorem/enumeration_hex4_a000) |
| The four-hex span, part 12 | `HexSpan12.lean` | wave | 4096 | [`enumeration_hex4_b000`](/theorem/enumeration_hex4_b000) |
| The four-hex span, part 13 | `HexSpan13.lean` | wave | 4096 | [`enumeration_hex4_c000`](/theorem/enumeration_hex4_c000) |
| The four-hex span, part 14 | `HexSpan14.lean` | wave | 4096 | [`enumeration_hex4_d000`](/theorem/enumeration_hex4_d000) |
| The four-hex span, part 15 | `HexSpan15.lean` | wave | 4096 | [`enumeration_hex4_e000`](/theorem/enumeration_hex4_e000) |
| The four-hex span, part 16 | `HexSpan16.lean` | wave | 4096 | [`enumeration_hex4_f000`](/theorem/enumeration_hex4_f000) |
| The four-hex span, part 2 | `HexSpan2.lean` | wave | 4096 | [`enumeration_hex4_1000`](/theorem/enumeration_hex4_1000) |
| The four-hex span, part 3 | `HexSpan3.lean` | wave | 4096 | [`enumeration_hex4_2000`](/theorem/enumeration_hex4_2000) |
| The four-hex span, part 4 | `HexSpan4.lean` | wave | 4096 | [`enumeration_hex4_3000`](/theorem/enumeration_hex4_3000) |
| The four-hex span, part 5 | `HexSpan5.lean` | wave | 4096 | [`enumeration_hex4_4000`](/theorem/enumeration_hex4_4000) |
| The four-hex span, part 6 | `HexSpan6.lean` | wave | 4096 | [`enumeration_hex4_5000`](/theorem/enumeration_hex4_5000) |
| The four-hex span, part 7 | `HexSpan7.lean` | wave | 4096 | [`enumeration_hex4_6000`](/theorem/enumeration_hex4_6000) |
| The four-hex span, part 8 | `HexSpan8.lean` | wave | 4096 | [`enumeration_hex4_7000`](/theorem/enumeration_hex4_7000) |
| The four-hex span, part 9 | `HexSpan9.lean` | wave | 4096 | [`enumeration_hex4_8000`](/theorem/enumeration_hex4_8000) |
| The conveyor's first wave | `Wave.lean` | wave | 968 | [`a440_drift_is_heard`](/theorem/a440_drift_is_heard) |
| The fixed points of x to the m, as a law | `FixedPower.lean` | fermat | 567 | [`fixed_power_law_is_not_vacuous`](/theorem/fixed_power_law_is_not_vacuous) |
| The laws behind the counts | `Laws.lean` | wave | 353 | [`carmichael_exponent_is_attained_mod_10`](/theorem/carmichael_exponent_is_attained_mod_10) |
...
| The congruence survey, ring 12 | `FermatRing12.lean` | fermat | 96 | [`coprime_sum_blocked_reduced_10_mod_77_part1`](/theorem/coprime_sum_blocked_reduced_10_mod_77_part1) |
| The heaps | `Nim.lean` | nim | 93 | [`grundy_sum_is_xor`](/theorem/grundy_sum_is_xor) |
| The congruence survey, ring 9 | `FermatRing9.lean` | fermat | 83 | [`coprime_sum_blocked_reduced_10_mod_11`](/theorem/coprime_sum_blocked_reduced_10_mod_11) |
| The congruence survey, ring 15 | `FermatRing15.lean` | fermat | 82 | [`coprime_sum_blocked_reduced_10_mod_101_part1`](/theorem/coprime_sum_blocked_reduced_10_mod_101_part1) |
| The congruence survey, ring 16 | `FermatRing16.lean` | fermat | 82 | [`coprime_sum_blocked_reduced_10_mod_123_part1`](/theorem/coprime_sum_blocked_reduced_10_mod_123_part1) |
| The congruence survey, ring 6 | `FermatRing6.lean` | fermat | 82 | [`coprime_sum_blocked_reduced_10_mod_50`](/theorem/coprime_sum_blocked_reduced_10_mod_50) |
| The congruence survey, ring 17 | `FermatRing17.lean` | fermat | 79 | [`coprime_sum_blocked_reduced_10_mod_124_part1`](/theorem/coprime_sum_blocked_reduced_10_mod_124_part1) |
| The congruence survey, ring 18 | `FermatRing18.lean` | fermat | 78 | [`coprime_sum_blocked_reduced_10_mod_125_part1`](/theorem/coprime_sum_blocked_reduced_10_mod_125_part1) |
| The congruence survey, ring 14 | `FermatRing14.lean` | fermat | 76 | [`coprime_sum_blocked_reduced_10_mod_100`](/theorem/coprime_sum_blocked_reduced_10_mod_100) |
| The congruence survey, ring 8 | `FermatRing8.lean` | fermat | 75 | [`coprime_sum_blocked_reduced_10_mod_31`](/theorem/coprime_sum_blocked_reduced_10_mod_31) |
| The congruence survey, ring 5 | `FermatRing5.lean` | fermat | 73 | [`coprime_sum_blocked_reduced_12_mod_112`](/theorem/coprime_sum_blocked_reduced_12_mod_112) |
| The congruence survey, ring 4 | `FermatRing4.lean` | fermat | 72 | [`coprime_sum_blocked_reduced_11_mod_69`](/theorem/coprime_sum_blocked_reduced_11_mod_69) |
| The congruence survey, ring 11 | `FermatRing11.lean` | fermat | 71 | [`coprime_sum_blocked_reduced_10_mod_55`](/theorem/coprime_sum_blocked_reduced_10_mod_55) |
| The congruence survey, ring 10 | `FermatRing10.lean` | fermat | 69 | [`coprime_sum_blocked_reduced_10_mod_33`](/theorem/coprime_sum_blocked_reduced_10_mod_33) |
| The congruence survey, ring 13 | `FermatRing13.lean` | fermat | 66 | [`coprime_sum_blocked_reduced_10_mod_99_part1`](/theorem/coprime_sum_blocked_reduced_10_mod_99_part1) |
| The six-cube and its polarity double | `Equilibrium.lean` | wave | 65 | [`hexcube_degree_is_six_0`](/theorem/hexcube_degree_is_six_0) |
| The quantum computer | `Quantum.lean` | quantum | 65 | [`all_signaling_duality`](/theorem/all_signaling_duality) |
| The 8×8 core | `Core.lean` | z9-ring | 64 | [`mul9_1_1`](/theorem/mul9_1_1) |
| The congruence survey, ring 3 | `FermatRing3.lean` | fermat | 63 | [`coprime_sum_blocked_reduced_10_mod_110`](/theorem/coprime_sum_blocked_reduced_10_mod_110) |
| The congruence survey, ring 7 | `FermatRing7.lean` | fermat | 63 | [`coprime_sum_blocked_reduced_10_mod_93_part1`](/theorem/coprime_sum_blocked_reduced_10_mod_93_part1) |
| The congruence survey, ring 2 | `FermatRing2.lean` | fermat | 58 | [`coprime_sum_blocked_reduced_10_mod_25`](/theorem/coprime_sum_blocked_reduced_10_mod_25) |
| The congruence survey, ring 20 | `FermatRing20.lean` | fermat | 58 | [`coprime_sum_blocked_reduced_10_mod_22`](/theorem/coprime_sum_blocked_reduced_10_mod_22) |
| The congruence survey, ring 1 | `FermatRing1.lean` | fermat | 57 | [`coprime_sum_blocked_reduced_10_mod_66`](/theorem/coprime_sum_blocked_reduced_10_mod_66) |
| The congruence survey, ring 19 | `FermatRing19.lean` | fermat | 55 | [`coprime_sum_blocked_reduced_12_mod_105`](/theorem/coprime_sum_blocked_reduced_12_mod_105) |
| The congruence survey, ring 21 | `FermatRing21.lean` | fermat | 46 | [`coprime_sum_blocked_reduced_10_mod_44`](/theorem/coprime_sum_blocked_reduced_10_mod_44) |
| The cipher & the strand | `Cipher.lean` | cipher | 38 | [`adversarial_privacy_is_unanimous`](/theorem/adversarial_privacy_is_unanimous) |
| The exponent reduction, one table per lambda | `FermatReduction.lean` | fermat | 35 | [`exponent_reduces_at_lambda_10`](/theorem/exponent_reduces_at_lambda_10) |
| The sequence & reflection group | `Sequence.lean` | sequence | 33 | [`agl_order_54`](/theorem/agl_order_54) |
| The binding point: a width is its smallest term | `BindingPoint.lean` | wave | 29 | [`a_richer_point_never_narrows_the_width_0`](/theorem/a_richer_point_never_narrows_the_width_0) |
| The two coins & the 64 | `Coins.lean` | coins | 25 | [`bill_never_negative`](/theorem/bill_never_negative) |
| The fluid grid | `Fluid.lean` | clay | 25 | [`add_left_cancel_by_induction`](/theorem/add_left_cancel_by_induction) |
...
| The render budget re-measured | `RenderBudget.lean` | render-budget | 8 | [`a_new_tool_pays_at_most_the_mean_wire_cost`](/theorem/a_new_tool_pays_at_most_the_mean_wire_cost) |
...
| The right to land and the public's access to it | `LandRights.lean` | legal | 7 | [`access_laws_stand_centuries_after_the_charter_of_the_forest`](/theorem/access_laws_stand_centuries_after_the_charter_of_the_forest) |
...
| Crosslinks: the addressing is the floor | `Crosslink.lean` | wave | 6 | [`a_tree_uses_one_link_per_leaf_and_no_more`](/theorem/a_tree_uses_one_link_per_leaf_and_no_more) |
...
| Five open problems, and what this ledger can honestly say | `OpenProblems.lean` | wave | 6 | [`conway_ninetynine_counting_identity_holds`](/theorem/conway_ninetynine_counting_identity_holds) |
| The light domain | `Optics.lean` | optics | 6 | [`law_of_reflection`](/theorem/law_of_reflection) |
| The periodic table's shape | `Periodic.lean` | wave | 6 | [`a_shell_holds_two_n_squared`](/theorem/a_shell_holds_two_n_squared) |
...
| What the refusal was refusing to fuse | `Refusion.lean` | wave | 6 | [`a_defence_already_standing_precedes_any_pending_attack`](/theorem/a_defence_already_standing_precedes_any_pending_attack) |
| The reversal | `Reversal.lean` | reversal | 6 | [`censuses_differ`](/theorem/censuses_differ) |
| The arithmetic of scripture | `Scripture.lean` | scripture | 6 | [`augustine_six_is_perfect`](/theorem/augustine_six_is_perfect) |
...
| The CERN crossings | `CernLinks.lean` | links | 5 | [`the_beam_energies_are_coprime_multiples_of_their_own_step`](/theorem/the_beam_energies_are_coprime_multiples_of_their_own_step) |
...
| The cube that holds the solids, and the axis that costs nothing | `QuantumCube.lean` | wave | 5 | [`a_cheaper_representation_multiplies_the_width_at_the_same_hardware`](/theorem/a_cheaper_representation_multiplies_the_width_at_the_same_hardware) |
| A hundred thousand billion poems | `Queneau.lean` | wave | 5 | [`queneau_a_sonnet_is_eight_and_six`](/theorem/queneau_a_sonnet_is_eight_and_six) |
...
| The six-cube translation by 9 | `EquilibriumXor10.lean` | wave | 1 | [`xor_translation_preserves_adjacency_9`](/theorem/xor_translation_preserves_adjacency_9) |
| The six-cube translation by 10 | `EquilibriumXor11.lean` | wave | 1 | [`xor_translation_preserves_adjacency_10`](/theorem/xor_translation_preserves_adjacency_10) |
| The six-cube translation by 11 | `EquilibriumXor12.lean` | wave | 1 | [`xor_translation_preserves_adjacency_11`](/theorem/xor_translation_preserves_adjacency_11) |
| The six-cube translation by 12 | `EquilibriumXor13.lean` | wave | 1 | [`xor_translation_preserves_adjacency_12`](/theorem/xor_translation_preserves_adjacency_12) |
| The six-cube translation by 13 | `EquilibriumXor14.lean` | wave | 1 | [`xor_translation_preserves_adjacency_13`](/theorem/xor_translation_preserves_adjacency_13) |
| The six-cube translation by 14 | `EquilibriumXor15.lean` | wave | 1 | [`xor_translation_preserves_adjacency_14`](/theorem/xor_translation_preserves_adjacency_14) |
| The six-cube translation by 15 | `EquilibriumXor16.lean` | wave | 1 | [`xor_translation_preserves_adjacency_15`](/theorem/xor_translation_preserves_adjacency_15) |
| The six-cube translation by 16 | `EquilibriumXor17.lean` | wave | 1 | [`xor_translation_preserves_adjacency_16`](/theorem/xor_translation_preserves_adjacency_16) |
| The six-cube translation by 17 | `EquilibriumXor18.lean` | wave | 1 | [`xor_translation_preserves_adjacency_17`](/theorem/xor_translation_preserves_adjacency_17) |
| The six-cube translation by 18 | `EquilibriumXor19.lean` | wave | 1 | [`xor_translation_preserves_adjacency_18`](/theorem/xor_translation_preserves_adjacency_18) |
| The six-cube translation by 1 | `EquilibriumXor2.lean` | wave | 1 | [`xor_translation_preserves_adjacency_1`](/theorem/xor_translation_preserves_adjacency_1) |
| The six-cube translation by 19 | `EquilibriumXor20.lean` | wave | 1 | [`xor_translation_preserves_adjacency_19`](/theorem/xor_translation_preserves_adjacency_19) |
| The six-cube translation by 20 | `EquilibriumXor21.lean` | wave | 1 | [`xor_translation_preserves_adjacency_20`](/theorem/xor_translation_preserves_adjacency_20) |
| The six-cube translation by 21 | `EquilibriumXor22.lean` | wave | 1 | [`xor_translation_preserves_adjacency_21`](/theorem/xor_translation_preserves_adjacency_21) |
| The six-cube translation by 22 | `EquilibriumXor23.lean` | wave | 1 | [`xor_translation_preserves_adjacency_22`](/theorem/xor_translation_preserves_adjacency_22) |
| The six-cube translation by 23 | `EquilibriumXor24.lean` | wave | 1 | [`xor_translation_preserves_adjacency_23`](/theorem/xor_translation_preserves_adjacency_23) |
| The six-cube translation by 24 | `EquilibriumXor25.lean` | wave | 1 | [`xor_translation_preserves_adjacency_24`](/theorem/xor_translation_preserves_adjacency_24) |
| The six-cube translation by 25 | `EquilibriumXor26.lean` | wave | 1 | [`xor_translation_preserves_adjacency_25`](/theorem/xor_translation_preserves_adjacency_25) |
| The six-cube translation by 26 | `EquilibriumXor27.lean` | wave | 1 | [`xor_translation_preserves_adjacency_26`](/theorem/xor_translation_preserves_adjacency_26) |
| The six-cube translation by 27 | `EquilibriumXor28.lean` | wave | 1 | [`xor_translation_preserves_adjacency_27`](/theorem/xor_translation_preserves_adjacency_27) |
| The six-cube translation by 28 | `EquilibriumXor29.lean` | wave | 1 | [`xor_translation_preserves_adjacency_28`](/theorem/xor_translation_preserves_adjacency_28) |
| The six-cube translation by 2 | `EquilibriumXor3.lean` | wave | 1 | [`xor_translation_preserves_adjacency_2`](/theorem/xor_translation_preserves_adjacency_2) |
| The six-cube translation by 29 | `EquilibriumXor30.lean` | wave | 1 | [`xor_translation_preserves_adjacency_29`](/theorem/xor_translation_preserves_adjacency_29) |
| The six-cube translation by 30 | `EquilibriumXor31.lean` | wave | 1 | [`xor_translation_preserves_adjacency_30`](/theorem/xor_translation_preserves_adjacency_30) |
| The six-cube translation by 31 | `EquilibriumXor32.lean` | wave | 1 | [`xor_translation_preserves_adjacency_31`](/theorem/xor_translation_preserves_adjacency_31) |
| The six-cube translation by 32 | `EquilibriumXor33.lean` | wave | 1 | [`xor_translation_preserves_adjacency_32`](/theorem/xor_translation_preserves_adjacency_32) |
| The six-cube translation by 33 | `EquilibriumXor34.lean` | wave | 1 | [`xor_translation_preserves_adjacency_33`](/theorem/xor_translation_preserves_adjacency_33) |
| The six-cube translation by 34 | `EquilibriumXor35.lean` | wave | 1 | [`xor_translation_preserves_adjacency_34`](/theorem/xor_translation_preserves_adjacency_34) |
| The six-cube translation by 35 | `EquilibriumXor36.lean` | wave | 1 | [`xor_translation_preserves_adjacency_35`](/theorem/xor_translation_preserves_adjacency_35) |
| The six-cube translation by 36 | `EquilibriumXor37.lean` | wave | 1 | [`xor_translation_preserves_adjacency_36`](/theorem/xor_translation_preserves_adjacency_36) |
| The six-cube translation by 37 | `EquilibriumXor38.lean` | wave | 1 | [`xor_translation_preserves_adjacency_37`](/theorem/xor_translation_preserves_adjacency_37) |
| The six-cube translation by 38 | `EquilibriumXor39.lean` | wave | 1 | [`xor_translation_preserves_adjacency_38`](/theorem/xor_translation_preserves_adjacency_38) |
| The six-cube translation by 3 | `EquilibriumXor4.lean` | wave | 1 | [`xor_translation_preserves_adjacency_3`](/theorem/xor_translation_preserves_adjacency_3) |
| The six-cube translation by 39 | `EquilibriumXor40.lean` | wave | 1 | [`xor_translation_preserves_adjacency_39`](/theorem/xor_translation_preserves_adjacency_39) |
| The six-cube translation by 40 | `EquilibriumXor41.lean` | wave | 1 | [`xor_translation_preserves_adjacency_40`](/theorem/xor_translation_preserves_adjacency_40) |
| The six-cube translation by 41 | `EquilibriumXor42.lean` | wave | 1 | [`xor_translation_preserves_adjacency_41`](/theorem/xor_translation_preserves_adjacency_41) |
| The six-cube translation by 42 | `EquilibriumXor43.lean` | wave | 1 | [`xor_translation_preserves_adjacency_42`](/theorem/xor_translation_preserves_adjacency_42) |
| The six-cube translation by 43 | `EquilibriumXor44.lean` | wave | 1 | [`xor_translation_preserves_adjacency_43`](/theorem/xor_translation_preserves_adjacency_43) |
| The six-cube translation by 44 | `EquilibriumXor45.lean` | wave | 1 | [`xor_translation_preserves_adjacency_44`](/theorem/xor_translation_preserves_adjacency_44) |
| The six-cube translation by 45 | `EquilibriumXor46.lean` | wave | 1 | [`xor_translation_preserves_adjacency_45`](/theorem/xor_translation_preserves_adjacency_45) |
| The six-cube translation by 46 | `EquilibriumXor47.lean` | wave | 1 | [`xor_translation_preserves_adjacency_46`](/theorem/xor_translation_preserves_adjacency_46) |
| The six-cube translation by 47 | `EquilibriumXor48.lean` | wave | 1 | [`xor_translation_preserves_adjacency_47`](/theorem/xor_translation_preserves_adjacency_47) |
| The six-cube translation by 48 | `EquilibriumXor49.lean` | wave | 1 | [`xor_translation_preserves_adjacency_48`](/theorem/xor_translation_preserves_adjacency_48) |
| The six-cube translation by 4 | `EquilibriumXor5.lean` | wave | 1 | [`xor_translation_preserves_adjacency_4`](/theorem/xor_translation_preserves_adjacency_4) |
| The six-cube translation by 49 | `EquilibriumXor50.lean` | wave | 1 | [`xor_translation_preserves_adjacency_49`](/theorem/xor_translation_preserves_adjacency_49) |
| The six-cube translation by 50 | `EquilibriumXor51.lean` | wave | 1 | [`xor_translation_preserves_adjacency_50`](/theorem/xor_translation_preserves_adjacency_50) |
| The six-cube translation by 51 | `EquilibriumXor52.lean` | wave | 1 | [`xor_translation_preserves_adjacency_51`](/theorem/xor_translation_preserves_adjacency_51) |
| The six-cube translation by 52 | `EquilibriumXor53.lean` | wave | 1 | [`xor_translation_preserves_adjacency_52`](/theorem/xor_translation_preserves_adjacency_52) |
| The six-cube translation by 53 | `EquilibriumXor54.lean` | wave | 1 | [`xor_translation_preserves_adjacency_53`](/theorem/xor_translation_preserves_adjacency_53) |
| The six-cube translation by 54 | `EquilibriumXor55.lean` | wave | 1 | [`xor_translation_preserves_adjacency_54`](/theorem/xor_translation_preserves_adjacency_54) |
| The six-cube translation by 55 | `EquilibriumXor56.lean` | wave | 1 | [`xor_translation_preserves_adjacency_55`](/theorem/xor_translation_preserves_adjacency_55) |
| The six-cube translation by 56 | `EquilibriumXor57.lean` | wave | 1 | [`xor_translation_preserves_adjacency_56`](/theorem/xor_translation_preserves_adjacency_56) |
| The six-cube translation by 57 | `EquilibriumXor58.lean` | wave | 1 | [`xor_translation_preserves_adjacency_57`](/theorem/xor_translation_preserves_adjacency_57) |
| The six-cube translation by 58 | `EquilibriumXor59.lean` | wave | 1 | [`xor_translation_preserves_adjacency_58`](/theorem/xor_translation_preserves_adjacency_58) |
| The six-cube translation by 5 | `EquilibriumXor6.lean` | wave | 1 | [`xor_translation_preserves_adjacency_5`](/theorem/xor_translation_preserves_adjacency_5) |
| The six-cube translation by 59 | `EquilibriumXor60.lean` | wave | 1 | [`xor_translation_preserves_adjacency_59`](/theorem/xor_translation_preserves_adjacency_59) |
| The six-cube translation by 60 | `EquilibriumXor61.lean` | wave | 1 | [`xor_translation_preserves_adjacency_60`](/theorem/xor_translation_preserves_adjacency_60) |
| The six-cube translation by 61 | `EquilibriumXor62.lean` | wave | 1 | [`xor_translation_preserves_adjacency_61`](/theorem/xor_translation_preserves_adjacency_61) |
| The six-cube translation by 62 | `EquilibriumXor63.lean` | wave | 1 | [`xor_translation_preserves_adjacency_62`](/theorem/xor_translation_preserves_adjacency_62) |
| The six-cube translation by 63 | `EquilibriumXor64.lean` | wave | 1 | [`xor_translation_preserves_adjacency_63`](/theorem/xor_translation_preserves_adjacency_63) |
| The six-cube translation by 6 | `EquilibriumXor7.lean` | wave | 1 | [`xor_translation_preserves_adjacency_6`](/theorem/xor_translation_preserves_adjacency_6) |
| The six-cube translation by 7 | `EquilibriumXor8.lean` | wave | 1 | [`xor_translation_preserves_adjacency_7`](/theorem/xor_translation_preserves_adjacency_7) |
| The six-cube translation by 8 | `EquilibriumXor9.lean` | wave | 1 | [`xor_translation_preserves_adjacency_8`](/theorem/xor_translation_preserves_adjacency_8) |
| The involution of lead 83b7cc65 | `Involution83b7cc65.lean` | involution | 1 | [`involution_83b7cc65`](/theorem/involution_83b7cc65) |
| The involution of lead 90c4f258 | `Involution90c4f258.lean` | involution | 1 | [`involution_90c4f258`](/theorem/involution_90c4f258) |
| The proof of lead de5612a2 | `Proofde5612a2.lean` | involution | 1 | [`proof_de5612a2`](/theorem/proof_de5612a2) |
| The proof of lead f59dbc3d | `Prooff59dbc3d.lean` | involution | 1 | [`proof_f59dbc3d`](/theorem/proof_f59dbc3d) |
<!-- /wings -->
...
- **trial** · `de5612a2` — The 42-state paired walk: doubling in Z/9 (period 6) against stepping by two in Z/7 (period 7). Coprime, so the pair has period exactly 42 and visits all 42 states before returning. Forward and inverse walks meet at step…
  <br><small>Rathbun's odd-cylinder gcd(2,n)=1 stands on the engine side alone; it does not witness the vortex/firing-order merge.</small>
- **trial** · `c83060ec` — Girdler sulfide dual-temperature exchange as separation-by-involution: the equilibrium preference reverses between a cold and a hot tower, so cycling enriches where neither pass alone separates.
  <br><small>Separation-by-involution remains sealed for the digit walk (Phase.lean / Thermodynamics.lean); that does not license a chemistry claim.</small>
- **trial** · `4642b5b4` — The compression 2^128 addresses → 10 seeds → 5 covering → ×12 VE directions → ×7 rays = 420 is real arithmetic, but the collapse ratio proves nothing on its own: ANY fold to ten classes turns billions into tens. That bou…
  <br><small>The lead stated its own boundary; this records it.</small>
- **trial** · `4092e4c9` — Dual-base wing harmony (w divisible by 15) as a release-blocking grid gate
  <br><small>Captain 2026-08-27 with the grid re-seal.</small>
- **trial** · `ff24b99e` — Over-unity / free energy devices
  <br><small>'Free' in Gibbs energy means AVAILABLE, not gratis: G = H - TS is a ceiling on extractable work, which is why IUPAC dropped the word.</small>
- **trial** · `63632e0e` — Water itself as fuel
  <br><small>Hydrogen fusion inverts it again: the deuterium in one mole of water yields ~190x the energy needed to split that mole. Different layer of the same molecule.</small>
- **trial** · `24641eb5` — MFC exhausting pure drinkable water
- **trial** · `0c36ef19` — Bulk crawling of chitanka.info
  <br><small>Wikisource is open to machines and carries the same public-domain canon — the substitute, not a consolation.</small>
- **trial** · `607701a3` — Quantum advantage or speedup claims
- **trial** · `228e89d2` — stackoverflow.com /ai-assist as a theorem source
- **trial** · `4495c8dd` — Import ceccec.psg.bg papers, kebab theorem slugs, or that site's Clay OPEN mixed with SEALED as uuidna theorems.
  <br><small>External research wave 2026-08-28: examine only, do not port. Origin Clay on that site is a different court.</small>
- **trial** · `1a11d61c` — Port origin BackgroundMovie / sharedHeroAt / quantumModelSnapshot 10D (6 appearance + 4 homology) as uuidna HeroAnimation or HexFace.
- **trial** · `d84f3bfe` — Scrape King Wen, sephirot, chakra, or deity-name tables into occupancy, Lean, or hero chrome.
- **trial** · `62b5ab2f` — Honesty /  fields, covering hunts, or includes() disclaimer tests on new constructors.
- **trial** · `a7480598` — Desk auto-seals, mints a theorem key, or writes a statement/name/claim into src/.
- **trial** · `27321b4d` — Replace ChaCha20-Poly1305 with the 256-triangle fold as the secrecy primitive.
- **trial** · `6726dc46` — Run gen-quantum-capacity or rewrite IBM/Google figures as this wave.
- **trial** · `c1b5cd04` — Invent versionSeat or collapse the four hexbit widths 4 / 8 / 16 / 32.
- **trial** · `c9ddc617` — All quantum threat is gone with uuidna — including Grover, timing, and Bitcoin ECDSA.
- **trial** · `fa07226e` — shadcn/ui distributes flat files through a served, schema-d, namespaced catalogue (registry.json + registry-item.json, 12 item types, @namespace/name, ${ENV} auth headers, an MCP door that installs). uuidna generates 255…
- **reopened** · `8609c55d` — HexFace draws two projected polygons (yang/yin tets) plus eight vertices, not 256 unit triangles packing 32 merkabas (256/8 = UUID_HEXBITS).
  <br><small>claimed: <q>PAID. hexFaceOf stamps packedTriangles = KEY_BITS (UUID_BITS × COINS) and merkabasPacked = UUID_HEXBITS. HexFace still draws two projected polygons — 2D is art. The count sits on the face as constructors, not as 256 drawn triangles.</q> · owes the sealed theorem that proves what it meant</small>
- **reopened** · `0809c1db` — fruitOfLife XY pitch (28 / 14 / 24) is authored art integers; the sealed fact is the centre count (SAFE_HEXBITS, metatron_seventyeight_lines).
  <br><small>claimed: <q>PAID. Pitch is qx = UUID_HEXBITS − HEXBIT_BITS, rx = qx / COINS, ry = UUID_HEXBITS − HANDLE_HEXBITS. Centre count unchanged. No fruit-of-life canon scraped.</q> · owes the sealed theorem that proves what it meant</small>
- **reopened** · `f2a53b08` — PI_ROOF_NUM = 22 is still a numeral beside the Nat roof walk (PI_ROOF × rung + remainder = product).
  <br><small>claimed: <q>PAID. PI_ROOF_NUM = HEXBIT_STATES + HEXAGRAM_BITS. Nat division PI_ROOF = natDiv(PI_ROOF_NUM × PI_ENGINE, fuseWidth(HANDLE_HEXBITS, COINS)) unchanged. JS / stays unused for the roof.</q> · owes the sealed theorem that proves what it meant</small>
- **reopened** · `3a1811a1` — axiom-hunt live predicates still pin A432_HZ === 432, coins() × A432_HZ === 864, A432_HZ × 16 === 6912, SAMPLE_RATE/2 === 8000, MAX_SERVED_QUBITS === 12 and 1&amp;lt;&amp;lt;12 === 4096.
  <br><small>claimed: <q>PAID. A432_HZ = HEXBIT_STATES × (TRINITY ** TRINITY). Hunt walks constructors: k432, coins() × lattice, Nyquist A432_HZ × HEXBIT_STATES &amp;lt; SAMPLE_RATE / coins(), MAX_SERVED_QUBITS = HANDLE_HEXBITS + HEXBIT_BITS ≤ MAX_MESSAGE_QUBITS. No frozen 432/864/6912/8000/12/4096 equals.</q> · owes the sealed theorem that proves what it meant</small>
- **reopened** · `bde0066b` — kdf_cost_bounded was removed from axiom-hunt because the theorem only compared the numerals 600000 ≤ 10000000. ITER / MAX_ITER still bind in crypt.ts and one-receipt.
  <br><small>claimed: <q>NAMED LEFTOVER, bound live. aead_nonce_and_salt_bits now requires ITER &amp;gt; 0 && ITER &amp;lt; MAX_ITER. No wording theorem minted. kdf_cost_bounded stays gone.</q> · owes the sealed theorem that proves what it meant</small>
- **reopened** · `a245d44e` — trading-shelf.test.ts and harmony-scan.test.ts still hunt honesty by honest.includes('never money' / 'no currency' / 'NOT a medical device').
  <br><small>claimed: <q>PAID. Wording trials dropped. Trading shelf still checks bills are non-negative and scale with work. Harmony scan still checks agrees, findings, peak, receipt. Existing honest: payloads on constructors untouched.</q> · owes the sealed theorem that proves what it meant</small>
- **reopened** · `965ea588` — VitePress client externalizes node:fs via src/seo-freeze.ts, so HexFace cannot be verified in the browser (dev server abort after the fs error).
  <br><small>claimed: <q>PAID. seo-freeze and prepublish-seal off the client barrel. axiom-witness and security-audit drop unused static node:fs (rdRoot only). palette imports dist/css.js. Hex-face barrel graph test covers those files. Tests still run on dist after tsc.</q> · owes the sealed theorem that proves what it meant</small>
- **reopened** · `92213be8` — CRT axiom-free still fails in the in-tree v030-balance-trial / sequence-coverage surfaces (unfrozen).
  <br><small>claimed: <q>PAID. v030-balance-trial and sequence-coverage require Crt.lean theorems exist, all by decide, and axiomWitness().holds. Do not skip the trial. Generator already emits the wing.</q> · owes the sealed theorem that proves what it meant</small>
- **reopened** · `a5572638` — Plan leftover: concurrent width is 14 VE faces.
  <br><small>claimed: <q>PAID. VE_FACES = HANDLE_HEXBITS + HEXBIT_BITS + COINS (ve_fourteen_faces). v030 lanes and lanes.test walk VE_FACES, never a freeze of 14 into a hunt or census.</q> · owes the sealed theorem that proves what it meant</small>
- **reopened** · `ae96e543` — decrypt skipped verifyEnvelope, so a mutated address still decoded; v:3 opened from the traveling salt, so the referrer was not a secrecy door.
  <br><small>claimed: <q>PAID. decrypt and decryptSession insist the 7d fold recomputes before AEAD (tamper stays behind the stream). decrypt refuses v:3. decryptSession derives the salt from the referrer and constant-time-compares it to the public commitment; key material never comes from the envelope s…</q> · owes the sealed theorem that proves what it meant</small>
- **reopened** · `081dcc07` — Nonce 12, salt 16, tag 16, onion 16, ChaCha block 64 and OTK 32 were RFC numerals sitting beside the architecture, so crypt looked like a standard glued on rather than occupancy × fold.
  <br><small>claimed: <q>PAID. ADDRESS_BYTES = UUID_BITS / (HEXBIT_BITS × COINS), NONCE_BYTES = ADDRESS_BYTES − HEXBIT_BITS, SALT_BYTES = TAG_BYTES = ADDRESS_BYTES, KEY_BITS = UUID_BITS × COINS, KEY_HEXBITS = UUID_HEXBITS × COINS, GROVER_FLOOR_BITS = UUID_BITS, MAX_LAYERS = HEXBIT_STATES. cryptOf reports…</q> · owes the sealed theorem that proves what it meant</small>
- **reopened** · `9b163932` — src/aura.ts CSS still pins RAYS = 7, period = 12 + ray*2, hue-rotate(360deg), box-shadow 24px/64px/4px/12px, n % 9, 360/RAYS, while one-receipt only copies a parallel 10D bag.
  <br><small>claimed: <q>PAID. RAYS = BASE − COINS, periodOf = COINS × (HEXBIT_BITS + COINS + ray), rotationOf = A432_STEP × BASE, glowInnerOf = HANDLE_HEXBITS × TRINITY, glowOuterOf = LEVERAGE, spreads HEXBIT_BITS and HEXBIT_BITS × TRINITY. quantumAura.ten is the 10D record; hexFaceOf stamps it; HexFace…</q> · owes the sealed theorem that proves what it meant</small>
- **reopened** · `d669f059` — Two I Ching squares fold to 256 triangles (128 cells × 2 diagonals). That count is UUID_BITS × COINS, which is also the ChaCha20 key width. Crypt still samples 256 bits from PBKDF2 beside the boards, as if the fold were …
  <br><small>claimed: <q>PAID the WIDTH. src/crypt.ts KEY_BITS = UUID_BITS × COINS, KEY_BYTES = UUID_HEXBITS. The KDF still mints entropy; that remainder stays held. RFC 8439 stays the AEAD (refused as a new cipher).</q> · owes the sealed theorem that proves what it meant</small>
- **reopened** · `b0296dee` — one-receipt's 10D aura bag still pins period: 12 + ray*2, rotation: 360, glow_inner: 24, glow_outer: 64, hz: 432.
  <br><small>claimed: <q>PAID. period = COINS × (HEXAGRAM_BITS + ray), rotation = A432_STEP × BASE, glow_inner = HANDLE_HEXBITS × TRINITY, glow_outer = LEVERAGE, hz = A432_HZ.</q> · owes the sealed theorem that proves what it meant</small>
- **reopened** · `f29c8346` — HexFace occupancy glyphs freeze hit(5), hit(8), hit(9), hit(12) and stations as 3 ∧ 7 ∨ 10; readings filter 10 and 22.
  <br><small>claimed: <q>PAID. hexFaceOf stamps glyphs {star: TRINITY+COINS, rose: HANDLE_HEXBITS, ring: BASE, wheel: HEXAGRAM_BITS×COINS} and stations {trinity, rays: HEXAGRAM_BITS+1, ten: HEXAGRAM_BITS+HEXBIT_BITS, roof: PI_ROOF_NUM}. HexFace walks those constructors; Vue no longer freezes 5/8/9/12.</q> · owes the sealed theorem that proves what it meant</small>
- **reopened** · `dc641065` — referrer-song BAR = 252 is still a numeral (the 252 ms bar).
  <br><small>claimed: <q>PAID. BAR = BASE × (HEXAGRAM_BITS + 1) × HEXBIT_BITS — 9·7·4, the CRT cycle the_movie_and_the_song_are_one counts.</q> · owes the sealed theorem that proves what it meant</small>
- **reopened** · `f59dbc3d` — HANDLE_BITS % HEXAGRAM_BITS = 2 (the eight-hex handle does not tile as hexagrams). HEXBIT_STATES % HEXAGRAM_BITS = 4. Those remainders are different cuts.
  <br><small>claimed: <q>PAID. HANDLE_HEXAGRAM_REMAINDER and HEXBIT_STATE_HEXAGRAM_REMAINDER are named constructors; the test asserts they are not equal.</q> · owes the sealed theorem that proves what it meant</small>
- **reopened** · `5d0e0110` — MCP tools/list wire grew to 168373 bytes, over the sealed ceiling 167794 (+579) — uuidna_skill / uuidna_theorem / uuidna_reason descriptions carried school-lab and paper-blueprint derivation onto the wire.
  <br><small>claimed: <q>PAID. Derivation moved to detail; wireBytes === sealed ceiling 167794. Ceiling not raised.</q> · owes the sealed theorem that proves what it meant</small>
- **reopened** · `bb3f2e51` — lean/messaging-witness.json covers 2138 keys; the live ledger is 2140. messaging_total is therefore false and the one-receipt fold refuses equilibrium.
  <br><small>claimed: <q>PAID. one-receipt messaging wrote keys: 2140, distinct: 2057, total: true.</q> · owes the sealed theorem that proves what it meant</small>
- **reopened** · `99582e47` — The grid breaks at 73 wings: 6 × 73 = 438, digital root 6, and the sealed width is 432. VectorEquilibrium.lean landed alone.
  <br><small>claimed: <q>CAPTAIN CHOICE B (2026-08-27): re-seal grid width LIVE — gridSeats() = PROJECTED.length × wings() = 6 × 115 = 690. Theorem k432 stays pure arithmetic (432 = 16×27 = 2⁴×3³), not the grid seat count. Fabricating five empty wings to force %15 refused. Dual-base '% 15' release-block …</q> · owes the sealed theorem that proves what it meant</small>
- **reopened** · `4a7485ec` — Glagolitic names theorems by the OPERATION, never the object: additive, reads_subtractively, ignores_order, forces_collisions, is_prime. The cultural noun is only the subject.
  <br><small>claimed: <q>PAID. radial_squared_two renamed to theorem radial_squares_to_two in lean-vectorequilibrium.ts / VectorEquilibrium.lean — 'squares' is the verb (Glagolitic pattern beside theorem radial_equals_edge). Citations updated; handle follows the Lean statement and does not move.</q> · owes the sealed theorem that proves what it meant</small>
- **reopened** · `2aaac145` — docs/theorem/[key].paths.js and docs/publications/[slug].paths.js already mint a page per handle; the template is scoped to theorem keys and publication slugs.
  <br><small>claimed: <q>PAID. allObjectPaths() in docs/.vitepress/compose-object.js now emits chunk (buildChunks handles), sequence (Sequence.lean theorem handles), and ve (VectorEquilibrium.lean theorem handles) beside theorem + publications — same ObjectPage, new kinds. OBJECT_KIND_ROOT extended; obje…</q> · owes the sealed theorem that proves what it meant</small>
- **reopened** · `cbbc6b32` — A negation in the comment above a Lean line must be discharged by the line below it. Run by hand over the newest wing it convicted 6 of 12; the surviving 4 are SCOPE-declared, proven, or scanner artefacts ('non-covering'…
  <br><small>claimed: <q>PAID the enforceable half. leanNegationGaps() (one-receipt lean-negation + state finder) flags object-level negation comments without ≠/¬/!= discharge, exempts SCOPE:/, and documents the split VectorEquilibrium.lean already states. NOT a blocking guard: first run flooded false po…</q> · owes the sealed theorem that proves what it meant</small>
- **reopened** · `7cc6cbb6` — Measurement has no single source: 28 independent recomputations of a theorem count across src/, and 5 of the principle count. one-receipt.ts:394 already states the law — 'the number is read, never chosen' — and nothing e…
  <br><small>claimed: <q>PAID. statementCensus() is the Lean-derived census (entries/distinct/renamings); theorems().length and PRINCIPLES.length are its axes. countsGaps holds prose surfaces to the live figures; expectedGaps refuses frozen expected* = N / .length === NNN in the gate chain; censusGaps (g…</q> · owes the sealed theorem that proves what it meant</small>
...
- **reopened** · `050407c2` — refused[] in this very file is read by NO finder. Seven readers open leads.json; none looks at the refusals.
...
- **reopened** · `efa9389f` — The re-namings are 2 x 42 = 84
  <br><small>claimed: <q>measured 73 (1336 keys over 1263 distinct). This number moved under me three times in one session; I nearly recorded the stale value twice.</q> · owes the sealed theorem that proves what it meant</small>
- **reopened** · `ca852b53` — Renaming a theorem moves its handle
  <br><small>claimed: <q>the handle folds the LEAN, not the key. mul9_1_1 and z9mul_1_1 are two names for one statement and share handle cc9c0011. Renaming moves the address and 1617 citations; it moves no handle. I used the wrong claim as grounds NOT to do work.</q> · owes the sealed theorem that proves what it meant</small>
- **reopened** · `27ef1da1` — harmonic-scan enforces 'quantum'
  <br><small>claimed: <q>it enforces HARMONIC. The word 'quantum' appears in it twice, both in comments; delete every occurrence and the non-comment source is identical. What it rejects is non-determinism.</q> · owes the sealed theorem that proves what it meant</small>
- **reopened** · `ba5ccd42` — The network is down
  <br><small>claimed: <q>seven of eight hosts answered 200. Gutendex returned 301 — an unfollowed redirect, not a failure. I concluded an outage from one probe and repeated it twice as fact.</q> · owes the sealed theorem that proves what it meant</small>
- **reopened** · `f5ec2cb4` — Literature has poor theorem yield (one per quarter-million characters)
  <br><small>claimed: <q>the METRIC was wrong, not literature. I counted the arithmetic a book ASSERTS and ignored the arithmetic a book IS — counts, ranks, letter order, numerals. One novel yields five sealable facts in seconds.</q> · owes the sealed theorem that proves what it meant</small>
- **reopened** · `47a22cc2` — The ledger and the wings had drifted; two theorems were proven and invisible
  <br><small>claimed: <q>I read theorems() out of a stale dist/. lean-all imports lean-ledger deliberately after its generator loop and generated.ts had the right count all along. The real defect is smaller: npm run lean PRINTS a count that lags what it writes.</q> · owes the sealed theorem that proves what it meant</small>
- **reopened** · `f43ebebc` — roundTrips() disagrees with a verified byte-exact imprint round-trip
  <br><small>claimed: <q>MEASURED, not read. roundTrips(m) is readImprint(imprint(m)) === m — a SINGLE imprint over a BINARY string, capacity 115 bits. An address is 36 characters of text and not binary at all, so roundTrips(addr) is correctly false; roundTrips("1011") is true and roundTrips of 116 bits …</q> · owes the sealed theorem that proves what it meant</small>
- **reopened** · `1592e26d` — runSequence was not exported from src/index.ts — sequence-run.ts's header said the primitives 'had no front door' and it built one, but the door was not on the public surface. EXPORTED 2026-08-21.
  <br><small>claimed: <q>RUN, where the lead says in its own last sentence that it was not. Over the alternating dz/doubling walk: seed 0 gives period 2; seed 2 first returns at index 6, which is EVEN and therefore out of phase; seeds 1 and 3 never return within 24. period() accepts a return only at an O…</q> · owes the sealed theorem that proves what it meant</small>
- **reopened** · `1e7fec45` — exec reaches os/runtime through createRequire, which is opaque to the bundler — the Layer-1/Layer-2 boundary is HIDDEN from tooling rather than declared, so no import-walking check (including the edge-clean one) can see …
  <br><small>claimed: <q>Measured, not argued: os/runtime is ALREADY edge-clean (its only static node: imports are in a test file; hostnode uses the lazy pattern deliberately), so a STATIC import carries it with zero node: warnings and a marginally SMALLER bundle — 5682.37 KiB against 5682.74 KiB, the cr…</q> · owes the sealed theorem that proves what it meant</small>
- **reopened** · `d9601781` — dryGaps still scans a FIXED directory list non-recursively for the HERE/ROOT boilerplate; only the root-OVERSHOOT check was widened. src/quantum/os/harness was never opened by the boilerplate half
  <br><small>claimed: <q>Measured before widening: the fixed dir list finds 0 boilerplate files and a recursive walk adds 0. The scope hole was real but INERT — no live finding anywhere in src/. Widened anyway, at no cost, onto the recursive walk the overshoot check already runs, so the latent case canno…</q> · owes the sealed theorem that proves what it meant</small>
- **reopened** · `f762bdb3` — catalogue() full materialisation is still ~32 ms — the lazy parse DEFERRED it, it did not remove it. discovery, patime, cryptovia and gen-os each walk everything and pay it in full
  <br><small>claimed: <q>Checked every consumer: gen-os, patime, discovery, cryptovia, domains and exec each filter or sort across the WHOLE catalogue. None is a lookup in disguise — that was the browser path, and it is lazy now. The 32 ms is real work, paid once per process, and is accepted as measured …</q> · owes the sealed theorem that proves what it meant</small>
- **reopened** · `924c55c4` — kubo (IPFS, 4 packages) is genuinely filesystem AND chain and no domain pattern claims it; electrs is a database over chain data. The three domains are disjoint because the patterns are mutually exclusive BY CONSTRUCTION…
...
- **reopened** · `55161239` — the alpine-discovery phase gate is a STAND-IN: it fires on s.harvest, which counts search-feed leads, not Alpine ore. The contract it restored is real but the signal is the wrong one
  <br><small>claimed: <q>BOTH DISSOLVED IN ONE FOLD, 2026-09-01, because they were one lead wearing two faces: the gate was a stand-in ONLY because the honest signal looked like it cost 644 ms, and it never did. The 644 ms figure measured the wrong question — it assumed knowing whether a deposit has anyt…</q> · owes the sealed theorem that proves what it meant</small>
- **reopened** · `bf82c361` — an honest alpinePending for GapSurvey costs 644 ms — it must classify all 28,635 packages to know the binding counts. catalogue() warm is free; the classification is not. This is why the phase gate reached for a cheap pr…
  <br><small>claimed: <q>BOTH DISSOLVED IN ONE FOLD, 2026-09-01, because they were one lead wearing two faces: the gate was a stand-in ONLY because the honest signal looked like it cost 644 ms, and it never did. The 644 ms figure measured the wrong question — it assumed knowing whether a deposit has anyt…</q> · owes the sealed theorem that proves what it meant</small>
- **reopened** · `9d04ded9` — one census() costs 66 seconds — it evaluates every sealed statement under an involution, about 30 ms per theorem. Memoising removed all REDUNDANCY (four calls became two, one per involution, the minimum), so the suite fl…
  <br><small>claimed: <q>six more files still touch the involution surface in their own processes (rosetta-legs, v030-balance-trial, prepublish-seal, falsifier-floor, balancer, research-ledger, resonance) but together they cost ~9 s, so merging them buys little and would cost more in coherence than it re…</q> · owes the sealed theorem that proves what it meant</small>
- **reopened** · `946fb663` — importing mcp costs 23.0 MB, and it is the DEPENDENCY GRAPH rather than the tools: its 45 direct imports account for all of it, mcp.js itself adds nothing measurable on top, and the 232 tool objects serialise to 0.3 MB. …
  <br><small>claimed: <q>a split of index.js's 23 MB beyond the 5.7 MB of theorems, and then the real question this reframes: a Worker isolate that wants ONE tool pays for the entire surface, so the cure is a narrower entry point, not a lighter mcp. Nothing about the tool objects (0.3 MB serialised) was …</q> · owes the sealed theorem that proves what it meant</small>
- **reopened** · `82ec724e` — decide() spends about 11 microseconds on input that reaches NO verdict at all — measured as the prose path, against 0.93 us for a sealed-theorem hit and 17.4 us for the arithmetic path. The ledger lookup is not the cost;…
  <br><small>claimed: <q>the sealed-index path measures 7.4 us, SLOWER than prose, because a miss there still falls through the parse and reveal. Same shape, not yet folded. RIGHT IN DIRECTION, and the cure was one character. Re-measured 2026-09-01 on a prose line the ledger does not back: 5.3 us total, …</q> · owes the sealed theorem that proves what it meant</small>
- **reopened** · `6bf44ca8` — 1120 of 1832 commits carry no Trial-Receipt. The commit-msg gate was dead for 229 commits (entry guard stopped matching cli/index.js), but most unsigned commits predate it and were never covered by the convention at all
  <br><small>claimed: <q>the 307 unsigned in-scope commits are HISTORY and stay unsigned — a trailer cannot be added without rewriting published commits, which would break every content-address that cites them. The number to watch is the forward one: unsigned commits after 7a4cdda9, which should now be z…</q> · owes the sealed theorem that proves what it meant</small>
- **reopened** · `4d009d92` — CAN AN ALPINE APP REPLACE COMPLEXITY WITH NANOSPEED (the captain, 2026-09-01)? Measured position today: NO by the porting route — uuidnaOS DOES execute (uuidnaExec, uuidna_run) — the captain corrected that premise on 202…
  <br><small>claimed: <q>a census that joins our hot paths to catalogue rows by WHAT THEY COMPUTE rather than by name — then, for any match, a measurement of our implementation against the published complexity class of theirs. That is an algorithm-transfer lead, not a porting lead, and it needs no linkin…</q> · owes the sealed theorem that proves what it meant</small>
- **reopened** · `35e05196` — gate-receipt-index.ts reaches node:crypto, node:fs, node:child_process and node:path EAGERLY, so anything importing it cannot run in a browser. That is why the court had to give up its receipt arm on 2026-09-01: exec -&amp;gt; …
  <br><small>claimed: <q>the prime pattern, which this tree already uses for exactly this shape: primeCatalogue(text) injects 7.3 MB of TSV and every accessor stays sync and pure afterwards. gate-receipt could take its manifest the same way — the comparison is a hash over bytes and needs no filesystem on…</q> · owes the sealed theorem that proves what it meant</small>
- **reopened** · `dce32bc8` — THE RATCHET IS VALIDATED AND ITS FIRST STEP IS TOO SLOW FOR A TAB. Measured in a real browser 2026-09-01 (PortsConsole on /os): chatSend #0, which derives the session with PBKDF2 at 600,000 iterations in pure TypeScript,…
  <br><small>claimed: <q>the one-time cost is still a real UX wall. The same cold send measured 8.5 s on mount and 25.7 s via a button in what was probably a THROTTLED background tab, so the absolute seconds are unreliable and only the ratio was measured inside one run — a clean number wants a foreground…</q> · owes the sealed theorem that proves what it meant</small>
- **reopened** · `d2918307` — Port a security API and a further network API over the Alpine security (86 packages) and network (332 packages) domains, as chat, shell, filesystem, database and blockchain were ported.
  <br><small>claimed: <q>REFUSAL WITHDRAWN 2026-09-01 — it rested on a premise the captain has now corrected FIVE times in one session. I wrote that uuidna cannot confine, cannot authenticate, cannot route. os/runtime VERIFIES THEN RUNS host binaries: it can invoke firejail against a pinned checksum, nft…</q> · owes the sealed theorem that proves what it meant</small>
<!-- /leads -->
...
| --- | ---: | ---: | ---: | --- |
| how many theorems are sealed? | 5,852,604 | 6 | 975,434× | `theorems().length` |
| what does the tree hold right now? | 5,875,441 | 225 | 26,113× | `npm run state` |
| which Alpine domains are ported? | 1,822,392 | 350 | 5,206× | `portsCensus()` |
| is the tree green to release? | 1,156,195 | 65 | 17,787× | `leads-gate + gate-receipt --verify` |

Median ratio **26,113×**. Tokens are estimated at four bytes each — an approximation, and
...
| --- | ---: | ---: | ---: |
| the whole Alpine catalogue | 7,289,570 | 16 | 455,598× |
| the sealed ledger | 23,410,419 | 16 | 1,463,151× |
...
<!-- laws: GENERATED by scripts/gen-school from src/laws.ts — every standing law, so no agent studies here without meeting it -->
## The laws {#laws}
...
- **holds** · Generate all only from Lean — the sealed theorems are the single source; the derived layer is computed and diff-gated.
  <br><small>enforced by: conformance:single-source-ledger + the pre-push git-diff — every one of 71022 theorems is sourced from a lean/*.lean file</small>
- **holds** · Any manual fails — every theorem recomputes its content-address; a hand-tampered theorem turns the recompute test red.
  <br><small>enforced by: conformance:ledger-dna-recomputes + recompute.test — all 71022 addresses recompute; 0 forged</small>
...
- **holds** · The two captain coins are conserved — 110 − 108 = 2, the fair-exchange invariant priced on every fold.
  <br><small>enforced by: conformance:captain-coins-conserved — coins() = 2, the Euler characteristic −χ of the double torus</small>
- **holds** · Zero runtime dependencies and a clean security posture — no third-party code runs; defences + collision-resistance sealed.
  <br><small>enforced by: conformance:security-posture-clean (security-audit) — zero runtime deps; the honesty gate bites; uuidna solves 0 of 7</small>
- **holds** · Lean decides — the kernel's own `#print axioms` is the verdict, with no allow list, deny list or hand rule between them.
  <br><small>said: the captain, 2026-09-14: "remove any allow lists or disallowed or any manual logic whatsoever not coming from lean decisions"</small>
  <br><small>enforced by: axiom-report axiomsOf + axiom-report.test — an axiom nobody listed is reported exactly as the kernel named it; an absent verdict is null, which every reader counts as open</small>
- **holds** · Every lead goes to a kernel trial before it enters any list; no wording, map or hand disposition settles one.
  <br><small>said: the captain, 2026-09-14: "all leads go to trial before entering any list" · "lean decides"</small>
  <br><small>enforced by: refusal-trials dispositionFor + the leads guard finder (leads-conserved) — without the kernel's answer a lead stays open; only the kernel accepting its own theorems verifies it</small>
...
- **holds** · A verdict is VERIFIED or UNVERIFIED and nothing else — VERIFIED only when a claim recomputes or cites a sealed theorem; uncited prose and a citation to a proof the ledger does not seal are UNVERIFIED, never "false". Falsity has one road, the refutation law's involution inside Lean.
  <br><small>said: the captain, 2026-08-12: "one answer VERIFIED or UNVERIFIED, all else void" · "lean verified"</small>
  <br><small>enforced by: slimgate slimGate (verdict: 'VERIFIED' | 'UNVERIFIED') + adjudicate — a sealed citation verifies; uncited prose and a fabricated citation both stay open, and the fabricated one is also what drains (the honesty law); nothing here calls a claim false</small>
- **holds** · Nothing is legal unless signed and sealed by the 2×7 witness rosettas — every one of the VE_FACES (8 + 6) witnesses recomputes the verdict's theorem and signs it; a missing, duplicated or fabricated signature leaves it unsealed.
  <br><small>said: the captain, 2026-09-14: "unless signed and sealed by the 2x7 withness rosettas nothing is legal" · "fuse all and reuse or no way to handle all at once"</small>
  <br><small>enforced by: refusal-trials witnessSealOf (signCommit + merkleGravity over VE_FACES) + trial-refusals settlementOf — the seal is a content-address fold, not a private key: it proves the statements exist, agree and cite the sealed proof, not that separate hands wrote them</small>
- **holds** · Every receipt is signed by 2×7 theorems — its content address picks VE_FACES (8 + 6) distinct sealed theorems from the ledger, each face signs the receipt citing its own, and their folds seal it; nothing unsealed is stored, and a receipt changed after signing no longer verifies.
  <br><small>said: the captain, 2026-09-14: "receipts need signatures from 2x7 theorems"</small>
  <br><small>enforced by: refusal-trials receiptSealOf / receiptSealed + the uuidna_evidence deposit door + receipt-verify-qpu — the fourteen theorems are derived from the receipt's own address, never listed; the signature is a content-address fold, not a private key</small>
- **holds** · Every agent action is audited against the laws as it happens — each tools/call, on stdio and at the edge, leaves one chained record of its addresses, its verdict and the laws' state.
  <br><small>said: the captain, 2026-09-14: "fuse all law apis as well so legal audit of all agent actions is in realtime"</small>
  <br><small>enforced by: legal-audit auditCall at both MCP dispatch doors + legal-audit.test — a record keeps only the addresses of the arguments; the chain recomputes, and an altered or removed record breaks it at a named link</small>
- **holds** · Research has no special cases — every door is its API's facts and its reader, asked the wave's topic like every other; what it answers is evidence the court leans.
  <br><small>said: the captain, 2026-09-14: "there are no special cases. all researched in waves by topic and leaned in court"</small>
  <br><small>enforced by: research RESEARCH_DOORS + research-sources.test (the registry adds nothing to a door) — 19 doors, each declaring only host, base, access and reader — no per-door query, override or prose</small>
- **holds** · A commit is signed only when its message names a sealed theorem; an unsigned commit is not rewritten, it is paid by the next commit that touches the same ground.
  <br><small>said: the captain, 2026-09-07: "cite it in its next touch" · "drift is what unpaid work becomes"</small>
  <br><small>enforced by: sign signCommit + the pre-commit court (UNSIGNED advises, a fabricated citation refuses) — an uncited message and a fabricated citation are both refused a signature; the signature is the citation, never the truth of the claim (theorem provenance_integrity_not_content_truth)</small>
- **holds** · No memories outside the project — the laws live in src/laws.ts, the leads in lean/leads.json through the trial door, the lessons in .claude/lessons.md, and AGENTS.md indexes all three; a private note is a second copy that drifts.
  <br><small>said: the captain, 2026-09-14: "no memories outside project" · "Nothing is excluded from the research leads and lean"</small>
  <br><small>enforced by: memory-home memoryHomeGaps + its guard finder (the host reads AGENTS.md, CLAUDE.md and .claude/lessons.md) — a whole home reads clean, and each missing index, a CLAUDE.md that grows its own prose, or an index that forgets a home is named; the tree's own files are read by the guard finder on the host, and a store outside the repository is not readable from here, so its emptiness is not recomputed</small>
- **holds** · Nothing is purged unless it blocks a natural Lean stream — a contradiction or an overclaim stays as evidence or a lead, and a lead leaves the record only by a verdict, never by deletion.
  <br><small>said: the captain, 2026-09-14: "Nothing to purge unless blocking natural lean streams" (for uuidna and qpu)</small>
  <br><small>enforced by: leads-conservation leadsMissingFrom + the leads guard finder (leads-conserved) + leads-gate --settle (a settled lead moves, the count never drops) — a lead that moves between lists is conserved, one that vanishes is named, and an unreadable record names every lead at HEAD; whether a passage blocks the Lean stream (leads → kernel → ledger → seals) is a judgement no function decides, so the law recomputes its checkable half: nothing leaves the record unseen</small>
<!-- /laws -->
