...
7. **Seal the input, never its pure function — and know where that stops** — a digest of f(x) moves exactly when
   ...
   **The boundary:** the same reasoning was turned on the 2514-frame aura film and it was wrong. The aura IS
...
Every wing the ledger seals, largest first: 2514 theorems across 115 wings and 107 skills.
...
| --- | --- | --- | ---: | --- |
| The conveyor's first wave | `Wave.lean` | wave | 838 | [`a440_drift_is_heard`](/theorem/a440_drift_is_heard) |
...
| is the tree green to release? | 77,494 | 65 | 1,192× | `leads-gate + gate-receipt --verify` |
