...
```
gate CLEAN f0 d0 v0 · 4ce83925-1fa7-8deb-aab6-4d6373d022f6
```
...
order-invariant identity `28c69801-8dfb-8d81-8ead-7bb8f615496b` (the hosted subset serves the same gate over its own registry).
...
244 tools, **ranked by usability — the reusable at the top** (fewest required keys first; the 114 zero-arg tools lead). The order EMERGES from `uuidna_mcp_benchmark`, not a hand-kept list. Each links to its entry below.
...
{}
// answer (excerpt)
{"address":"ca362792-2c9e-8375-a1e9-29f50f69c3b6","handle":"ca362792","path":"src/handles/ca/36/27/92/index.json","parts":["ca","36","27","92"],"roundTrip":tru…
```
...
{}
// answer (excerpt)
{"leads":222,"clusters":[{"term":"uuidna","handle":"fc511532","leads":59},{"term":"hexbit","handle":"36f01fe8","leads":36},{"term":"quantum","handle":"74f0dd16…
```
...
{}
// answer (excerpt)
{"coins":2,"unit":2,"seals":70938,"minted":141876,"capacity":128,"referrerDoors":6,"combinations":42,"max":5376,"remaining":-136500,"capSeals":2688,"unsealed":…
```
...
{}
// answer (excerpt)
{"total":70938,"formula":1437,"program":69501,"refused":0,"manuscript":"https://uuidna.com/uuidna-ledger.tex"}
```
...
{}
// answer (excerpt)
{"stations":65536,"occupied":5536,"vacant":60000,"theoremsSeated":5402,"axiomsSeated":375,"problemsSeated":18,"collisions":[{"station":"000e","keys":["euler_ph…
```
...
{}
// answer (excerpt)
{"total":285,"byKind":{"seal-finding":28,"decide-bound":134,"symbol-leg":123},"missions":[{"handle":"f3b786a0","kind":"seal-finding","wing":"research ledger","…
```
...
{}
// answer (excerpt)
{"sections":[{"title":"Theorem accounting (ledger balance)","source":null,"present":true,"facts":{"distinct":70854,"keys":70938,"renamings":84,"principles":242…
```
...
{}
// answer (excerpt)
{"clean":true,"scanned":70938,"traitors":[],"checks":["dna-recomputes","no-key-collision","no-address-collision","conformance-invariants","seal-integrity","hex…
```
...
{}
// answer (excerpt)
{"shipped":true,"measured":true,"holds":true,"audited":70938,"axiomFree":70938,"ledger":70938,"offenders":{},"receipt":"150ebbb9-f8f4-8934-82ff-f7ccfd4d5c35","…
```
...
{}
// answer (excerpt)
{"count":70938,"total":true,"failures":[],"receipt":"54aa1689-36c2-8c28-90ae-a4fe824f509d","honest":"THE TOTALITY SEAL: secure messaging is a TOTAL function on…
```
...
{}
// answer (excerpt)
{"terms":70938,"skills":121,"principles":242,"receipt":"ca362792-2c9e-8375-a1e9-29f50f69c3b6","honest":"the lexicon is the ledger — every term sealed, every de…
```
...
{}
// answer (excerpt)
{"svg":"<svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 104 104\" width=\"104\" height=\"104\" role=\"img\" data-fused=\"1\" data-handle=\"9ea74738\" d…
```
...
{}
// answer (excerpt)
{"version":"6.0","spec":"https://github.com/open-education-api/specification/blob/main/oeapi.json","counts":{"organisations":2,"programmes":121,"courses":242,"…
```
...
{"likelihood":"all"}
// answer (excerpt)
{"total":37,"declaredDormantSkipped":34,"byLikelihood":{"high":0,"medium":37,"low":0},"gaps":[{"pattern":"unwired-script","likelihood":"medium","location":"src…
```
...
{}
// answer (excerpt)
{"branch":"latest-stable","repo":"main","arch":"x86_64","release":{"version":"3.24.1","rootfsSha256":"41f73e3cf5fa919b8aa5ca6b30dc48f0da2720776d7423e2a77482114…
```
...
{}
// answer (excerpt)
{"count":269,"tools":244,"installs":25,"packages":[{"kind":"install","id":"uuidna/alpine-base","name":"alpine-base","route":"/","meaning":"Meta package for min…
```
...
{}
// answer (excerpt)
{"namespace":"uuidna/<package>","honest":"Each Alpine package is a content-addressed provenance identity uuidna/<name>, minted from its published checksum — in…
```
...
{}
// answer (excerpt)
{"total":70938,"historical":1587,"contextual":973,"captainAlone":68378,"address":"c04199f4-8e20-8d77-85a7-ff9117f76dfe"}
```
...
{}
// answer (excerpt)
{"verifiedAll":{"theorems":70938,"verified":70938,"unverified":0,"receipt":"ca362792-2c9e-8375-a1e9-29f50f69c3b6"},"guarantees":[{"key":"legal_verdict_is_exact…
```
...
{}
// answer (excerpt)
{"propositions":70854,"entries":70938,"index":[{"leanUuid":"0764f3a2-a09a-83fe-9d81-8c6928d7de1a","statement":"(1 * 1) % 9 = 1","keys":["mul9_1_1","z9mul_1_1"]…
```
...
{}
// answer (excerpt)
{"entries":70938,"distinct":70854,"renamings":84,"groups":[{"statement":"(1 * 1) % 9 = 1","keys":["mul9_1_1","z9mul_1_1"],"files":["Core.lean","Ring.lean"]},{"…
```
...
{"q":"mul9_1_1"}
// answer (excerpt)
{"q":"mul9_1_1","count":1,"total":70938,"receipt":"f0b58c9c-d571-81ff-b82d-07db3a0e2aea","handle":"f0b58c9c","hexbits":[15,0,11,5,8,12,9,12,13,5,7,1,8,1,15,15,…
```
...
{}
// answer (excerpt)
{"traitors":{"clean":true,"scanned":70938,"traitors":[],"checks":["dna-recomputes","no-key-collision","no-address-collision","conformance-invariants","seal-int…
```
...
{}
// answer (excerpt)
{"fingerprint":{"count":70938,"fnvReceipt":"ca362792-2c9e-8375-a1e9-29f50f69c3b6","sha256":"6cccf8abcbf09042f459ba50c2977af81c48a117fc32e2a6c72e26316db060ff","…
```
...
{}
// answer (excerpt)
{"intrusions":{"traitors":{"clean":true,"scanned":70938,"traitors":[],"checks":["dna-recomputes","no-key-collision","no-address-collision","conformance-invaria…
```
...
{}
// answer (excerpt)
{"definition":"uuidnaOS·doi·tags","prefixes":12,"doors":48,"tagged":[{"door":"arxiv-org","prefixes":["10.48550"]},{"door":"biorxiv","prefixes":["10.1101"]},{"d…
```
...
{"of":"monitor"}
// answer (excerpt)
{"definition":"uuidnaos-monitor·vitepress","present":true,"panels":52,"pages":67,"live":20,"static":32,"receipt":"395a2ad6-a2ee-8cb3-9b0d-0cee212fc89e","honest…
```
...
{"text":"theorem"}
// answer (excerpt)
{"address":"ec9e6641-989b-85de-aa57-58eedfea0d13","details":1,"dropped":0,"controls":[{"control":"2 + 2 = 5","mustNotBe":["VERIFIED","VERIFIED_BY_DECIDE"],"got…
```
...
{"name":"theorem"}
// answer (excerpt)
<article class="uuidna-card" data-slot="card" itemscope itemtype="https://schema.org/WebPage" data-og-title="theorem" data-og-description="theorem" data-og-url…
```
...
{"names":["theorem"]}
// answer (excerpt)
<div class="uuidna-list" style="display:grid;gap:.4rem"><article class="uuidna-card" data-slot="card" itemscope itemtype="https://schema.org/WebPage" data-og-t…
```
...
{}
// answer (excerpt)
{"total":70938,"covered":70938,"uncovered":[],"uncoveredFiles":[],"ready":true,"receipt":"e8832476-f51a-8a01-b6de-bf5098de5c80"}
```
...
{}
// answer (excerpt)
{"count":70938,"fnvReceipt":"ca362792-2c9e-8375-a1e9-29f50f69c3b6","sha256":"6cccf8abcbf09042f459ba50c2977af81c48a117fc32e2a6c72e26316db060ff","tamperCost":"A …
```
...
{}
// answer (excerpt)
{"count":70938,"verified":70938,"unverified":0,"leanBacked":70938,"receipt":"ca362792-2c9e-8375-a1e9-29f50f69c3b6","verdicts":[{"key":"mul9_1_1","name":"1·1 ≡ …
```
...
{}
// answer (excerpt)
{"table":[1,0,0,0,0,0,0,0],"sealedTable":[1,0,0,0,0,0,0,0],"matchesSealedSpec":true,"cleanStates":1,"drainedStates":7,"tools":244,"registry":"28c69801-8dfb-8d8…
```
...
{}
// answer (excerpt)
{"selfReported":true,"label":null,"dimensions":{"input":0,"output":0,"cached":0,"reasoning":0},"total":0,"theorems":70938,"tokensPerTheorem":0,"distribution":{…
```
...
{}
// answer (excerpt)
{"count":70938,"formalBytes":7620859,"bytesPerTheorem":107.42985423891285,"verifyOps":70938,"produceOverVerify":107.42985423891285,"largest":{"key":"a_template…
```
...
**Open leads.** Returns {total,open,verified,unverified,items,receipt,honest,example}.
...
{}
// answer (excerpt)
{"total":21,"open":21,"verified":0,"unverified":21,"items":[{"claim":"KEY_BITS names occupancy × fold (UUID_BITS × COINS) and occupancyTapeOf packs yang‖yin fr…
```
...
{}
// answer (excerpt)
{"polarities":{"minus":28476,"neutral":14100,"plus":28362,"capacity":{"minus":4,"neutral":2,"plus":4},"byRay":[{"ray":0,"minus":4096,"neutral":1999,"plus":4045…
```
...
{}
// answer (excerpt)
{"tools":244,"zeroArgReusable":114,"totalRequiredKeys":192,"reusablePerKey":1.271,"avgRequiredKeys":0.787,"avgRating":4.213,"hardest":[{"name":"uuidna_crt","re…
```
...
{}
// answer (excerpt)
{"handle":"b6e064f9","theorems":{"count":70938,"verified":70938,"receipt":"ca362792-2c9e-8375-a1e9-29f50f69c3b6"},"domains":{"count":121,"verdict":"VERIFIED","…
```
...
{}
// answer (excerpt)
{"handle":"6034f5a6","identity":{"name":"uuidna","address":"fc511532-6e8a-8418-a522-a51b1d46a70c","aura":{"ray":2,"hue":66,"hsl":"hsl(66, 66%, 54%)","rgb":"#c8…
```
...
{}
// answer (excerpt)
{"handle":"@uuidna","name":"uuidna","bio":"Content-addressed identity, honest by construction — 70938 Lean theorems, all by decide, kernel-only, folded to one …
```
...
**Get quantum advantage.** Returns {prerequisite,magnitudes,steps,compute,alpine,curriculum,…}.
...
{}
// answer (excerpt)
{"receipt":"8e1f3bd3-5633-81d8-9543-bd72f09087eb","handle":"8e1f3bd3","hexbits":[8,14,1,15,3,11,13,3,5,6,3,3,8,1,13,8,9,5,4,3,11,13,7,2,15,0,9,0,8,7,14,11],"do…
```
