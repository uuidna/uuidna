...
# MCP tools <Badge type="tip" text="205 keys" />

<!-- GENERATED from src/mcp.ts by scripts/gen-mcp — DO NOT EDIT. Categories, skills and parameters are derived from the tool keys and their input schemas. -->

Every tool the uuidna MCP server exposes — fuse uuidna into any harness (Claude, Cursor, any MCP client). This page
is **built from the keys**: the 205 tools below are read from the server's own tool list and
...
```
gate CLEAN f0 d0 v0 · 33ef74fc-2462-88ab-b6ad-5f2b53605535
```
...
1 clean state, 7 drained), and the 205-tool registry folds to its
order-invariant identity `f5d91e90-8163-8db7-9d87-4da164e29f36` (the hosted subset serves the same gate over its own registry).
...
## The grid <Badge type="tip" :text="`205`" />

205 tools, **ranked by usability — the reusable at the top** (fewest required keys first; the 80 zero-arg tools lead). The order EMERGES from `uuidna_mcp_benchmark`, not a hand-kept list. Each links to its entry below.
