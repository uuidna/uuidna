...
> The anthem is the **whole ledger in place** — 1690 theorems, theorem k at bar k, each bar that
...
**The whole ledger folds to** `5f00a2b9-ff27-8011-929f-6cf23eaff464` — and the coin octave, 432 against 864
