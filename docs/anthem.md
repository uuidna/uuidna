...
> The anthem is the **whole ledger in place** — 1622 theorems, theorem k at bar k, each bar that
...
**The whole ledger folds to** `be7435fb-8dfd-8f1f-b543-d98178fd77c9` — and the coin octave, 432 against 864
