...
> The anthem is the **whole ledger in place** — 2654 theorems, theorem k at bar k, each bar that
...
**The whole ledger folds to** `faf6d575-a253-824b-9138-f9c91e2a8c7c` — and the coin octave, 432 against 864
