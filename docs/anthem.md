...
> The anthem is the **whole ledger in place** — 1703 theorems, theorem k at bar k, each bar that
...
**The whole ledger folds to** `4e7cfc8a-5c84-8d4f-a37a-f5774c3f1584` — and the coin octave, 432 against 864
