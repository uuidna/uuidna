...
> The anthem sings the **whole ledger, in place**: theorem k sounds at bar k, in ledger order — 1507
...
Exact integers on the A432 lattice: the **same bytes for anyone, forever**. Content-address `fedc984a` —
recompute it from the file, or the recording is not this anthem. Duration 5:36 for 1507 theorems.
...
**Finale** (at 5:29) — the merkle root of all 1507 addresses, `62421c38-19cd-8db8-b364-af27cc581bac`, sung whole:
