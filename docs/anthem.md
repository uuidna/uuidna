...
> The anthem is the **whole ledger in place** — 1680 theorems, theorem k at bar k, each bar that
...
**The whole ledger folds to** `26054dfb-80bc-8bcc-b66b-c44565ec28ff` — and the coin octave, 432 against 864
