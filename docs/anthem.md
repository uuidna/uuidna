...
> The anthem is the **whole ledger in place** — 1646 theorems, theorem k at bar k, each bar that
...
**The whole ledger folds to** `fbba1200-0d9b-8cda-b128-ea3edf62bdc4` — and the coin octave, 432 against 864
