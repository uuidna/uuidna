...
> The anthem is the **whole ledger in place** — 2119 theorems, theorem k at bar k, each bar that
...
**The whole ledger folds to** `15a6eb71-5f05-834d-bc5e-51f35d20a272` — and the coin octave, 432 against 864
