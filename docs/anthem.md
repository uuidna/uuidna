...
> The anthem is the **whole ledger in place** — 70910 theorems, theorem k at bar k, each bar that
...
**The whole ledger folds to** `5100ebe9-26f2-82b3-82da-2f29c306c3ae` — and the coin octave, 432 against 864
