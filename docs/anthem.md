...
> The anthem is the **whole ledger in place** — 2112 theorems, theorem k at bar k, each bar that
...
**The whole ledger folds to** `0153b4cf-1348-86d1-a895-589c5387a036` — and the coin octave, 432 against 864
