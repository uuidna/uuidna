...
> The anthem is the **whole ledger in place** — 2655 theorems, theorem k at bar k, each bar that
...
**The whole ledger folds to** `6e17bce6-e478-8ddb-bb2e-720789c93df1` — and the coin octave, 432 against 864
