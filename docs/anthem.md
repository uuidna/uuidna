...
> The anthem is the **whole ledger in place** — 1699 theorems, theorem k at bar k, each bar that
...
**The whole ledger folds to** `92b9ecf1-db50-8df9-a551-56b13c1ac81c` — and the coin octave, 432 against 864
