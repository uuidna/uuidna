...
> The anthem is the **whole ledger in place** — 2588 theorems, theorem k at bar k, each bar that
...
**The whole ledger folds to** `86bb58c9-5a5f-8b2f-bdf0-e06844008eea` — and the coin octave, 432 against 864
