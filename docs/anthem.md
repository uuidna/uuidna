...
> The anthem sings the **whole ledger, in place**: theorem k sounds at bar k, in ledger order — 1497
...
Exact integers on the A432 lattice: the **same bytes for anyone, forever**. Content-address `18a4d2aa` —
recompute it from the file, or the recording is not this anthem. Duration 5:33 for 1497 theorems.
...
**Finale** (at 5:26) — the merkle root of all 1497 addresses, `5f0174c6-3fba-889b-bb74-b7c408e3324c`, sung whole:
