...
> The anthem sings the **whole ledger, in place**: theorem k sounds at bar k, in ledger order — 1550
...
Exact integers on the A432 lattice: the **same bytes for anyone, forever**. Content-address `8dd8b82f` —
recompute it from the file, or the recording is not this anthem. Duration 5:45 for 1550 theorems.
...
**Finale** (at 5:38) — the merkle root of all 1550 addresses, `7675e2dc-a2b6-8b98-8f58-bd8c5c537a49`, sung whole:
