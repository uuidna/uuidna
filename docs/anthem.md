...
> The anthem is the **whole ledger in place** — 71035 theorems, theorem k at bar k, each bar that
...
**The whole ledger folds to** `2e457a2c-3a33-887e-9d45-c68a843bbb14` — and the coin octave, 432 against 864
