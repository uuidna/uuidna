...
> The anthem is the **whole ledger in place** — 70998 theorems, theorem k at bar k, each bar that
...
**The whole ledger folds to** `e7dc02f3-f4e0-842c-acaf-6abeab82f97f` — and the coin octave, 432 against 864
