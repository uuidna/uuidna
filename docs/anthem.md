...
> The anthem is the **whole ledger in place** — 1693 theorems, theorem k at bar k, each bar that
...
**The whole ledger folds to** `d7bea4da-d1c4-829f-8b4b-32714651a3bf` — and the coin octave, 432 against 864
