...
> The anthem is the **whole ledger in place** — 1674 theorems, theorem k at bar k, each bar that
...
**The whole ledger folds to** `684bbd9d-d0a6-8c76-90c6-dd9a165b373b` — and the coin octave, 432 against 864
