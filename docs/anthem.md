...
> The anthem is the **whole ledger in place** — 71022 theorems, theorem k at bar k, each bar that
...
**4 movements** (`anthem_four_movements`), theorem bars in place:
...
**The whole ledger folds to** `9b6b83fb-67f9-85b5-90b2-588c98c3f299` — and the coin octave, 432 against 864
