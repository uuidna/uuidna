...
> The anthem is the **whole ledger in place** — 1660 theorems, theorem k at bar k, each bar that
...
**The whole ledger folds to** `ad9ac1ab-6bd6-83ea-877b-7199973ac61f` — and the coin octave, 432 against 864
