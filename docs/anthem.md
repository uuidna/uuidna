...
> The anthem is the **whole ledger in place** — 2612 theorems, theorem k at bar k, each bar that
...
**The whole ledger folds to** `38e3b2e1-b5ec-8c3a-b6fa-666b23903e4b` — and the coin octave, 432 against 864
