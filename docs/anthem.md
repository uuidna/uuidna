...
> The anthem is the **whole ledger in place** — 2653 theorems, theorem k at bar k, each bar that
...
**The whole ledger folds to** `edee50b7-365a-8f94-bf17-353dea08e808` — and the coin octave, 432 against 864
