...
**Data source:** Live ledger (1318 sealed theorems)
...
|--------|-------|-----------------|
| **Theorems proven** | 1318 | Every theorem by decidable computation (no axioms) |
| **Axiom-free** | 1318/1318 (100%) | Kernel-only proofs, recomputable offline |
