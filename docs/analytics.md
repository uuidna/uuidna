...
**Data source:** Live ledger (1247 sealed theorems)
...
|--------|-------|-----------------|
| **Theorems proven** | 1247 | Every theorem by decidable computation (no axioms) |
| **Axiom-free** | 1247/1247 (100%) | Kernel-only proofs, recomputable offline |
