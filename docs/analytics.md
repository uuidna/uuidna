...
**Data source:** Live ledger (1248 sealed theorems)
...
|--------|-------|-----------------|
| **Theorems proven** | 1248 | Every theorem by decidable computation (no axioms) |
| **Axiom-free** | 1248/1248 (100%) | Kernel-only proofs, recomputable offline |
