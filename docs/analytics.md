...
**Data source:** Live ledger (1257 sealed theorems)
...
|--------|-------|-----------------|
| **Theorems proven** | 1257 | Every theorem by decidable computation (no axioms) |
| **Axiom-free** | 1257/1257 (100%) | Kernel-only proofs, recomputable offline |
