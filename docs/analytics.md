...
**Data source:** Live ledger (1328 sealed theorems)
...
|--------|-------|-----------------|
| **Theorems proven** | 1328 | Every theorem by decidable computation (no axioms) |
| **Axiom-free** | 1328/1328 (100%) | Kernel-only proofs, recomputable offline |
