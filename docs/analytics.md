...
**Data source:** Live ledger (1604 sealed theorems)
...
|--------|-------|-----------------|
| **Theorems proven** | 1604 | Every theorem by decidable computation (no axioms) |
| **Axiom-free** | 1604/1604 (100%) | Kernel-only proofs, recomputable offline |
| **Principles** | 109 | Mathematical domains (ring, rosette, quantum, etc.) |
| **Skills** | 106 | Capability axes across the ledger |
| **Proof cost** | 680379 decide-steps | MEASURED per theorem in lean/heartbeats.json |
| **Verification work** | 1604 addresses | one recomputed per theorem |
...
- Every later push (verify): 1604 address recomputations
...
```
Total theorems:       1604
Axiom-free (decide):  1604 (100.0%)
Principles:           109 domains
...
| Ledger | 1604 theorems · 109 principles · 106 skills | [/theorems](/theorems) · every wing |
