...
**Data source:** Live ledger (1327 sealed theorems)
...
|--------|-------|-----------------|
| **Theorems proven** | 1327 | Every theorem by decidable computation (no axioms) |
| **Axiom-free** | 1327/1327 (100%) | Kernel-only proofs, recomputable offline |
