...
**Data source:** Live ledger (2589 sealed theorems)
...
|--------|-------|-----------------|
| **Theorems proven** | 2589 | Every theorem by decidable computation (no axioms) |
...
| **Supported modules** | 1025/1025 | Every module reachable (no dead code) |
