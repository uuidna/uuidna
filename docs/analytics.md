...
**Data source:** Live ledger (1330 sealed theorems)
...
|--------|-------|-----------------|
| **Theorems proven** | 1330 | Every theorem by decidable computation (no axioms) |
| **Axiom-free** | 1330/1330 (100%) | Kernel-only proofs, recomputable offline |
