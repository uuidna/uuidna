...
**Data source:** Live ledger (1329 sealed theorems)
...
|--------|-------|-----------------|
| **Theorems proven** | 1329 | Every theorem by decidable computation (no axioms) |
| **Axiom-free** | 1329/1329 (100%) | Kernel-only proofs, recomputable offline |
