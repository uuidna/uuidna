...
**Data source:** Live ledger (1703 sealed theorems)
...
|--------|-------|-----------------|
| **Theorems proven** | 1703 | Every theorem by decidable computation (no axioms) |
| **Axiom-free** | 1703/1703 (100%) | Kernel-only proofs, recomputable offline |
| **Principles** | 115 | Mathematical domains (ring, rosette, quantum, etc.) |
| **Skills** | 112 | Capability axes across the ledger |
| **Proof cost** | 722491 decide-steps | MEASURED per theorem in lean/heartbeats.json |
| **Verification work** | 1703 addresses | one recomputed per theorem |
...
- First push (prove): 722491 kernel decide-steps, measured
- Every later push (verify): 1703 address recomputations
...
| Ledger | 1703 theorems · 115 principles · 112 skills | [/theorems](/theorems) · every wing |
