...
**Data source:** Live ledger (1295 sealed theorems)
...
|--------|-------|-----------------|
| **Theorems proven** | 1295 | Every theorem by decidable computation (no axioms) |
| **Axiom-free** | 1295/1295 (100%) | Kernel-only proofs, recomputable offline |
