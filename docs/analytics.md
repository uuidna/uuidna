...
**Data source:** Live ledger (2120 sealed theorems)
...
|--------|-------|-----------------|
| **Theorems proven** | 2120 | Every theorem by decidable computation (no axioms) |
| **Axiom-free** | 2120/2120 (100%) | Kernel-only proofs, recomputable offline |
| **Principles** | 115 | Mathematical domains (ring, rosette, quantum, etc.) |
| **Skills** | 112 | Capability axes across the ledger |
| **Proof cost** | 1541367 decide-steps | MEASURED per theorem in lean/heartbeats.json |
| **Verification work** | 2120 addresses | one recomputed per theorem |
...
- First push (prove): 1541367 kernel decide-steps, measured
- Every later push (verify): 2120 address recomputations
...
| Public model feed | 417 models · widest window 2,000,000 tokens · 1,634,686,480 transient hexbits across all windows | [/models](/models) · `Models.lean` |
| Terminal singularity | 3 builtin words · 0 hardcoded tool names (the toolbox is learned live) | [/terminal](/terminal) · tested |
| Ledger | 2120 theorems · 115 principles · 112 skills | [/theorems](/theorems) · every wing |
