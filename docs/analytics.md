...
**Data source:** Live ledger (1701 sealed theorems)
...
|--------|-------|-----------------|
| **Theorems proven** | 1701 | Every theorem by decidable computation (no axioms) |
| **Axiom-free** | 1701/1701 (100%) | Kernel-only proofs, recomputable offline |
| **Principles** | 115 | Mathematical domains (ring, rosette, quantum, etc.) |
| **Skills** | 112 | Capability axes across the ledger |
| **Proof cost** | 721121 decide-steps | MEASURED per theorem in lean/heartbeats.json |
| **Verification work** | 1701 addresses | one recomputed per theorem |
| **Steps per address** | 423 | proving costs this much more than checking; no timings are asserted, only counts | <!-- every push |
...
- First push (prove): 721121 kernel decide-steps, measured
- Every later push (verify): 1701 address recomputations
...
| Ledger | 1701 theorems · 115 principles · 112 skills | [/theorems](/theorems) · every wing |
