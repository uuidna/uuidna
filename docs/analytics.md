...
| **Proof cost** | 1695637 decide-steps | MEASURED per theorem in lean/heartbeats.json |
...
| **Supported modules** | 1140/1140 | Every module reachable (no dead code) |
...
- First push (prove): 1695637 kernel decide-steps, measured
