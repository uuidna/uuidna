...
**Data source:** Live ledger (1437 sealed theorems)
...
|--------|-------|-----------------|
| **Theorems proven** | 1437 | Every theorem by decidable computation (no axioms) |
| **Axiom-free** | 1437/1437 (100%) | Kernel-only proofs, recomputable offline |
| **Principles** | 94 | Mathematical domains (ring, rosette, quantum, etc.) |
| **Skills** | 91 | Capability axes across the ledger |
| **Proof cost** | 577254 decide-steps | MEASURED per theorem in lean/heartbeats.json |
| **Verification work** | 1437 addresses | one recomputed per theorem |
...
- First push (prove): 577254 kernel decide-steps, measured
- Every later push (verify): 1437 address recomputations
