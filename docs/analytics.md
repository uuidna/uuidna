...
**Data source:** Live ledger (1611 sealed theorems)
...
|--------|-------|-----------------|
| **Theorems proven** | 1611 | Every theorem by decidable computation (no axioms) |
| **Axiom-free** | 1611/1611 (100%) | Kernel-only proofs, recomputable offline |
| **Principles** | 110 | Mathematical domains (ring, rosette, quantum, etc.) |
| **Skills** | 107 | Capability axes across the ledger |
| **Proof cost** | 681391 decide-steps | MEASURED per theorem in lean/heartbeats.json |
| **Verification work** | 1611 addresses | one recomputed per theorem |
...
- First push (prove): 681391 kernel decide-steps, measured
- Every later push (verify): 1611 address recomputations
...
| Ledger | 1611 theorems · 110 principles · 107 skills | [/theorems](/theorems) · every wing |
