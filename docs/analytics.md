...
**Data source:** Live ledger (2654 sealed theorems)
...
|--------|-------|-----------------|
| **Theorems proven** | 2654 | Every theorem by decidable computation (no axioms) |
| **Axiom-free** | 2654/2654 (100%) | Kernel-only proofs, recomputable offline |
| **Principles** | 118 | Mathematical domains (ring, rosette, quantum, etc.) |
| **Skills** | 115 | Capability axes across the ledger |
| **Proof cost** | 1669058 decide-steps | MEASURED per theorem in lean/heartbeats.json |
| **Verification work** | 2654 addresses | one recomputed per theorem |
...
- First push (prove): 1669058 kernel decide-steps, measured
- Every later push (verify): 2654 address recomputations
...
| Ledger | 2654 theorems · 118 principles · 115 skills | [/theorems](/theorems) · every wing |
