...
**Data source:** Live ledger (1326 sealed theorems)
...
|--------|-------|-----------------|
| **Theorems proven** | 1326 | Every theorem by decidable computation (no axioms) |
| **Axiom-free** | 1326/1326 (100%) | Kernel-only proofs, recomputable offline |
