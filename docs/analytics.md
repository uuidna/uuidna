...
**Data source:** Live ledger (1231 sealed theorems)
...
|--------|-------|-----------------|
| **Theorems proven** | 1231 | Every theorem by decidable computation (no axioms) |
| **Axiom-free** | 1231/1231 (100%) | Kernel-only proofs, recomputable offline |
