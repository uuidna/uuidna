...
**Data source:** Live ledger (1285 sealed theorems)
...
|--------|-------|-----------------|
| **Theorems proven** | 1285 | Every theorem by decidable computation (no axioms) |
| **Axiom-free** | 1285/1285 (100%) | Kernel-only proofs, recomputable offline |
