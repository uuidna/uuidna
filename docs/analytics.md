...
**Data source:** Live ledger (1221 sealed theorems)
...
|--------|-------|-----------------|
| **Theorems proven** | 1221 | Every theorem by decidable computation (no axioms) |
| **Axiom-free** | 1221/1221 (100%) | Kernel-only proofs, recomputable offline |
