...
**Data source:** Live ledger (1691 sealed theorems)
...
|--------|-------|-----------------|
| **Theorems proven** | 1691 | Every theorem by decidable computation (no axioms) |
| **Axiom-free** | 1691/1691 (100%) | Kernel-only proofs, recomputable offline |
| **Principles** | 115 | Mathematical domains (ring, rosette, quantum, etc.) |
| **Skills** | 112 | Capability axes across the ledger |
| **Proof cost** | 704595 decide-steps | MEASURED per theorem in lean/heartbeats.json |
| **Verification work** | 1691 addresses | one recomputed per theorem |
...
- First push (prove): 704595 kernel decide-steps, measured
- Every later push (verify): 1691 address recomputations
...
| Ledger | 1691 theorems · 115 principles · 112 skills | [/theorems](/theorems) · every wing |
