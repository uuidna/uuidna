...
**Data source:** Live ledger (2626 sealed theorems)
...
|--------|-------|-----------------|
| **Theorems proven** | 2626 | Every theorem by decidable computation (no axioms) |
| **Axiom-free** | 2626/2626 (100%) | Kernel-only proofs, recomputable offline |
| **Principles** | 118 | Mathematical domains (ring, rosette, quantum, etc.) |
| **Skills** | 115 | Capability axes across the ledger |
| **Proof cost** | 1667203 decide-steps | MEASURED per theorem in lean/heartbeats.json |
| **Verification work** | 2626 addresses | one recomputed per theorem |
| **Steps per address** | 634 | proving costs this much more than checking; no timings are asserted, only counts | <!-- every push |
...
| **Supported modules** | 1092/1092 | Every module reachable (no dead code) |
...
- First push (prove): 1667203 kernel decide-steps, measured
- Every later push (verify): 2626 address recomputations
...
| Ledger | 2626 theorems · 118 principles · 115 skills | [/theorems](/theorems) · every wing |
