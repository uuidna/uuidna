...
**Data source:** Live ledger (1237 sealed theorems)
...
|--------|-------|-----------------|
| **Theorems proven** | 1237 | Every theorem by decidable computation (no axioms) |
| **Axiom-free** | 1237/1237 (100%) | Kernel-only proofs, recomputable offline |
