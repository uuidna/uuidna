...
**Data source:** Live ledger (1322 sealed theorems)
...
|--------|-------|-----------------|
| **Theorems proven** | 1322 | Every theorem by decidable computation (no axioms) |
| **Axiom-free** | 1322/1322 (100%) | Kernel-only proofs, recomputable offline |
