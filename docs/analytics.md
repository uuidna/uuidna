...
**Data source:** Live ledger (1211 sealed theorems)
...
|--------|-------|-----------------|
| **Theorems proven** | 1211 | Every theorem by decidable computation (no axioms) |
| **Axiom-free** | 1211/1211 (100%) | Kernel-only proofs, recomputable offline |
