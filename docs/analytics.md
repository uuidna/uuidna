...
**Data source:** Live ledger (1317 sealed theorems)
...
|--------|-------|-----------------|
| **Theorems proven** | 1317 | Every theorem by decidable computation (no axioms) |
| **Axiom-free** | 1317/1317 (100%) | Kernel-only proofs, recomputable offline |
