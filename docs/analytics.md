...
**Data source:** Live ledger (1610 sealed theorems)
...
|--------|-------|-----------------|
| **Theorems proven** | 1610 | Every theorem by decidable computation (no axioms) |
| **Axiom-free** | 1610/1610 (100%) | Kernel-only proofs, recomputable offline |
| **Principles** | 110 | Mathematical domains (ring, rosette, quantum, etc.) |
| **Skills** | 107 | Capability axes across the ledger |
| **Proof cost** | 680379 decide-steps | MEASURED per theorem in lean/heartbeats.json |
| **Verification work** | 1610 addresses | one recomputed per theorem |
...
- First push (prove): 680379 kernel decide-steps, measured
- Every later push (verify): 1610 address recomputations
...
| Ledger | 1610 theorems · 110 principles · 107 skills | [/theorems](/theorems) · every wing |
