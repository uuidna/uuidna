...
**Data source:** Live ledger (1334 sealed theorems)
...
|--------|-------|-----------------|
| **Theorems proven** | 1334 | Every theorem by decidable computation (no axioms) |
| **Axiom-free** | 1334/1334 (100%) | Kernel-only proofs, recomputable offline |
