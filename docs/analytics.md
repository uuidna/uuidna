...
**Data source:** Live ledger (1652 sealed theorems)
...
|--------|-------|-----------------|
| **Theorems proven** | 1652 | Every theorem by decidable computation (no axioms) |
| **Axiom-free** | 1652/1652 (100%) | Kernel-only proofs, recomputable offline |
| **Principles** | 112 | Mathematical domains (ring, rosette, quantum, etc.) |
| **Skills** | 109 | Capability axes across the ledger |
| **Proof cost** | 692577 decide-steps | MEASURED per theorem in lean/heartbeats.json |
| **Verification work** | 1652 addresses | one recomputed per theorem |
...
- First push (prove): 692577 kernel decide-steps, measured
- Every later push (verify): 1652 address recomputations
...
| Ledger | 1652 theorems · 112 principles · 109 skills | [/theorems](/theorems) · every wing |
