...
**Data source:** Live ledger (1468 sealed theorems)
...
|--------|-------|-----------------|
| **Theorems proven** | 1468 | Every theorem by decidable computation (no axioms) |
| **Axiom-free** | 1468/1468 (100%) | Kernel-only proofs, recomputable offline |
| **Principles** | 94 | Mathematical domains (ring, rosette, quantum, etc.) |
| **Skills** | 90 | Capability axes across the ledger |
| **Proof cost** | 576904 decide-steps | MEASURED per theorem in lean/heartbeats.json |
| **Verification work** | 1468 addresses | one recomputed per theorem |
...
- First push (prove): 576904 kernel decide-steps, measured
- Every later push (verify): 1468 address recomputations
