...
**Data source:** Live ledger (1250 sealed theorems)
...
|--------|-------|-----------------|
| **Theorems proven** | 1250 | Every theorem by decidable computation (no axioms) |
| **Axiom-free** | 1250/1250 (100%) | Kernel-only proofs, recomputable offline |
