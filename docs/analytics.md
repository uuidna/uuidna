...
**Data source:** Live ledger (2659 sealed theorems)
...
|--------|-------|-----------------|
| **Theorems proven** | 2659 | Every theorem by decidable computation (no axioms) |
| **Axiom-free** | 2659/2659 (100%) | Kernel-only proofs, recomputable offline |
| **Principles** | 118 | Mathematical domains (ring, rosette, quantum, etc.) |
| **Skills** | 115 | Capability axes across the ledger |
| **Proof cost** | 1692985 decide-steps | MEASURED per theorem in lean/heartbeats.json |
| **Verification work** | 2659 addresses | one recomputed per theorem |
| **Steps per address** | 636 | proving costs this much more than checking; no timings are asserted, only counts | <!-- every push |
...
| **Supported modules** | 1135/1135 | Every module reachable (no dead code) |
...
- First push (prove): 1692985 kernel decide-steps, measured
- Every later push (verify): 2659 address recomputations
...
| Ledger | 2659 theorems · 118 principles · 115 skills | [/theorems](/theorems) · every wing |
