...
**Data source:** Live ledger (1226 sealed theorems)
...
|--------|-------|-----------------|
| **Theorems proven** | 1226 | Every theorem by decidable computation (no axioms) |
| **Axiom-free** | 1226/1226 (100%) | Kernel-only proofs, recomputable offline |
