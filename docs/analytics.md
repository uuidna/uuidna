...
**Data source:** Live ledger (1294 sealed theorems)
...
|--------|-------|-----------------|
| **Theorems proven** | 1294 | Every theorem by decidable computation (no axioms) |
| **Axiom-free** | 1294/1294 (100%) | Kernel-only proofs, recomputable offline |
