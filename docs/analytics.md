...
**Data source:** Live ledger (1290 sealed theorems)
...
|--------|-------|-----------------|
| **Theorems proven** | 1290 | Every theorem by decidable computation (no axioms) |
| **Axiom-free** | 1290/1290 (100%) | Kernel-only proofs, recomputable offline |
