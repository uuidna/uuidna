...
**Data source:** Live ledger (1313 sealed theorems)
...
|--------|-------|-----------------|
| **Theorems proven** | 1313 | Every theorem by decidable computation (no axioms) |
| **Axiom-free** | 1313/1313 (100%) | Kernel-only proofs, recomputable offline |
