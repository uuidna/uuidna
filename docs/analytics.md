...
**Data source:** Live ledger (1297 sealed theorems)
...
|--------|-------|-----------------|
| **Theorems proven** | 1297 | Every theorem by decidable computation (no axioms) |
| **Axiom-free** | 1297/1297 (100%) | Kernel-only proofs, recomputable offline |
