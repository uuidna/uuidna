...
**Data source:** Live ledger (1254 sealed theorems)
...
|--------|-------|-----------------|
| **Theorems proven** | 1254 | Every theorem by decidable computation (no axioms) |
| **Axiom-free** | 1254/1254 (100%) | Kernel-only proofs, recomputable offline |
