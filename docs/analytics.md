...
**Data source:** Live ledger (1217 sealed theorems)
...
|--------|-------|-----------------|
| **Theorems proven** | 1217 | Every theorem by decidable computation (no axioms) |
| **Axiom-free** | 1217/1217 (100%) | Kernel-only proofs, recomputable offline |
