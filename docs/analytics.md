...
**Data source:** Live ledger (1224 sealed theorems)
...
|--------|-------|-----------------|
| **Theorems proven** | 1224 | Every theorem by decidable computation (no axioms) |
| **Axiom-free** | 1224/1224 (100%) | Kernel-only proofs, recomputable offline |
