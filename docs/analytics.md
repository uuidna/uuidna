...
**Data source:** Live ledger (1289 sealed theorems)
...
|--------|-------|-----------------|
| **Theorems proven** | 1289 | Every theorem by decidable computation (no axioms) |
| **Axiom-free** | 1289/1289 (100%) | Kernel-only proofs, recomputable offline |
| **Principles** | 70 | Mathematical domains (ring, rosette, quantum, etc.) |
| **Skills** | 66 | Capability axes across the ledger |
...
```
Total theorems:       1289
Axiom-free (decide):  1289 (100.0%)
Principles:           70 domains
