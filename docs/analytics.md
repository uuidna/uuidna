...
**Data source:** Live ledger (1234 sealed theorems)
...
|--------|-------|-----------------|
| **Theorems proven** | 1234 | Every theorem by decidable computation (no axioms) |
| **Axiom-free** | 1234/1234 (100%) | Kernel-only proofs, recomputable offline |
