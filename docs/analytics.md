...
**Data source:** Live ledger (1699 sealed theorems)
...
|--------|-------|-----------------|
| **Theorems proven** | 1699 | Every theorem by decidable computation (no axioms) |
| **Axiom-free** | 1699/1699 (100%) | Kernel-only proofs, recomputable offline |
| **Principles** | 115 | Mathematical domains (ring, rosette, quantum, etc.) |
| **Skills** | 112 | Capability axes across the ledger |
| **Proof cost** | 720207 decide-steps | MEASURED per theorem in lean/heartbeats.json |
| **Verification work** | 1699 addresses | one recomputed per theorem |
...
- First push (prove): 720207 kernel decide-steps, measured
- Every later push (verify): 1699 address recomputations
...
| Ledger | 1699 theorems · 115 principles · 112 skills | [/theorems](/theorems) · every wing |
