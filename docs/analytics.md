...
**Data source:** Live ledger (2653 sealed theorems)
...
|--------|-------|-----------------|
| **Theorems proven** | 2653 | Every theorem by decidable computation (no axioms) |
| **Axiom-free** | 2653/2653 (100%) | Kernel-only proofs, recomputable offline |
| **Principles** | 118 | Mathematical domains (ring, rosette, quantum, etc.) |
| **Skills** | 115 | Capability axes across the ledger |
| **Proof cost** | 1668642 decide-steps | MEASURED per theorem in lean/heartbeats.json |
| **Verification work** | 2653 addresses | one recomputed per theorem |
...
| **Supported modules** | 1095/1095 | Every module reachable (no dead code) |
...
- First push (prove): 1668642 kernel decide-steps, measured
- Every later push (verify): 2653 address recomputations
...
| Ledger | 2653 theorems · 118 principles · 115 skills | [/theorems](/theorems) · every wing |
