...
**Data source:** Live ledger (1323 sealed theorems)
...
|--------|-------|-----------------|
| **Theorems proven** | 1323 | Every theorem by decidable computation (no axioms) |
| **Axiom-free** | 1323/1323 (100%) | Kernel-only proofs, recomputable offline |
