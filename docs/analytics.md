...
**Data source:** Live ledger (1284 sealed theorems)
...
|--------|-------|-----------------|
| **Theorems proven** | 1284 | Every theorem by decidable computation (no axioms) |
| **Axiom-free** | 1284/1284 (100%) | Kernel-only proofs, recomputable offline |
