...
**Data source:** Live ledger (1288 sealed theorems)
...
|--------|-------|-----------------|
| **Theorems proven** | 1288 | Every theorem by decidable computation (no axioms) |
| **Axiom-free** | 1288/1288 (100%) | Kernel-only proofs, recomputable offline |
