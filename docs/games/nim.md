...
**Theorem:** `Nim.lean` (1 theorems, all `by decide`)

Nim-sum (XOR) is P-position test. Zero nim-sum loses for mover (Bouton's theorem).
...
**The Question:** *Does knowing the winning strategy spoil the game or enhance it?*
