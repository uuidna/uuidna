...
dotnet-doc resolves via cmd:dotnet provide — apps exist, not sealed orphans
...
```text
every prescribed 'npm run' names a script that exists — a remedy pointing nowhere is worse than none
```
