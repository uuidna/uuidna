...
The site's 2998 pages form one closed cycle — previous and next are total and mutually inverse from
...
**The census of this walk's 2998 steps**: 186 unisons, 203 pure octaves,
...
(64 bars), while the census above measures the full 2998-page cycle. Every bar
