...
The site's 1866 pages form one closed cycle — previous and next are total and mutually inverse from
...
**The census of this walk's 1866 steps**: 116 unisons, 140 pure octaves,
1151 coprime (irreducible) tensions. The most common reduced intervals:
...
(47 bars), while the census above measures the full 1866-page cycle. Every bar
