...
The site's 2083 pages form one closed cycle — previous and next are total and mutually inverse from
...
**The census of this walk's 2083 steps**: 123 unisons, 154 pure octaves,
1302 coprime (irreducible) tensions. The most common reduced intervals:
...
(58 bars), while the census above measures the full 2083-page cycle. Every bar
