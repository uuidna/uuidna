...
The site's 2070 pages form one closed cycle — previous and next are total and mutually inverse from
...
**The census of this walk's 2070 steps**: 124 unisons, 151 pure octaves,
1295 coprime (irreducible) tensions. The most common reduced intervals:
...
(57 bars), while the census above measures the full 2070-page cycle. Every bar
