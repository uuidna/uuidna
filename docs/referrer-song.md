...
The site's 1948 pages form one closed cycle — previous and next are total and mutually inverse from
...
**The census of this walk's 1948 steps**: 115 unisons, 142 pure octaves,
1215 coprime (irreducible) tensions. The most common reduced intervals:
...
(51 bars), while the census above measures the full 1948-page cycle. Every bar
