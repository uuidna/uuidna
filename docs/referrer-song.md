...
The site's 6068 pages form one closed cycle — previous and next are total and mutually inverse from
...
**The census of this walk's 6068 steps**: 382 unisons, 393 pure octaves,
3755 coprime (irreducible) tensions. The most common reduced intervals:
...
(67 bars), while the census above measures the full 6068-page cycle. Every bar
