...
The site's 2085 pages form one closed cycle — previous and next are total and mutually inverse from
...
**The census of this walk's 2085 steps**: 123 unisons, 154 pure octaves,
...
(58 bars), while the census above measures the full 2085-page cycle. Every bar
