...
The site's 1920 pages form one closed cycle — previous and next are total and mutually inverse from
...
**The census of this walk's 1920 steps**: 115 unisons, 144 pure octaves,
1193 coprime (irreducible) tensions. The most common reduced intervals:
...
<HexbitPlayer :states="[5,9,14,13,13,2,4,1,12,11,3,15,9,6,10,13,0,14,7,1,6,15,5,11,8,8,4,1,13,7,1,3,9,1,8,11,9,12,0,5,2,5,11,13,11,10,5,5,15,13]" />
...
(50 bars), while the census above measures the full 1920-page cycle. Every bar
