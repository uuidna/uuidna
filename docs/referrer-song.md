...
The site's 2503 pages form one closed cycle — previous and next are total and mutually inverse from
...
**The census of this walk's 2503 steps**: 159 unisons, 176 pure octaves,
...
(59 bars), while the census above measures the full 2503-page cycle. Every bar
