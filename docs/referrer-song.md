...
The site's 1979 pages form one closed cycle — previous and next are total and mutually inverse from
...
**The census of this walk's 1979 steps**: 117 unisons, 142 pure octaves,
1239 coprime (irreducible) tensions. The most common reduced intervals:
...
(52 bars), while the census above measures the full 1979-page cycle. Every bar
