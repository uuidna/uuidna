...
The site's 1915 pages form one closed cycle — previous and next are total and mutually inverse from
...
**The census of this walk's 1915 steps**: 115 unisons, 145 pure octaves,
...
(47 bars), while the census above measures the full 1915-page cycle. Every bar
