...
The site's 1946 pages form one closed cycle — previous and next are total and mutually inverse from
...
**The census of this walk's 1946 steps**: 115 unisons, 143 pure octaves,
1213 coprime (irreducible) tensions. The most common reduced intervals:
...
(50 bars), while the census above measures the full 1946-page cycle. Every bar
