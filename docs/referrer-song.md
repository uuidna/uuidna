...
The site's 1877 pages form one closed cycle — previous and next are total and mutually inverse from
...
**The census of this walk's 1877 steps**: 115 unisons, 145 pure octaves,
1159 coprime (irreducible) tensions. The most common reduced intervals:
...
(47 bars), while the census above measures the full 1877-page cycle. Every bar
