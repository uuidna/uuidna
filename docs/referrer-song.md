...
The site's 3073 pages form one closed cycle — previous and next are total and mutually inverse from
...
**The census of this walk's 3073 steps**: 192 unisons, 212 pure octaves,
...
(64 bars), while the census above measures the full 3073-page cycle. Every bar
