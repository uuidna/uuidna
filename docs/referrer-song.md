...
The site's 2017 pages form one closed cycle — previous and next are total and mutually inverse from
...
**The census of this walk's 2017 steps**: 120 unisons, 146 pure octaves,
...
(53 bars), while the census above measures the full 2017-page cycle. Every bar
