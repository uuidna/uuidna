...
The site's 2031 pages form one closed cycle — previous and next are total and mutually inverse from
...
**The census of this walk's 2031 steps**: 121 unisons, 147 pure octaves,
1266 coprime (irreducible) tensions. The most common reduced intervals:
...
(53 bars), while the census above measures the full 2031-page cycle. Every bar
