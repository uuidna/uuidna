...
The site's 2044 pages form one closed cycle — previous and next are total and mutually inverse from
...
**The census of this walk's 2044 steps**: 122 unisons, 148 pure octaves,
1276 coprime (irreducible) tensions. The most common reduced intervals:
...
(57 bars), while the census above measures the full 2044-page cycle. Every bar
