...
The site's 3007 pages form one closed cycle — previous and next are total and mutually inverse from
...
**The census of this walk's 3007 steps**: 188 unisons, 204 pure octaves,
1851 coprime (irreducible) tensions. The most common reduced intervals:
...
(64 bars), while the census above measures the full 3007-page cycle. Every bar
