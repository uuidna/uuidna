...
The site's 3068 pages form one closed cycle — previous and next are total and mutually inverse from
...
**The census of this walk's 3068 steps**: 191 unisons, 212 pure octaves,
...
(64 bars), while the census above measures the full 3068-page cycle. Every bar
