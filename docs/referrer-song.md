...
The site's 3069 pages form one closed cycle — previous and next are total and mutually inverse from
...
**The census of this walk's 3069 steps**: 191 unisons, 212 pure octaves,
1891 coprime (irreducible) tensions. The most common reduced intervals:
...
(64 bars), while the census above measures the full 3069-page cycle. Every bar
