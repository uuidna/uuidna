...
The site's 1868 pages form one closed cycle — previous and next are total and mutually inverse from
...
**The census of this walk's 1868 steps**: 115 unisons, 140 pure octaves,
1154 coprime (irreducible) tensions. The most common reduced intervals:
...
(47 bars), while the census above measures the full 1868-page cycle. Every bar
