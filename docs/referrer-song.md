...
The site's 2075 pages form one closed cycle — previous and next are total and mutually inverse from
...
**The census of this walk's 2075 steps**: 124 unisons, 152 pure octaves,
1298 coprime (irreducible) tensions. The most common reduced intervals:
...
(58 bars), while the census above measures the full 2075-page cycle. Every bar
