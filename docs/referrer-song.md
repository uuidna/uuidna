...
The site's 1833 pages form one closed cycle — previous and next are total and mutually inverse from
...
**The census of this walk's 1833 steps**: 114 unisons, 139 pure octaves,
1127 coprime (irreducible) tensions. The most common reduced intervals:
...
<HexbitPlayer :states="[5,9,14,13,13,2,4,1,12,11,3,15,9,6,10,13,0,1,6,15,5,11,8,8,4,1,13,7,1,3,9,1,11,9,12,0,5,2,11,13,11,10,5,13]" />
...
(44 bars), while the census above measures the full 1833-page cycle. Every bar
