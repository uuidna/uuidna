...
The site's 1916 pages form one closed cycle — previous and next are total and mutually inverse from
...
**The census of this walk's 1916 steps**: 115 unisons, 144 pure octaves,
1192 coprime (irreducible) tensions. The most common reduced intervals:
...
(48 bars), while the census above measures the full 1916-page cycle. Every bar
