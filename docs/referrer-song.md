...
The site's 2039 pages form one closed cycle — previous and next are total and mutually inverse from
...
**The census of this walk's 2039 steps**: 122 unisons, 148 pure octaves,
1271 coprime (irreducible) tensions. The most common reduced intervals:
...
(55 bars), while the census above measures the full 2039-page cycle. Every bar
