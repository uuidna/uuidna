...
The site's 2496 pages form one closed cycle — previous and next are total and mutually inverse from
...
**The census of this walk's 2496 steps**: 157 unisons, 175 pure octaves,
...
(58 bars), while the census above measures the full 2496-page cycle. Every bar
