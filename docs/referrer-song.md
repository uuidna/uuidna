...
The site's 1962 pages form one closed cycle — previous and next are total and mutually inverse from
...
**The census of this walk's 1962 steps**: 115 unisons, 142 pure octaves,
1228 coprime (irreducible) tensions. The most common reduced intervals:
...
(52 bars), while the census above measures the full 1962-page cycle. Every bar
