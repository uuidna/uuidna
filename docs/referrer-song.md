...
The site's 2073 pages form one closed cycle — previous and next are total and mutually inverse from
...
**The census of this walk's 2073 steps**: 124 unisons, 152 pure octaves,
...
(58 bars), while the census above measures the full 2073-page cycle. Every bar
