...
The site's 2059 pages form one closed cycle — previous and next are total and mutually inverse from
...
**The census of this walk's 2059 steps**: 124 unisons, 149 pure octaves,
1287 coprime (irreducible) tensions. The most common reduced intervals:
...
(57 bars), while the census above measures the full 2059-page cycle. Every bar
