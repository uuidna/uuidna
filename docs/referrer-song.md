...
The site's 1856 pages form one closed cycle — previous and next are total and mutually inverse from
...
**The census of this walk's 1856 steps**: 115 unisons, 139 pure octaves,
1144 coprime (irreducible) tensions. The most common reduced intervals:
...
(47 bars), while the census above measures the full 1856-page cycle. Every bar
