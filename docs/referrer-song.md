...
The site's 2991 pages form one closed cycle — previous and next are total and mutually inverse from
...
**The census of this walk's 2991 steps**: 184 unisons, 203 pure octaves,
1846 coprime (irreducible) tensions. The most common reduced intervals:
...
(64 bars), while the census above measures the full 2991-page cycle. Every bar
