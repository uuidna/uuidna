...
The site's 6055 pages form one closed cycle — previous and next are total and mutually inverse from
...
**The census of this walk's 6055 steps**: 382 unisons, 393 pure octaves,
3747 coprime (irreducible) tensions. The most common reduced intervals:
...
<HexbitPlayer :states="[5,9,14,13,13,2,4,1,12,6,11,3,15,9,6,10,13,15,0,5,3,14,7,7,1,6,15,5,11,8,8,4,1,13,7,1,3,9,1,8,12,11,9,12,0,5,5,2,14,5,11,6,13,1,11,6,6,10,5,5,4,4,15,13,6,9,10]" />
...
(67 bars), while the census above measures the full 6055-page cycle. Every bar
