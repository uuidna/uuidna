...
The site's 1989 pages form one closed cycle — previous and next are total and mutually inverse from
...
**The census of this walk's 1989 steps**: 120 unisons, 144 pure octaves,
1243 coprime (irreducible) tensions. The most common reduced intervals:
...
(53 bars), while the census above measures the full 1989-page cycle. Every bar
