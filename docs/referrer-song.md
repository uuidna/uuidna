...
The site's 3074 pages form one closed cycle — previous and next are total and mutually inverse from
...
**The census of this walk's 3074 steps**: 193 unisons, 212 pure octaves,
...
(64 bars), while the census above measures the full 3074-page cycle. Every bar
