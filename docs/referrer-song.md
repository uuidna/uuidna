...
The site's 2033 pages form one closed cycle — previous and next are total and mutually inverse from
...
**The census of this walk's 2033 steps**: 121 unisons, 148 pure octaves,
1267 coprime (irreducible) tensions. The most common reduced intervals:
...
(53 bars), while the census above measures the full 2033-page cycle. Every bar
