...
The site's 3041 pages form one closed cycle — previous and next are total and mutually inverse from
...
**The census of this walk's 3041 steps**: 189 unisons, 210 pure octaves,
1873 coprime (irreducible) tensions. The most common reduced intervals:
...
(64 bars), while the census above measures the full 3041-page cycle. Every bar
