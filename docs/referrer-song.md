...
The site's 1867 pages form one closed cycle — previous and next are total and mutually inverse from
...
**The census of this walk's 1867 steps**: 115 unisons, 140 pure octaves,
1153 coprime (irreducible) tensions. The most common reduced intervals:
...
(47 bars), while the census above measures the full 1867-page cycle. Every bar
