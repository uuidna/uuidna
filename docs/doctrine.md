...
interface), and [all <!--L:distinct--><span class="ledger" data-slot="distinct" data-receipt="fad8e4de-c91f-8b32-8ec2-63c5497e8a1a">70950</span><!--/L--> distinct theorems under <!--L:keys--><span class="ledger" data-slot="keys" data-receipt="fad8e4de-c91f-8b32-8ec2-63c5497e8a1a">71035</span><!--/L--> keys](/theorems) (the record itself). *Honest scope:* uuidna replaces the
