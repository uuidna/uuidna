...
interface), and [all <!--L:distinct--><span class="ledger" data-slot="distinct" data-receipt="960ef148-023b-8a76-ab2e-25587881de2f">2024</span><!--/L--> distinct theorems under <!--L:keys--><span class="ledger" data-slot="keys" data-receipt="960ef148-023b-8a76-ab2e-25587881de2f">2105</span><!--/L--> keys](/theorems) (the record itself). *Honest scope:* uuidna replaces the
