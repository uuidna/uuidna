...
interface), and [all <!--L:distinct--><span class="ledger" data-slot="distinct" data-receipt="d7bea4da-d1c4-829f-8b4b-32714651a3bf">1612</span><!--/L--> distinct theorems under <!--L:keys--><span class="ledger" data-slot="keys" data-receipt="d7bea4da-d1c4-829f-8b4b-32714651a3bf">1693</span><!--/L--> keys](/theorems) (the record itself). *Honest scope:* uuidna replaces the
