...
interface), and [all <!--L:distinct--><span class="ledger" data-slot="distinct" data-receipt="83050382-c9af-83e4-b2d2-4e6a992c896d">2033</span><!--/L--> distinct theorems under <!--L:keys--><span class="ledger" data-slot="keys" data-receipt="83050382-c9af-83e4-b2d2-4e6a992c896d">2114</span><!--/L--> keys](/theorems) (the record itself). *Honest scope:* uuidna replaces the
