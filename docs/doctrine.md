...
interface), and [all <!--L:distinct--><span class="ledger" data-slot="distinct" data-receipt="0a1209ad-aacb-8bd9-922e-3ddc2ef1ebc0">1358</span><!--/L--> distinct theorems under <!--L:keys--><span class="ledger" data-slot="keys" data-receipt="0a1209ad-aacb-8bd9-922e-3ddc2ef1ebc0">1439</span><!--/L--> keys](/theorems) (the record itself). *Honest scope:* uuidna replaces the
