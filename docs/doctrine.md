...
interface), and [all <!--L:distinct--><span class="ledger" data-slot="distinct" data-receipt="f368a9a9-aede-8f45-914a-b2e1a6d8bc80">1246</span><!--/L--> distinct theorems under <!--L:keys--><span class="ledger" data-slot="keys" data-receipt="f368a9a9-aede-8f45-914a-b2e1a6d8bc80">1330</span><!--/L--> keys](/theorems) (the record itself). *Honest scope:* uuidna replaces the
