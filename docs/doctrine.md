...
interface), and [all <!--L:distinct--><span class="ledger" data-slot="distinct" data-receipt="3b3fd5fa-1d7b-84f6-906c-df6819f1019f">1354</span><!--/L--> distinct theorems under <!--L:keys--><span class="ledger" data-slot="keys" data-receipt="3b3fd5fa-1d7b-84f6-906c-df6819f1019f">1435</span><!--/L--> keys](/theorems) (the record itself). *Honest scope:* uuidna replaces the
