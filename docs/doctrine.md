...
interface), and [all <!--L:distinct--><span class="ledger" data-slot="distinct" data-receipt="8eb77175-df78-8bce-a5e7-a5f1d5b6b648">2529</span><!--/L--> distinct theorems under <!--L:keys--><span class="ledger" data-slot="keys" data-receipt="8eb77175-df78-8bce-a5e7-a5f1d5b6b648">2612</span><!--/L--> keys](/theorems) (the record itself). *Honest scope:* uuidna replaces the
