...
interface), and [all <!--L:distinct--><span class="ledger" data-slot="distinct" data-receipt="394f7e5b-23ac-8a22-967c-10873580f39e">2436</span><!--/L--> distinct theorems under <!--L:keys--><span class="ledger" data-slot="keys" data-receipt="394f7e5b-23ac-8a22-967c-10873580f39e">2519</span><!--/L--> keys](/theorems) (the record itself). *Honest scope:* uuidna replaces the
