...
interface), and [all <!--L:distinct--><span class="ledger" data-slot="distinct" data-receipt="92b9ecf1-db50-8df9-a551-56b13c1ac81c">1618</span><!--/L--> distinct theorems under <!--L:keys--><span class="ledger" data-slot="keys" data-receipt="92b9ecf1-db50-8df9-a551-56b13c1ac81c">1699</span><!--/L--> keys](/theorems) (the record itself). *Honest scope:* uuidna replaces the
