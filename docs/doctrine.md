...
interface), and [all <!--L:distinct--><span class="ledger" data-slot="distinct" data-receipt="9ed29cb5-f7f8-877d-9ae6-2cbe01d83f34">1370</span><!--/L--> distinct theorems under <!--L:keys--><span class="ledger" data-slot="keys" data-receipt="9ed29cb5-f7f8-877d-9ae6-2cbe01d83f34">1451</span><!--/L--> keys](/theorems) (the record itself). *Honest scope:* uuidna replaces the
