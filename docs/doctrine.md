...
interface), and [all <!--L:distinct--><span class="ledger" data-slot="distinct" data-receipt="4e7cfc8a-5c84-8d4f-a37a-f5774c3f1584">1622</span><!--/L--> distinct theorems under <!--L:keys--><span class="ledger" data-slot="keys" data-receipt="4e7cfc8a-5c84-8d4f-a37a-f5774c3f1584">1703</span><!--/L--> keys](/theorems) (the record itself). *Honest scope:* uuidna replaces the
