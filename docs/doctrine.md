...
interface), and [all <!--L:distinct--><span class="ledger" data-slot="distinct" data-receipt="95420dfe-e2b4-83e7-810c-7aa5b7544be9">2573</span><!--/L--> distinct theorems under <!--L:keys--><span class="ledger" data-slot="keys" data-receipt="95420dfe-e2b4-83e7-810c-7aa5b7544be9">2656</span><!--/L--> keys](/theorems) (the record itself). *Honest scope:* uuidna replaces the
