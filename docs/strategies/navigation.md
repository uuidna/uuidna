...
**Theorem:** `Navigation.lean` (10 theorems, all `by decide`)

Compass rose ℤ/8. Reciprocal bearing +4 (involution). Dead reckoning is vector sum.
...
**The Question:** *Can you navigate if you cannot see? What does "lost" mean?*
...
[`Navigation.lean`](../../lean/Navigation.lean)
