...
| 13 | `/crypto` | `uuidna/libcrypto3` | 3.5.7-r0 | Crypto library from openssl | `4c087476-0a6d-82cd-a8e5-5795a7efc0c3` |
| 14 | `/tls` | `uuidna/libssl3` | 3.5.7-r0 | SSL shared libraries | `f3f59dc9-5424-8cbf-9928-9abb888d777f` |
...
**Port receipt** `a520528b-717f-87e9-a09a-c2c821f36660` · **boot image** `b3bac096-dd36-8d3b-950c-90ea64088adb`
