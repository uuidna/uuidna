...
- **Time:** community compile sweep **113,190,833 ns** (~**4,991 ns**/package); man-page corpus **24,461,916 ns** (~**5,140 ns**/doc). Classical enumeration of 2^128 states is not a runnable baseline.
