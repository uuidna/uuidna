...
- **Time:** community compile sweep **49,504,708 ns** (~**2,183 ns**/package); man-page corpus **11,214,500 ns** (~**2,357 ns**/doc). Classical enumeration of 2^128 states is not a runnable baseline.
