...
- **Time:** community compile sweep in the **10,000,000 ns** decade (~**100 ns**/package decade); man-page corpus **10,000,000 ns** (~**1,000 ns**/doc). Classical enumeration of 2^128 states is not a runnable baseline.
