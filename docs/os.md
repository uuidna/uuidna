...
- **Time:** community compile sweep **52,908,833 ns** (~**2,333 ns**/package); man-page corpus **11,843,667 ns** (~**2,489 ns**/doc). Classical enumeration of 2^128 states is not a runnable baseline.
