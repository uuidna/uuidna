...
- **Time:** community compile sweep **50,251,042 ns** (~**2,216 ns**/package); man-page corpus **11,269,041 ns** (~**2,368 ns**/doc). Classical enumeration of 2^128 states is not a runnable baseline.
