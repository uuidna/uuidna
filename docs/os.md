...
- **Time:** community compile sweep **53,056,167 ns** (~**2,340 ns**/package); man-page corpus **12,995,750 ns** (~**2,731 ns**/doc). Classical enumeration of 2^128 states is not a runnable baseline.
