...
The base: Alpine **3.24.2** (`latest-stable`, main/x86_64), minirootfs
`sha256:c5ca053cfe1d85c5b96dff8b9bc57045f7f184a30ffb6b65776409ca90388677` — always Alpine **latest**: the mirror regenerates from upstream at the
...
| 3 | `/release` | `uuidna/alpine-release` | 3.24.2-r0 | Alpine release data | `993df341-4596-8511-974b-1709f6852f40` |
...
| 5 | `/trust` | `uuidna/ca-certificates-bundle` | 20260909-r0 | Pre generated bundle of Mozilla certificates | `ff029ef6-1a6b-83ba-b531-e397a4c077a6` |
...
| 25 | `/` | `uuidna/alpine-base` | 3.24.2-r0 | Meta package for minimal alpine base | `6f9e6ce0-c595-8f01-981e-c85e0582497c` |
