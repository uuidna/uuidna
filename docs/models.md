...
> public feed** — 446 of them, read live from [openrouter.ai/api/v1/models (public, keyless)](https://openrouter.ai/api/v1/models) at the `src/os`
...
- **Speed**: the public feed publishes no throughput, so this page carries **no speed numbers at all** —
  a column of guesses would be 446 fabricated citations. uuidna's own speed is of a different kind
...
## The census — all 446 public models
...
| `deepseek/deepseek-v4-flash-0731` | 1,310,720 | 10,485,760 | 145,635 | 0.00000004 / 0.00000016 |
| `meta-llama/llama-4-scout` | 1,310,720 | 10,485,760 | 145,635 | 0.0000001 / 0.0000003 |
| `z-ai/glm-5.3` | 1,310,720 | 10,485,760 | 145,635 | 0.00000091 / 0.00000286 |
| `z-ai/glm-5.3-flash` | 1,310,720 | 10,485,760 | 145,635 | 0.00000009 / 0.0000003 |
| `~deepseek/deepseek-v4-flash-latest` | 1,310,720 | 10,485,760 | 145,635 | 0.00000004 / 0.00000016 |
| `~z-ai/glm-flash-latest` | 1,310,720 | 10,485,760 | 145,635 | 0.000000075 / 0.00000025 |
| `~z-ai/glm-latest` | 1,310,720 | 10,485,760 | 145,635 | 0.0000007735 / 0.000002431 |
...
| `deepseek/deepseek-v4-flash` | 1,048,576 | 8,388,608 | 116,508 | 0.000000088606 / 0.000000177212 |
...
| `deepseek/deepseek-v4-pro` | 1,048,576 | 8,388,608 | 116,508 | 0.00000095526 / 0.00000191052 |
| `deepseek/deepseek-v4-pro-0813` | 1,048,576 | 8,388,608 | 116,508 | 0.00000132 / 0.00000396 |
...
| `moonshotai/kimi-k3` | 1,048,576 | 8,388,608 | 116,508 | 0.0000017 / 0.0000085 |
...
| `~deepseek/deepseek-flash-latest` | 1,048,576 | 8,388,608 | 116,508 | 0.00000012 / 0.00000048 |
| `~deepseek/deepseek-pro-latest` | 1,048,576 | 8,388,608 | 116,508 | 0.0000007 / 0.00000288 |
...
| `~moonshotai/kimi-latest` | 1,048,576 | 8,388,608 | 116,508 | 0.0000017 / 0.0000085 |
...
| `qwen/qwen3.8-27b` | 1,000,000 | 8,000,000 | 111,111 | 0.0000002 / 0.0000025 |
...
| `moonshotai/kimi-k2.7-code` | 262,144 | 2,097,152 | 29,127 | 0.0000007062 / 0.00000321 |
...
| `nvidia/nemotron-3-nano-30b-a3b` | 262,144 | 2,097,152 | 29,127 | 0.00000006 / 0.00000024 |
...
| `nvidia/nemotron-3.5-lightning` | 262,144 | 2,097,152 | 29,127 | 0.00000007 / 0.0000002 |
...
| `qwen/qwen3.6-35b-a3b` | 262,144 | 2,097,152 | 29,127 | 0.00000015 / 0.000001 |
| `qwen/qwen3.6-max-preview` | 262,144 | 2,097,152 | 29,127 | 0.000001027 / 0.000006162 |
| `qwen/qwen3.8-27b:free` | 262,144 | 2,097,152 | 29,127 | 0 / 0 |
...
| `mistralai/mistral-small-3.2-24b-instruct` | 256,000 | 2,048,000 | 28,444 | 0.00000009375 / 0.00000025 |
...
| `deepseek/deepseek-chat` | 163,840 | 1,310,720 | 18,204 | 0.00000032 / 0.00000089 |
...
| `ibm-granite/granite-4.2-8b` | 131,072 | 1,048,576 | 14,563 | 0.0000001 / 0.00000015 |
...
| `z-ai/glm-5.2:free` | 32,768 | 262,144 | 3,640 | 0 / 0 |
...
**Census receipt** `c10a2eb1-c592-8faf-8d1e-304868b442c5` — as hexbits `[12, 1, 0, 10, 2, 14, 11, 1, 12, 5, 9, 2, 8, 15, 10, 15, 8, 13, 1, 14, 3, 0, 4, 8, 6, 8, 11, 4, 4, 2, 12, 5]` — recompute it from the same
