...
> public feed** — 422 of them, read live from [openrouter.ai/api/v1/models (public, keyless)](https://openrouter.ai/api/v1/models) at the `src/os`
...
- **Speed**: the public feed publishes no throughput, so this page carries **no speed numbers at all** —
  a column of guesses would be 422 fabricated citations. uuidna's own speed is of a different kind
...
## The census — all 422 public models
...
| `deepseek/deepseek-v4-flash-0731` | 1,310,720 | 10,485,760 | 145,635 | 0.00000008 / 0.00000018 |
| `meta-llama/llama-4-scout` | 1,310,720 | 10,485,760 | 145,635 | 0.0000001 / 0.0000003 |
| `~deepseek/deepseek-v4-flash-latest` | 1,310,720 | 10,485,760 | 145,635 | 0.00000004 / 0.00000013 |
...
| `deepseek/deepseek-v4-flash` | 1,048,576 | 8,388,608 | 116,508 | 0.00000004886 / 0.00000009772 |
| `deepseek/deepseek-v4-flash-vision-exp` | 1,048,576 | 8,388,608 | 116,508 | 0.00000022 / 0.00000066 |
| `deepseek/deepseek-v4-pro` | 1,048,576 | 8,388,608 | 116,508 | 0.000000396894 / 0.000000793788 |
...
| `meta-llama/llama-guard-4-12b` | 1,048,576 | 8,388,608 | 116,508 | 0.00000018 / 0.00000018 |
...
| `~moonshotai/kimi-latest` | 1,048,576 | 8,388,608 | 116,508 | 0.0000026 / 0.000013 |
...
| `qwen/qwen-plus-2025-07-28:thinking` | 1,000,000 | 8,000,000 | 111,111 | 0.00000026 / 0.00000078 |
...
| `qwen/qwen3.8-27b` | 1,000,000 | 8,000,000 | 111,111 | 0.0000004 / 0.000003 |
...
| `google/gemma-4-31b-it` | 262,144 | 2,097,152 | 29,127 | 0.0000001 / 0.00000034 |
| `google/gemma-4-31b-it:free` | 262,144 | 2,097,152 | 29,127 | 0 / 0 |
| `inclusionai/ling-2.6-1t` | 262,144 | 2,097,152 | 29,127 | 0.000000075 / 0.000000625 |
| `inclusionai/ling-2.6-flash` | 262,144 | 2,097,152 | 29,127 | 0.00000001 / 0.00000003 |
| `inclusionai/ling-3.0-flash` | 262,144 | 2,097,152 | 29,127 | 0.000000021 / 0.000000063 |
| `inclusionai/ring-2.6-1t` | 262,144 | 2,097,152 | 29,127 | 0.000000075 / 0.000000625 |
...
| `thinkingmachines/inkling-small:free` | 262,144 | 2,097,152 | 29,127 | 0 / 0 |
| `thinkingmachines/inkling:free` | 262,144 | 2,097,152 | 29,127 | 0 / 0 |
...
| `minimax/minimax-m2.7` | 204,800 | 1,638,400 | 22,755 | 0.00000024 / 0.00000096 |
...
| `google/gemma-3n-e4b-it` | 32,768 | 262,144 | 3,640 | 0.00000006 / 0.00000012 |
...
**Census receipt** `877d8336-c595-8109-b6b2-d4e89b5146dd` — as hexbits `[8, 7, 7, 13, 8, 3, 3, 6, 12, 5, 9, 5, 8, 1, 0, 9, 11, 6, 11, 2, 13, 4, 14, 8, 9, 11, 5, 1, 4, 6, 13, 13]` — recompute it from the same
