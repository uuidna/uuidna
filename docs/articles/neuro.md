...
the decidable ALGEBRA of the textbook model — not clinical, not diagnostic, and not about any individual. The boundary is confirmed by the wing's own sealed theorems — e.g. [all_or_none](/theorem/all_or_none) — never merely denied.
:::
