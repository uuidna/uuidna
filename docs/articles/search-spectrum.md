...
| `42719028` | zenodo.org | zenodo record 17938897: SpiroPlay, a Suite of Breathing Games for Spirometry by Kids & Experts | UNVERIFIED | VERIFIED |
...
**24 findings · 24 usable search-trial combinations · receipt `5b48e0ed`** (fold of every finding's address — recompute by re-running the search).

The sealed backing this trial held the findings beside:

- [wave_product_is_constant](/theorem/wave_product_is_constant) — `2 * 150 = 300 ∧ 4 * 75 = 300`
- [light_speed_rounds_to_300000](/theorem/light_speed_rounds_to_300000) — `300000000 - 299792458 = 207542`
