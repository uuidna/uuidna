...
| `e3dccf4f` | crossref.org | DOI 10.1007/978-3-319-70658-0_82-2: Mathematics and Cultures Across the Chessboard: The Wheat and Chessboard Problem | UNVERIFIED | VERIFIED |
...
**53 findings · 53 usable search-trial combinations · receipt `e07e4139`** (fold of every finding's address — recompute by re-running the search).
