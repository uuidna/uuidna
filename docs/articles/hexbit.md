...
::: warning 
THE HEXBIT — the alphabet and the layout an address is actually built from. The boundary is confirmed by the wing's own sealed theorems — e.g. [the_void_tile_cannot_cross](/theorem/the_void_tile_cannot_cross) — never merely denied.
:::
