...
| `5dd2d0e9` | openalex.org | OpenAlex Algebraic Fermi Liquid from Phase Fluctuations: “Topological” Fermions [Physics of Superconductivity a] | UNVERIFIED | VERIFIED |
| `654b279d` | openalex.org | OpenAlex Isolated optical vortex knots [Orbital Angular Momentum in Op] | UNVERIFIED | VERIFIED |
| `d57eb686` | openalex.org | OpenAlex Algebraic vortex liquid theory of a quantum antiferromagnet on the kag [Advanced Condensed Matter Phys] | UNVERIFIED | VERIFIED |
| `8e0c973d` | openalex.org | OpenAlex Theory of the algebraic vortex liquid in an anisotropic spin- 12 trian [Physics of Superconductivity a] | UNVERIFIED | VERIFIED |
| `c27c6a6c` | openalex.org | OpenAlex Algebraic Vortex Liquid in Spin- 1 / 2 Triangular Antiferromagnets: Sc [Advanced Condensed Matter Phys] | UNVERIFIED | VERIFIED |
| `fae5252a` | openalex.org | OpenAlex Synthesis and Dynamic Switching of Surface Plasmon Vortices with Plasm [Plasmonic and Surface Plasmon ] | UNVERIFIED | VERIFIED |

**24 findings · 24 usable search-trial combinations · receipt `e80ef33f`** (fold of every finding's address — recompute by re-running the search).
...
- [light_faster_than_uuidna](/theorem/light_faster_than_uuidna) — `(299792458 : Nat) > 0 ∧ (List.range 64).all (fun t => 1000 / t < 299792458) -- range 64 IN`
- [division_by_zero](/theorem/division_by_zero) — `(1000 / 0 = 0) ∧ (0 / 0 = 0) -- (a) exists, defined as 0 ∧ (List.range 9).all (fun x => (0`
