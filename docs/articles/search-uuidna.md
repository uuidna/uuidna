---
title: "The search on trial: The vortex algebra"
...
# The search on trial: The vortex algebra

**The quantum search finds; the trial decides; this page is what the trial returned.** Every research source was
asked in parallel about *The vortex algebra* — the wing sealed in [lean/Uuidna.lean](/lean/Uuidna.lean) with **15 theorems**. Each
...
| `b5823929` | crossref.org | DOI 10.28989/vortex.v2i2:  | UNVERIFIED | VERIFIED |
...
| `2b8487f3` | en.wikipedia.org | Wikipedia: Danica McKellar | UNVERIFIED | VERIFIED |
| `5eaf0155` | en.wikipedia.org | Wikipedia: Kaufmann vortex | UNVERIFIED | VERIFIED |
| `f6998dc8` | en.wikipedia.org | Wikipedia: Vertex | UNVERIFIED | VERIFIED |
| `c3f21d63` | en.wikipedia.org | Wikipedia: Eddy (fluid dynamics) | UNVERIFIED | VERIFIED |
| `72dea72a` | en.wikipedia.org | Wikipedia: Computational fluid dynamics | UNVERIFIED | VERIFIED |
| `fe04a508` | en.wikipedia.org | Wikipedia: Entropy-vorticity wave | UNVERIFIED | VERIFIED |
| `326dfd7c` | en.wikipedia.org | Wikipedia: Kutta–Joukowski theorem | UNVERIFIED | VERIFIED |
| `3bed8835` | en.wikipedia.org | Wikipedia: History of knot theory | UNVERIFIED | VERIFIED |
| `00b51b98` | esco | {"source":"esco","address":"77a73ad8-a926-83e3-93af-8218dd014161","uri":"http://data.europa.eu/esco/skill/55e910e4-736d-44cf-bfa9-b15adc5d91d2","title":"algebra","conceptType":"Skill"}
{"source":"esco","address":"c21ca677-42b5-8eac-bf27-8aa9d38eac2e","uri":"http://data.europa.eu/esco/skill/21dfab2e-f954-49ab-8fb6-18cc98cf10bb","title":"geometry","conceptType":"Skill"}
...
{"source":"esco","address":"5745c63a-c9fb-8302-9475-7ab81f0124fd","uri":"http://data.europa.eu/esco/skill/e90c83be-ccb7-4752-af5e-7f58cd0ac399","title":"facilitate the healing process re | UNVERIFIED | VERIFIED |
...
| `1c212b75` | data-europa | {"source":"data-europa","address":"8d5ffe51-b67b-8a7b-b882-6acad4fad62f","id":"f0fd3e45-2da7-5e94-c4d3-e0b2996263c9","title":"Prüm - In the vortex","country":"Germany","catalogue":"gdi-de"}
{"source":"data-europa","address":"9544f128-f88e-8baf-b7f4-cd3497447bdc","id":"https-komserv4gdi-service24-rlp-de-b85cc367-6fbe-9bff-dd2f-81a046ff901b","title":"In the vortex","country":"Germany","catalogue":"govdata"}
{"source":"data-europa","address":"5bba090c-7384-82cb-b453-ecf11351285e","id":"oai-zenodo-org-7319991","title":"Vortex Circular Dichroism experiment at IIT","country":"EU institutions","catalogue":"zenodo"}
{"source":"data-europa","address":"5c4d7185-deb4-8030-b41e-0c13d14dcb78","id":"oai-zenodo-org-8207890","title":"Examples for CGI2023","country":"EU institutions","catalogue":"zenodo"}
 | UNVERIFIED | VERIFIED |
...
**45 findings · 45 usable search-trial combinations · receipt `3318408e`** (fold of every finding's address — recompute by re-running the search).

The sealed backing this trial held the findings beside:

- [units_z9](/theorem/units_z9) — `(List.range 9).filter (fun d => (List.range 9).any (fun e => (d * e) % 9 == 1)) = [1,2,4,5`
- [vortex_orbit](/theorem/vortex_orbit) — `[1, (1*2)%9, (2*2)%9, (4*2)%9, (8*2)%9, (7*2)%9] = [1,2,4,8,7,5] ∧ (5*2) % 9 = 1`
- [mod9_arithmetic](/theorem/mod9_arithmetic) — `(2*5)%9 = 1 ∧ (4*7)%9 = 1 ∧ (8*8)%9 = 1 ∧ (3*3)%9 = 0 ∧ (6*6)%9 = 0 ∧ (List.range 9).all (`
- [digital_root](/theorem/digital_root) — `432 % 9 = 0 ∧ (List.range' 1 60).all (fun n => let r := if n % 9 == 0 then 9 else n % 9; (`
- [diamond_involution](/theorem/diamond_involution) — `(List.range' 1 9).all (fun d => 10 - (10 - d) == d) ∧ ((List.range' 1 9).filter (fun d => `
- [seats_pigeonhole](/theorem/seats_pigeonhole) — `(2:Nat)^8 = 256 ∧ (2:Nat)^0 = 1 ∧ (2:Nat)^10 = 1024`
- [involution_group](/theorem/involution_group) — `sig (sig (3,7)) = (3,7) ∧ tau (tau (3,7)) = (3,7) ∧ kap (kap (3,7)) = (3,7) ∧ sig (kap (3,`
- [ns_spike](/theorem/ns_spike) — `(1*2 < 1*4) ∧ (4 > 2) ∧ (1*4 = 4) ∧ (1*3 < 1*9) ∧ (9 > 3)`
- [ym_quantum](/theorem/ym_quantum) — `(List.range 9).all (fun n => (List.range 12).all (fun k => ¬ (n < k ∧ k < n+1))) ∧ (List.r`
- [hodge_bound](/theorem/hodge_bound) — `((0:Int)+1 = 1) ∧ (∀ c : Int, c ∈ [(-3:Int),-2,-1,0,1,2,3] → ¬ (c*1 = 0 ∧ c*0 = 1 ∧ c*1 = `
- [light_faster_than_uuidna](/theorem/light_faster_than_uuidna) — `(299792458 : Nat) > 0 ∧ (List.range 64).all (fun t => 1000 / t < 299792458) ∧ (1000 / 0 = `
- [division_by_zero](/theorem/division_by_zero) — `(1000 / 0 = 0) ∧ (0 / 0 = 0) ∧ (List.range 9).all (fun x => (0 * x) % 9 != 1) ∧ (List.rang`
- [div_by_zero_is_the_reflection](/theorem/div_by_zero_is_the_reflection) — `divZero 0 = 0 ∧ divZero 9 = 1 ∧ divZero 8 = 2 ∧ divZero 5 = 5 ∧ divZero 1 = 9 ∧ (List.rang`
- [involute_centre](/theorem/involute_centre) — `(List.range 12).all (fun n => ((List.range n).filter (fun i => 2*i + 1 == n)).length = n %`
- [billing_arith](/theorem/billing_arith) — `(1024 - 1 = 1023) ∧ (1000000 - 1 = 999999) ∧ (2 = 1 + 1)`
