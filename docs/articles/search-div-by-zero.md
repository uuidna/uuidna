...
| `d65632ec` | zenodo.org | zenodo record 4304933: My Academic Review  Vacuum Calculations Burden of Proof | UNVERIFIED | VERIFIED |
...
**24 findings · 24 usable search-trial combinations · receipt `f2925e09`** (fold of every finding's address — recompute by re-running the search).
