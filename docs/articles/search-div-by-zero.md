...
**50 findings · 50 usable search-trial combinations · receipt `65789570`** (fold of every finding's address — recompute by re-running the search).
