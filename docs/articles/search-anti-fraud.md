...
| `b4262563` | zenodo.org | zenodo record 13852734: IDNet: A Novel Dataset for Identity Document Analysis and Fraud Detection (part  | UNVERIFIED | VERIFIED |
...
**48 findings · 48 usable search-trial combinations · receipt `b3a4b8dc`** (fold of every finding's address — recompute by re-running the search).
