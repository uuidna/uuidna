...
**40 findings · 40 usable search-trial combinations · receipt `7acc3623`** (fold of every finding's address — recompute by re-running the search).
