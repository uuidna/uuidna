...
asked in parallel about *The measures of type* — the wing sealed in [lean/Typesetting.lean](/lean/Typesetting.lean) with **14 theorems**. Each
...
| `64c9c4d1` | crossref.org | DOI 10.1515/9783112231463-006: 5506 Notes and references | UNVERIFIED | VERIFIED |
...
| `7a298760` | openalex.org | OpenAlex Measuring distinct types of musical self-efficacy [Diverse Music Education Insigh] | UNVERIFIED | VERIFIED |

**24 findings · 24 usable search-trial combinations · receipt `5a91b949`** (fold of every finding's address — recompute by re-running the search).
...
- [readable_measure_range](/theorem/readable_measure_range) — `45 ≤ 66 ∧ 66 ≤ 75`
