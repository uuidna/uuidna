...
| `8f06a709` | openalex.org | OpenAlex Interactive graph cuts for optimal boundary &amp; region segmentation  [Medical Image Segmentation Tec] | UNVERIFIED | VERIFIED |
...
**24 findings · 24 usable search-trial combinations · receipt `b92a8fcd`** (fold of every finding's address — recompute by re-running the search).
...
- [crossfade_overlap](/theorem/crossfade_overlap) — `48 + 48 - 12 = 84`
