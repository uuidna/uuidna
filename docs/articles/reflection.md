...
### SIX IS FORCED. SCOPE: the sequence walk also yields six orbits, and that is a SEPARATE enumeration landing on the same integer. No correspondence between the two sixes is claimed or sealed.
