...
| `97cb24d0` | zenodo.org | zenodo record 2639099: Triangular-Type Selfie Numbers: Reverse Order of Digits | UNVERIFIED | VERIFIED |
...
| `ac1c2fc5` | openalex.org | OpenAlex The BFP (Benford-Fibonacci-Perez) method validates the consistency of  [Benford’s Law and Fraud Detect] | UNVERIFIED | VERIFIED |

**24 findings · 24 usable search-trial combinations · receipt `a76cf71d`** (fold of every finding's address — recompute by re-running the search).
