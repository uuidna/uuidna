...
**8 theorems**, each proven `by decide` in [lean/Acoustics.lean](/lean/Acoustics.lean), axiom-free against the bare Lean kernel. This article is computed from the ledger — nothing here is authored; every claim carries its citation.
...
the arithmetic of sound waves — exact ratios and cycles, not a full acoustics derivation, distinct from the music/432 ladder in BioPhysics.
:::
