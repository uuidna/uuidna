...
asked in parallel about *The energy domain* — the wing sealed in [lean/Thermodynamics.lean](/lean/Thermodynamics.lean) with **8 theorems**. Each
...
**24 findings · 24 usable search-trial combinations · receipt `1f43462f`** (fold of every finding's address — recompute by re-running the search).
