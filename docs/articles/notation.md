...
### THE MODULUS IS CHOSEN BY THE BASE, NOT BY THE NUMBERS: b ≡ 1 (mod b−1) for every base, so base eight gives mod 7, base ten mod 9, hexadecimal mod 15. Three bases, three different rings, one construction.
