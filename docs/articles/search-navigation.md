...
| `d45623d0` | crossref.org | DOI 10.1098/rsos.211800/v1/review2: Review for "A space of goals: the cognitive geometry of informationally bounded  | UNVERIFIED | VERIFIED |
| `852f3300` | semanticscholar.org | S2 Robust Cislunar Navigation via LFT-Based H∞ Filtering with B | UNVERIFIED | VERIFIED |
| `5262a3c0` | semanticscholar.org | S2 Quality-Aware Potential-Based Reward Shaping for Fixed-Wing  | UNVERIFIED | VERIFIED |
| `7c2c79e5` | semanticscholar.org | S2 RI-DVP: A Physics–Geometry Dual-Driven Framework for Static  | UNVERIFIED | VERIFIED |
| `a336cf01` | semanticscholar.org | S2 Spatial Learning by Using Non-Visual Geometry and a Visual 3 — AI tldr: The possibility that multisensory processes affect fish’s reorientation behavior and spati | UNVERIFIED | VERIFIED |
| `8fbeb2df` | semanticscholar.org | S2 Integrity-Based Fault Detection for GNSS Navigation Safety — AI tldr: This work aims to classify a set of received GNSS measurements as safe or unsafe for navig | UNVERIFIED | VERIFIED |
| `8e5d3583` | semanticscholar.org | S2 Selection of electrodes geometry for contactless suspension  | UNVERIFIED | VERIFIED |
| `ac8c3841` | semanticscholar.org | S2 Probability Navigation Function for Stochastic Static Enviro — AI tldr: A new Probability NF is defined that is able to provide a converging trajectory in stochas | UNVERIFIED | VERIFIED |
| `be8bfb27` | semanticscholar.org | S2 Mapping and Localization in Confined Underwater Environments | UNVERIFIED | VERIFIED |
...
**24 findings · 24 usable search-trial combinations · receipt `7e0627da`** (fold of every finding's address — recompute by re-running the search).
