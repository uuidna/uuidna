...
**47 findings · 47 usable search-trial combinations · receipt `8863a057`** (fold of every finding's address — recompute by re-running the search).
