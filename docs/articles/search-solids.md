...
asked in parallel about *The Platonic solids in every dimension* — the wing sealed in [lean/Solids.lean](/lean/Solids.lean) with **12 theorems**. Each
...
**16 findings · 16 usable search-trial combinations · receipt `3e1e1095`** (fold of every finding's address — recompute by re-running the search).
