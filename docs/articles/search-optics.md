...
asked in parallel about *The light domain* — the wing sealed in [lean/Optics.lean](/lean/Optics.lean) with **8 theorems**. Each
...
**32 findings · 32 usable search-trial combinations · receipt `03452b42`** (fold of every finding's address — recompute by re-running the search).

The sealed backing this trial held the findings beside:

- [law_of_reflection](/theorem/law_of_reflection) — `(List.range 181).all (fun a => (180 - (180 - a)) == a)`
...
- [magnification](/theorem/magnification) — `30 / 15 = 2`
- [dispersion_blue_over_red](/theorem/dispersion_blue_over_red) — `151 < 153`
- [tir_needs_denser_source](/theorem/tir_needs_denser_source) — `100 < 150`
