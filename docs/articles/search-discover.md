...
**24 findings · 24 usable search-trial combinations · receipt `8d6e1f3c`** (fold of every finding's address — recompute by re-running the search).

The sealed backing this trial held the findings beside:

- [involution_census_self_explains](/theorem/involution_census_self_explains) — `(29 > 1) ∧ (2 * 2 = 4) ∧ ((-1 : Int) ^ 2 = 1)`
- [happy_ending_verified_cases](/theorem/happy_ending_verified_cases) — `(2 ^ 2 + 1 = 5) ∧ (2 ^ 3 + 1 = 9) ∧ (2 ^ 4 + 1 = 17)`
