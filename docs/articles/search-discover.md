...
**48 findings · 48 usable search-trial combinations · receipt `4495e620`** (fold of every finding's address — recompute by re-running the search).
