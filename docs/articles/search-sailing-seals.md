...
| `4116a12b` | zenodo.org | zenodo record 7513003: gangway statt  Leiter für Yachten im Winter | UNVERIFIED | VERIFIED |
...
**24 findings · 24 usable search-trial combinations · receipt `70c4360b`** (fold of every finding's address — recompute by re-running the search).
