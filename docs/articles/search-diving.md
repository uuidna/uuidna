...
| `382121b3` | openalex.org | OpenAlex The impact of different gas mixtures on inflammatory responses in adva [Cardiovascular and Diving-Rela] | UNVERIFIED | VERIFIED |
...
**24 findings · 24 usable search-trial combinations · receipt `87a92717`** (fold of every finding's address — recompute by re-running the search).
