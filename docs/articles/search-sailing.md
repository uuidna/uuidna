...
asked in parallel about *The points-of-sail domain* — the wing sealed in [lean/Sailing.lean](/lean/Sailing.lean) with **8 theorems**. Each
...
| `dd9aeaf0` | zenodo.org | zenodo record 3406585: The role of domain-specific reference points in life satisfaction | UNVERIFIED | VERIFIED |
| `257ab30d` | zenodo.org | zenodo record 3406594: The role of domain-specific reference points in life satisfaction | UNVERIFIED | VERIFIED |
...
**24 findings · 24 usable search-trial combinations · receipt `3f053a30`** (fold of every finding's address — recompute by re-running the search).
...
- [beating_distance_penalty](/theorem/beating_distance_penalty) — `5 > 3`
- [apparent_wind_exceeds_true](/theorem/apparent_wind_exceeds_true) — `5 > 4`
