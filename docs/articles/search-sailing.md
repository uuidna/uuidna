...
asked in parallel about *The points-of-sail domain* — the wing sealed in [lean/Sailing.lean](/lean/Sailing.lean) with **9 theorems**. Each
...
**24 findings · 24 usable search-trial combinations · receipt `15a1c571`** (fold of every finding's address — recompute by re-running the search).
