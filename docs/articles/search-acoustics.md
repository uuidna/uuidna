...
| `c95c75bd` | zenodo.org | zenodo record 5503994: Preservation Metadata for Software - Describing Software in Archives. | UNVERIFIED | VERIFIED |
...
| `ab959479` | crossref.org | DOI 10.32920/ryerson.14652450: Wind Turbine Sound Propagation Using A Finite-Difference Time-Domain Method | UNVERIFIED | VERIFIED |
...
**24 findings · 24 usable search-trial combinations · receipt `05814d34`** (fold of every finding's address — recompute by re-running the search).
