...
<<<<<<< HEAD
**24 findings · 24 usable search-trial combinations · receipt `fd423afe`** (fold of every finding's address — recompute by re-running the search).
=======
**24 findings · 24 usable search-trial combinations · receipt `8ab178f8`** (fold of every finding's address — recompute by re-running the search).
>>>>>>> origin/main
