...
**40 findings · 40 usable search-trial combinations · receipt `fc7dc4d6`** (fold of every finding's address — recompute by re-running the search).
