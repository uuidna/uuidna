...
asked in parallel about *The two coins & the 64* — the wing sealed in [lean/Coins.lean](/lean/Coins.lean) with **25 theorems**. Each
...
| `634fb7a7` | en.wikipedia.org | Wikipedia: 2 euro commemorative coins | UNVERIFIED | VERIFIED |
...
**54 findings · 54 usable search-trial combinations · receipt `2fb5dea4`** (fold of every finding's address — recompute by re-running the search).
