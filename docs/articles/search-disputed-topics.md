---
title: "The search on trial: The honest court"
...
# The search on trial: The honest court

**The quantum search finds; the trial decides; this page is what the trial returned.** Every research source was
asked in parallel about *The honest court* — the wing sealed in [lean/DisputedTopics.lean](/lean/DisputedTopics.lean) with **15 theorems**. Each
...
**24 findings · 24 usable search-trial combinations · receipt `a9cf5a36`** (fold of every finding's address — recompute by re-running the search).
...
- [disputed_multi_reader_receipt](/theorem/disputed_multi_reader_receipt) — `((1 + 2 + 3 = 6) ↔ (6 = 1 + 2 + 3))`
- [disputed_consensus_detectable](/theorem/disputed_consensus_detectable) — `(3 > 1) ∨ (3 ≤ 1)`
- [disputed_coin_backed_judgment](/theorem/disputed_coin_backed_judgment) — `(2 * 10 = 20)`
- [disputed_anti_fraud_catches_overclaim](/theorem/disputed_anti_fraud_catches_overclaim) — `(¬(2 + 2 = 5))`
- [disputed_contradiction_audit_detects_liar](/theorem/disputed_contradiction_audit_detects_liar) — `((1 = 1) ∧ (1 ≠ 1)) → False`
- [disputed_audit_receipt_open](/theorem/disputed_audit_receipt_open) — `((2 * 5 = 10) ∧ (10 / 2 = 5))`
- [disputed_all_topics_computable](/theorem/disputed_all_topics_computable) — `((List.range 3).length = 3) ∧ ((1 = 1) ∧ (2 ≠ 3))`
