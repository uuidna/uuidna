...
**24 findings · 24 usable search-trial combinations · receipt `e8f1a400`** (fold of every finding's address — recompute by re-running the search).
...
- [fstop_14_rounds_sqrt_two](/theorem/fstop_14_rounds_sqrt_two) — `14 * 14 = 196 ∧ 196 < 200`
