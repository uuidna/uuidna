...
| `15a69c5e` | zenodo.org | zenodo record 8404425: Neutrosophic Inference System (NIS) in Power Electrical  Transformers, Adapted t | UNVERIFIED | VERIFIED |
...
**24 findings · 24 usable search-trial combinations · receipt `3a065e5f`** (fold of every finding's address — recompute by re-running the search).
...
- [manipulation_never_faster](/theorem/manipulation_never_faster) — `(16 < 2^16) ∧ (2 * 16 < 2^16) ∧ (110 - 110 = 0) ∧ (16 < 128)`
