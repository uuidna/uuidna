...
asked in parallel about *The reactions domain* — the wing sealed in [lean/Chemistry.lean](/lean/Chemistry.lean) with **8 theorems**. Each
...
| `833472b0` | crossref.org | DOI 10.1021/jacs.3c03086.s001: Quinone Catalysis Modulates Proton Transfer Reactions in the Membrane Domain of  | UNVERIFIED | VERIFIED |
...
**24 findings · 24 usable search-trial combinations · receipt `5cc7f210`** (fold of every finding's address — recompute by re-running the search).
...
- [ph_plus_poh_14](/theorem/ph_plus_poh_14) — `7 + 7 = 14`
