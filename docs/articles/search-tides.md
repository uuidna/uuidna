...
asked in parallel about *The tides* — the wing sealed in [lean/Tides.lean](/lean/Tides.lean) with **7 theorems**. Each
...
**24 findings · 24 usable search-trial combinations · receipt `7e323af5`** (fold of every finding's address — recompute by re-running the search).
...
- [mid_tide_fastest](/theorem/mid_tide_fastest) — `3 > 1`
