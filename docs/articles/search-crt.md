---
title: "The search on trial: The fused ring"
...
asked in parallel about *The fused ring* — the wing sealed in [lean/Crt.lean](/lean/Crt.lean) with **8 theorems**. Each
...
| `51ea96ea` | crossref.org | DOI 10.1515/iupac.70.0023: Bridged Fused Ring Systems | UNVERIFIED | VERIFIED |
| `16a46791` | crossref.org | DOI 10.1515/iupac.70.0017: Ring Systems Used as Components | UNVERIFIED | VERIFIED |
...
| `957681b0` | openalex.org | OpenAlex The principles, design and applications of fused-ring electron accepto [Organic Electronics and Photov] | UNVERIFIED | VERIFIED |
| `3e5db664` | openalex.org | OpenAlex Fused-Ring Electron Acceptors for Photovoltaics and Beyond [Organic Electronics and Photov] | UNVERIFIED | VERIFIED |
| `d8263b78` | openalex.org | OpenAlex Exploiting Noncovalently Conformational Locking as a Design Strategy f [Organic Electronics and Photov] | UNVERIFIED | VERIFIED |
...
**24 findings · 24 usable search-trial combinations · receipt `7210f121`** (fold of every finding's address — recompute by re-running the search).
...
- [axes_stride_coprime](/theorem/axes_stride_coprime) — `(3 + 3 + 1 = 7) ∧ (Nat.gcd 7 9 = 1) ∧ (7 * 9 = 63) ∧ (63 = 2^6 - 1) ∧ (Nat.gcd 2 8 = 2)`
...
- [the_fused_ring_is_all_ones](/theorem/the_fused_ring_is_all_ones) — `(63 = 32 + 16 + 8 + 4 + 2 + 1) ∧ (64 = 2^6) ∧ (63 < 64)`
