...
| `e23e0033` | openalex.org | OpenAlex Seven-year longitudinal study of the early prediction of reading achie [Diverse Academic Research Area] | UNVERIFIED | VERIFIED |
| `22fd286a` | openalex.org | OpenAlex DEVELOPMENTAL LANGUAGE DELAY FROM THREE TO SEVEN YEARS AND ITS SIGNIFI [Language Development and Disor] | UNVERIFIED | VERIFIED |
| `6a7529ec` | openalex.org | OpenAlex Dimensions of Reading Motivation and Their Relation to Reading Behavio [Psychological and Educational ] | UNVERIFIED | VERIFIED |
| `c56475af` | openalex.org | OpenAlex Dimensions of Children's Motivation for Reading and Their Relations to [Reading and Literacy Developme] | UNVERIFIED | VERIFIED |
| `82cf4443` | openalex.org | OpenAlex Naming-Speed Processes, Timing, and Reading [Reading and Literacy Developme] | UNVERIFIED | VERIFIED |
