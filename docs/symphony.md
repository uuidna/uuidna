...
# The ledger symphony <Badge type="tip" text="opus 93097edc" />
...
<HexbitPlayer :states="[12,13,6,6,11,11,0,5,2,8,10,7,8,9,0,14,10,13,2,12,13,1,8,5,3,3,3,5,14,10,2,13]" :ms="252" />

The finale's thirty-two states are the fold of the entire ledger — 1699 theorems in one
address, `cd66bb05` — the work of the whole tree in nine seconds. When the ledger grows, the
