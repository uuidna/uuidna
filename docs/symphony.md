...
# The ledger symphony <Badge type="tip" text="opus bce7da7a" />
...
## III. Scherzo — the walk <small>(65 chapters dancing · 126 ms)</small>

<HexbitPlayer :states="[5,9,14,13,13,2,4,1,12,6,11,3,15,9,6,10,13,15,0,5,3,14,7,7,1,6,15,5,11,8,8,4,1,13,7,1,3,9,1,8,12,11,9,12,0,5,2,14,5,11,6,13,1,11,6,6,10,5,5,4,15,13,6,9,10]" :ms="126" />

## IV. Finale — the whole <small>(every sealed theorem, one address · 252 ms)</small>

<HexbitPlayer :states="[1,7,15,15,5,3,13,9,3,2,15,5,8,3,11,1,8,14,11,15,4,14,10,0,2,13,13,14,9,0,11,11]" :ms="252" />

The finale's thirty-two states are the fold of the entire ledger — 5124 theorems in one
address, `17ff53d9` — the work of the whole tree in nine seconds. When the ledger grows, the
