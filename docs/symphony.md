...
# The ledger symphony <Badge type="tip" text="opus 6943ab1c" />
...
<HexbitPlayer :states="[2,13,4,12,5,1,12,7,4,11,8,1,8,15,7,14,10,10,3,13,4,12,9,2,3,8,9,6,15,10,3,15]" :ms="252" />

The finale's thirty-two states are the fold of the entire ledger — 70938 theorems in one
address, `2d4c51c7` — the work of the whole tree in nine seconds. When the ledger grows, the
