...
# The ledger symphony <Badge type="tip" text="opus b5fa7de8" />
...
<HexbitPlayer :states="[1,15,4,12,12,13,6,0,10,15,10,14,8,7,1,2,9,2,8,9,5,15,9,2,10,6,5,3,14,0,14,7]" :ms="252" />

The finale's thirty-two states are the fold of the entire ledger — 1701 theorems in one
address, `1f4ccd60` — the work of the whole tree in nine seconds. When the ledger grows, the
