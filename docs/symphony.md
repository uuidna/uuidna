...
# The ledger symphony <Badge type="tip" text="opus 1416d17f" />
...
<HexbitPlayer :states="[1,7,9,13,7,9,10,0,10,2,10,5,8,3,2,14,9,10,5,1,11,15,13,12,4,11,4,3,6,14,2,15]" :ms="252" />

The finale's thirty-two states are the fold of the entire ledger — 1703 theorems in one
address, `179d79a0` — the work of the whole tree in nine seconds. When the ledger grows, the
