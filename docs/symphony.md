...
# The ledger symphony <Badge type="tip" text="opus 0ff2a178" />
...
<HexbitPlayer :states="[12,12,6,4,3,3,4,9,10,3,15,7,8,14,14,1,9,6,3,3,3,12,15,9,14,0,6,4,12,10,2,8]" :ms="252" />

The finale's thirty-two states are the fold of the entire ledger — 71018 theorems in one
address, `cc643349` — the work of the whole tree in nine seconds. When the ledger grows, the
