...
# The ledger symphony <Badge type="tip" text="opus cf188f85" />
...
<HexbitPlayer :states="[5,8,7,11,0,6,9,15,8,7,15,15,8,9,4,13,9,12,7,14,10,3,12,13,9,1,11,9,3,6,7,12]" :ms="252" />

The finale's thirty-two states are the fold of the entire ledger — 1660 theorems in one
address, `587b069f` — the work of the whole tree in nine seconds. When the ledger grows, the
