...
**Theorem:** `Security.lean` (7 theorems, all `by decide`)

Independent layers add bits (64+64=128). Collision costs ~half exponent of preimage.
...
**The Question:** *Can security be mathematically proven, or is it a game of escalation?*
...
[`Security.lean`](../../lean/Security.lean)
