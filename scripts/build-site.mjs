...
import { theorems, runTrial, PRINCIPLES, toUuid, merkleGravity, renderHero, renderTheorem } from '../dist/index.js'
...
const card = (t) => `<div class="fcard" data-p="${escapeHtml(t.principle)}" data-t="${escapeHtml((t.key + ' ' + t.name + ' ' + t.statement).toLowerCase())}">`
