...
test('README and home carry the live Captain PhD magnitudes', () => {
  ...
  assert.match(readme, /## Test proof of work/)
  assert.match(readme, /## Test proof of concept — DNA/)
  assert.match(readme, /## Test proof of work — codon occupancy/)
  assert.match(readme, /## Complete Captain PhD/)
