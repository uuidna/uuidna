...
//
// AND THE LIKELY ANSWER IS THAT THE GPU LOSES. A dispatch costs a buffer write, a submit, and a readback —
// hundreds of microseconds of fixed overhead against 132 ns per element. Below roughly a hundred thousand
// elements the CPU should win outright, and saying so before measuring is the point: the instrument exists to
// settle it, not to flatter the accelerator.
