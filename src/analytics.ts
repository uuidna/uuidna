 ...
 *  no clock, no RNG, no telemetry. Integrity; it measures the ledger. */
export function quantumAnalytics(): QuantumAnalytics {
  ...
  // recomputed collision census — a key or address collision would be an intrusion
  ...
  _cache = {
    ...
    honest:
      ...
      'predictive statistics, NOT inference, NOT observation of any person. It measures the ledger. ' +
