...
export const UNLOCK_ILLUSTRATIONS: readonly { key: string; label: string }[] = [
  ...
  { key: 'digit_polarities_partition_ten', label: 'sequence polarity 4+2+4' },
  { key: 've_pentads_overlap_to_eight', label: 'VE 5∪5 → 8' },
  { key: 'theorems_interact_as_faces', label: 'theorems as clique faces' },
  { key: 'imagine_all_as_clique_faces', label: 'imagine all theorems as forms' },
  { key: 'entanglement_completes_one_at_a_time', label: 'entangle one theorem at a time' },
  { key: 'axes_stride_coprime', label: 'seven axes, fused 63' },
  { key: 'the_fused_ring_is_all_ones', label: 'fused hexbits 32+16+8+4+2+1' },
  { key: 'four_vectors_reach_the_uuid', label: 'entangled in seven vectors' },
  { key: 'gap_is_a_count', label: 'gap is a count' },
  { key: 'rounding_fee_closes_the_cube', label: 'hex cube 16³=4096' },
  { key: 'served_qubit_ceiling', label: '2¹²=4096 served ceiling' },
  { key: 'keplers_harmonic_law', label: 'T²=a³ harmonic law' },
  { key: 'discovery_buys_coverage_never_supply', label: 'discovery buys coverage' },
  { key: 'radial_equals_edge', label: 'VE complete balance r=e' },
  { key: 'lanes_even_on_complete_system', label: 'complete residue even' },
  { key: 'trial_computes_only_with_two_coins', label: 'trial computes iff two coins' },
  { key: 'trinity_edit_is_three', label: 'trinity 1+1+1=3' },
