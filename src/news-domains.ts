...
import { NewsArticle, NewsPortal, FactJudgment, JudgmentVote } from './quantum-news-portal.js'
import { buildNewsPortal, renderPortalSummary, tallyJudgmentVotes, shouldSealFact } from './quantum-news-portal.js'
