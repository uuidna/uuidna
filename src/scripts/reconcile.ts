...
run('node dist/scripts/gen-handle-chunks.js')          // src/handles/** — one file per DISTINCT proven fact (1224, not 1308 keys), sharded by handle; the reusable-algebra storage layer
