...
console.log(`✓ gen-school — ${PRACTICES.length} practices + ${byWing.size} wings + ${CLAY.length} Clay lessons + ${leadsFig.of} leads (${leadsFig.held} held · ${leadsFig.refuted} refuted · ${leadsFig.refused} refused); figures: ${fig.monographs} monographs + ${fig.auras} auras = ${fig.redundant} (${fig.hexbits} hexbits, ${fig.bits} bits)`)
