...
const FACTS = [
  ...
  { key: 'the_grids_minute',
    why: 'THE GRID’S MINUTE: at 60 cycles a second the wave alternates 3600 times a minute — 60·60, the same square that makes the hour of minutes and the minute of seconds; 60 = 2·30 shares the leap-spring day-count wing\'s 30.',
    js: () => 60 * 60 === 3600 && 60 === 2 * 30,
    lean: 'theorem the_grids_minute : (60 * 60 = 3600) \u2227 (60 = 2 * 30) := by decide' },
