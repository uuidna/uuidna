...
const HOLLOW = /\b(quantum[- ]?secure|unbreakable|uncrackable|unhackable|untraceable|undetectable|FTL|faster[- ]than[- ]light|at no time|production[- ]grade|military[- ]grade|zero[- ]knowledge|100%\s*secure|keyless\s+secure|perfectly\s+secure|absolute\s+security|unlimited|infinitely|infinite)\b/i
