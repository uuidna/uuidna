...
// (44.1 k → 22.05 k, the honest ceiling; MIDI is 7-bit (128 notes, 0..127); 16-bit dynamic range is
...
// the involutions of the mix — NOT a DAW, a synth, or a mastering chain. COMPUTE → GENERATE → VERIFY. Integrity.
...
const FACTS = [
  ...
  { key: 'tempo_ms_per_beat',
    ...
    lean: 'theorem tempo_ms_per_beat : (60000 / 120 = 500 ∧ 4 * 500 = 2000) \u2227 (6 % 9 = 6) := by decide' },
  ...
  { key: 'sixteen_bit_dynamic_range',
    ...
    js: () => 6 * 16 === 96,
    lean: 'theorem sixteen_bit_dynamic_range : (6 * 16 = 96) \u2227 (7 % 9 = 7) := by decide' },
