...
const FACTS = [
  ...
  { key: 'four_traditions_count_by_one_rank_rule',
    ...
    lean: 'theorem four_traditions_count_by_one_rank_rule : ((List.range 9).map (fun i => (i % 9 + 1) * 10 ^ (i / 9)) = [1, 2, 3, 4, 5, 6, 7, 8, 9]) \u2227 ((9 % 9 + 1) * 10 ^ (9 / 9) = 10) \u2227 ((18 % 9 + 1) * 10 ^ (18 / 9) = 100) \u2227 ((27 % 9 + 1) * 10 ^ (27 / 9) = 1000) \u2227 (27 = 3 * 9) \u2227 (28 = 3 * 9 + 1) \u2227 (22 < 27) := by decide' },
