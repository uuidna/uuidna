...
// sealed as optimisation_space_is_qubit_dimension and CITED here. the counting
// arithmetic of the mix space — the census's bit layout, and no cryptographic claim.
