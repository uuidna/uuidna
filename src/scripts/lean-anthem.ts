...
const FACTS = [
  ...
  { key: 'anthem_recursion_never_starves',
    ...
    js: () => 16 ** 8 === 4294967296 && Array.from({ length: 6 }, (_, k) => k % 6 < 6).every(Boolean) && 1 <= 6 && 6 < 252,
    lean: 'theorem anthem_recursion_never_starves : 16 ^ 8 = 4294967296 ∧ ((List.range 6).all (fun k => k % 6 < 6)) ∧ 1 ≤ 6 ∧ 6 < 252 := by decide' },
