...
const FACTS = [
  ...
  { key: 'the_concurrency_knob_cannot_close_the_gap', skill: 'site-build',
  ...
  { key: 'the_params_are_not_the_retained_mass', skill: 'site-build',
  ...
  { key: 'the_process_holds_more_than_the_container_allows', skill: 'site-build',
  ...
  { key: 'verify_costs_one_walk_against_the_whole_page_count', skill: 'site-build',
  ...
  { key: 'exponent_associativity_changes_the_value', skill: 'typesetting',
  ...
  { key: 'the_congruence_form_is_the_modulus_form', skill: 'typesetting',
