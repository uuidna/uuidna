...
export const DRAIN_PATHS: readonly string[] = [
  ...
  // candidate leads mined from public-domain texts — proposed by the desk, never sealed; regenerated by the
  // DAILY research cron (network), not by the fast guard, so the cheap gates stay cheap.
  'book-leads.json',
