...
export const DRAIN_PATHS: readonly string[] = [
  ...
  // the run gate's own cache, beside the kernel's: it records which generators did not need to react, so it
  // MOVES while the gate runs and sealing it would seal a value the seal itself invalidates.
  'lean/generator-cache.json',
