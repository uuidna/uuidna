...
export const DRAIN_PATHS: readonly string[] = [
  ...
  'src/tests/falsifiers.generated.test.ts',
  ...
  '.zenodo.json',
  // clay σ-involution publication metadata — workflow job zenodo-clay versions concept 21781602 from this file
  '.zenodo.clay.json',
...
export const RECONCILE_OUTPUTS: Readonly<Record<string, readonly string[]>> = {
  ...
  'gen-zenodo-clay': ['.zenodo.clay.json'],
  ...
  'gen-falsifiers': ['src/tests/falsifiers.generated.test.ts'],
