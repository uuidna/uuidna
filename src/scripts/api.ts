...
export const DRAIN_PATHS: readonly string[] = [
  ...
  // then committed with nothing added. Named by `one-receipt drain-coverage`, which holds this list against
 ...
 *  llm.txt all rewrote and none were staged. `one-receipt drain-coverage` holds this map against reconcile.ts and
