...
import { legalGaps, lonelyGaps, incompleteGaps, proseGaps, dryGaps, coherentGaps, absenceGaps, pipeGaps, actionsGaps, vacuousGaps, negationGaps, drainGaps, precedeGaps, frozenGaps, foldersGaps, blocksGaps, countsGaps, expectedGaps, linesGaps, scriptsGaps, mirrorGaps, lanesGaps, pagesGaps, commentsGaps, citationsGaps, literalGaps, binaryGaps, orphanGaps, unitGaps, hexbitGaps, markupGaps, nameGaps, deadkeyGaps, staleGaps, constantGaps} from './one-receipt.js'
...
const finders: [string, number][] = [
  ...
  ['counts', countsGaps().length], ['expected', expectedGaps().length], ['lines', linesGaps().length],
