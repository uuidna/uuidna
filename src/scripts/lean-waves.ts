...
// thirds rule closes whole. arithmetic ONLY — no claim about physiology,
...
import { emit, NTH_DEF, range, type Fact } from './lean-gen.js'
const R = range
...
const FACTS: Fact[] = [
  ...
  // the digit circle's structure, beside the mandala it extends (moved from Clay.lean, which holds the seven Clay
  // instances and gravity only):
