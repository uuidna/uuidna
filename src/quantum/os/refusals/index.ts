...
export const REFUSAL_FAMILIES: readonly RefusalFamily[] = [
  ...
  {
    kind: 'scope',
    cause: 'is a COMPRESSION CODEC, each its own algorithm and container; a partial one that handled only stored blocks would report success over data it never compressed, which is the failure mode this tree calls worse than none',
    members: ['gzip', 'gunzip', 'zcat', 'gzexe', 'znew', 'zforce', 'uncompress', 'pigz', 'unpigz',
  ...
  },
  {
    ...
    members: ['zgrep', 'zegrep', 'zfgrep', 'zcmp', 'zdiff', 'zless', 'zmore',
