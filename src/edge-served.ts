...
// ledger instead. The site's dead-link check sees only built pages, so it asks this module whether a link it cannot
// find is one of those routes. The answer is read from the ledger: a sealed, pageless key resolves; a typo, a key the
