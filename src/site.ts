...
export const SIDEBAR_CATEGORIES: readonly [string, string[]][] = [
  ...
  ['Fuse it in', ['/school', '/tools', '/terminal', '/mcp', '/chat', '/books', '/guides', '/chess', '/quantum-messaging', '/dimensions']],
...
const LABELS: Readonly<Record<string, string>> = {
  ...
  '/games': 'Games', '/song': 'The song ♪', '/anthem': 'The anthem ♪', '/referrer-song': 'The referrer song ♪', '/school': 'The school', '/tools': 'School tools 🛠', '/reading-room': 'Reading room 📖', '/apps': 'The app store ◆', '/open-questions': 'Open questions ◯', '/terminal': 'The terminal ⌨', '/mcp': 'MCP tools', '/chat': 'Chat', '/books': 'Books',
