...
const LABELS: Readonly<Record<string, string>> = {
  ...
  '/games': 'Games', '/song': 'The song ♪', '/anthem': 'The anthem ♪', '/referrer-song': 'The referrer song ♪', '/school': 'The school', '/store': 'The store 🛍', '/tools': 'School tools 🛠', '/reading-room': 'Reading room 📖', '/apps': 'The app store ◆', '/open-questions': 'Open questions ◯', '/terminal': 'The terminal ⌨', '/mcp': 'MCP tools', '/chat': 'Chat', '/books': 'Books',
