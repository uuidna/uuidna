...
import {
  ...
  THEOREMS, runTrial, theorems, theoremNeighbours, credits, creditsSummary, skillGroups, reviewDomains,
...
const TOOLS: Tool[] = [
  ...
  { name: 'uuidna_credits_summary',
    description: 'The recomputable credit tally over the whole ledger: how many theorems reflect a named historical result vs how many the captain claims by law (elementary decidable facts with no prior discoverer, first sealed by-decide here). Returns {total,historical,captainClaimed,address}.',
    inputSchema: { type: 'object', properties: {} },
    run: () => creditsSummary() },
