...
import {
  ...
  auditText, auditTranslation, auditBook, bookArticle, auditMovie, auditZenodo, beaconAnchor, nistConstant, auditCve,
  corroborateWithResearch,
  gcdInt, starPolygon, fibonacciCycle, rotate, crt, recomputableCost, securityAudit,
