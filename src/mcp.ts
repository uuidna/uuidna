...
import { schoolApiRegistry, schoolApiFetch, mapSkillsToEsco, pairEducationToJobs } from './school-apis.js' // the European education APIs behind one door — ESCO / Eurostat / GISCO fetched, OOAPI served
...
const TOOLS: Tool[] = [
  ...
  { name: 'uuidna_school_apis',
    ...
    inputSchema: { type: 'object', properties: {
      source: { type: 'string', description: 'omit for the registry, or one of: esco, eurostat, gisco' },
      map: { type: 'boolean', description: 'map every uuidna skill cluster onto the European skill taxonomy' },
