...
const TOOLS: Tool[] = [
  ...
  { name: 'uuidna_quantum_message',
    ...
    run: async (a) => { const { encodeMessage } = await import('./quantum/message.js'); return encodeMessage(String(a.plaintext), String(a.theoremKey)) } },
  { name: 'uuidna_theorem_message',
    ...
    run: async (a = {}) => { const m = await import('./quantum/message.js'); return a.key ? m.theoremMessage(String(a.key)) : m.messagingSeal() } },
  ...
  { name: 'uuidna_quantum_voting',
    ...
    run: async (a) => { const { tallyVotes, signCommitWithVoting, serializeCommitWithVoting } = await import('./quantum/voting.js'); const voting = tallyVotes((a.votes as any[]).map(v => ({ voterId: String(v.voterId), decision: Boolean(v.decision), weight: Number(v.weight) })), String(a.proposal)); const commit = signCommitWithVoting('quantum voting tally', [], voting, String(a.theoremProof)); return serializeCommitWithVoting(commit) } },
  { name: 'uuidna_agent_contribute',
    ...
    run: async (a) => { const { agentContribute } = await import('./quantum/voting.js'); return agentContribute(String(a.workAddress), String(a.theoremCited)) } },
  { name: 'uuidna_rights',
