...
// crossref — a DOI RESOLVED rather than trusted. The witness leg is granted by a keyword roster over text, so a// string containing "DOI" earns the scarcest leg in the ledger without a source behind it. This resolves it.export { doisIn, crossrefUrl, parseCrossref, verifyCitations, type Citation, type CitationCheck, type CitationReport } from './crossref.js'
