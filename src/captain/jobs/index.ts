...
const JOBS: CoinJob[] = [
  ...
  { n: 3, job: 'measure leverage', claim: 'contribute 2, save up to 64 bits of recompute; the bill can never go negative', cites: ['captain_theorem', 'bill_never_negative'] },
  { n: 4, job: 'take the commission', claim: '2 per 110 bits, 108 delivered net; commercially the passenger still saves while the captain earns', cites: ['captain_theorem', 'captain_theorem'] },
