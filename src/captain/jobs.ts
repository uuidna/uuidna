...
const JOBS: CoinJob[] = [
  ...
  { n: 7, job: 'be topology, not treasure', claim: 'the 2 is the negative Euler characteristic of the double torus, the same 2 the dodecahedron computes', cites: ['two_coins_is_double_torus', 'euler_two_is_the_two_coins'] },
