...
import { hmac as nobleHmac } from './hmac.js';
...
import { getMinHashLength, invertCt, mapHashToField, type IField } from './modular.js';
...
export { DER, DERErr, type IDER } from './der.js';
...
export function _splitEndoScalar(k: bigint, basis: EndoBasis, n: bigint): ScalarEndoParts {
  ...
  const MAX_NUM = bitMask(iceilDiv(bitLen(n), 2)) + _1n; // Half bits of N
 ...
 *
 * ```ts
 * import { ecdh } from './weierstrass.js';
...
export function ecdh(
  ...
  const lengths = Object.assign(getWLengths(Point.Fp, Fn), {
    seed: imax(getMinHashLength(Fn.ORDER), 16),
  });
 ...
 *
 * ```ts
 * import { ecdsa } from './weierstrass.js';
 * import { p256 } from '@noble/curves/nist.js';
