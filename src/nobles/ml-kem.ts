...
import { sha3_256, sha3_512, shake256 } from './sha3.js';
import { type CHash, swap32IfBE, u32 } from './hash-utils.js';
import { genCrystals, type XOF, XOF128 } from './crystals.js';
import {
  abytes,
  cleanBytes,
  type Coder,
 ...
 * @example
 * Generate deterministic ML-KEM level-512 keypairs, encapsulate a shared secret, and decapsulate it.
 * ```ts
