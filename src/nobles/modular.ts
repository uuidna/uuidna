...
import { iceilDiv, imax } from './imath.js';
import {
  aarray,
  abool,
  abytes,
 ...
 *
 * ```ts
 * import { Field, tonelliShanks } from './modular.js';
 * const Fp = Field(17n);
 ...
 *
 * ```ts
 * import { Field, FpSqrt } from './modular.js';
 * const Fp = Field(17n);
 ...
 *
 * ```ts
 * import { Field, validateField } from './modular.js';
 ...
 *
 * ```ts
 * import { Field, FpPow } from './modular.js';
 * const Fp = Field(17n);
 ...
 *
 * ```ts
 * import { Field, FpInvertBatch } from './modular.js';
 * const Fp = Field(17n);
 ...
 *
 * ```ts
 * import { Field, FpDiv } from './modular.js';
 * const Fp = Field(17n);
 ...
 *
 * ```ts
 * import { Field, FpLegendre } from './modular.js';
 * const Fp = Field(17n);
 ...
 *
 * ```ts
 * import { Field, FpIsSquare } from './modular.js';
 * const Fp = Field(17n);
...
export function nLength(n: bigint, nBitLength?: number): NLength {
  ...
  const nByteLength = iceilDiv(_nBitLength, 8);
 ...
 *
 * ```ts
 * import { Field, FpSqrtOdd } from './modular.js';
 * const Fp = Field(17n);
 ...
 *
 * ```ts
 * import { Field, FpSqrtEven } from './modular.js';
 * const Fp = Field(17n);
...
export function getMinHashLength(fieldOrder: bigint): number {
  ...
  return length + iceilDiv(length, 2);
}
...
export function mapHashToField(
  ...
  const minLen = imax(getMinHashLength(fieldOrder), 16);
