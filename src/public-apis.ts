// public-apis — ONE CATALOG of every keyless public door this repo names, probes, or sweeps.
// Research streams live in corroborate.ts; EU education in school-apis.ts; weather and news have their own
// fetchers — this module LISTS them without copying endpoints, so a surface that says "how many APIs" reads here.
import { merkleGravity } from './gravity/index.js'
import { toUuid } from './address.js'
import { hexbitDoorOf } from './hexbit/index.js'
import { RESEARCH_SOURCE_NAMES } from './corroborate.js'
import { EXTENDED_RESEARCH_PROBES } from './research-sources.js'
import { SCHOOL_APIS, schoolApiRegistry } from './school-apis.js'
...
export interface PublicApiEntry {
  ...
  sweep: boolean       // fan-out in researchSweep
  heartbeat: boolean   // daily probe script asks it
  probe?: { query: string }
  honest: string
}
