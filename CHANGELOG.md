...
<!-- LEDGER:TODAY -->Today: **2497 distinct** (2580 keys, 83 deliberate re-namings), across 115 principles.<!-- /LEDGER:TODAY -->
...
<!-- LEDGER:CURRENT -->Ledger: **2497 distinct propositions** under **2580 keys** (83 re-namings — a statement sealed in two wings is one theorem with two names) across **115 principles**, folded to receipt `bf61b25a-75f8-8fec-8296-de00c6299558`<!-- /LEDGER:CURRENT -->
