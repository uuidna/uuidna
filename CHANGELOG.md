...
<!-- LEDGER:TODAY -->Today: **2572 distinct** (2655 keys, 83 deliberate re-namings), across 118 principles.<!-- /LEDGER:TODAY -->
...
<!-- LEDGER:CURRENT -->Ledger: **2572 distinct propositions** under **2655 keys** (83 re-namings — a statement sealed in two wings is one theorem with two names) across **118 principles**, folded to receipt `6e17bce6-e478-8ddb-bb2e-720789c93df1`<!-- /LEDGER:CURRENT -->
