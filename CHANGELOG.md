...
<!-- LEDGER:TODAY -->Today: **2437 distinct** (2520 keys, 83 deliberate re-namings), across 115 principles.<!-- /LEDGER:TODAY -->
...
<!-- LEDGER:CURRENT -->Ledger: **2437 distinct propositions** under **2520 keys** (83 re-namings — a statement sealed in two wings is one theorem with two names) across **115 principles**, folded to receipt `122b0af8-dd67-8d9f-aff4-8c5cc789c460`<!-- /LEDGER:CURRENT -->
