...
<!-- LEDGER:TODAY -->Today: **2436 distinct** (2519 keys, 83 deliberate re-namings), across 115 principles.<!-- /LEDGER:TODAY -->
...
<!-- LEDGER:CURRENT -->Ledger: **2436 distinct propositions** under **2519 keys** (83 re-namings — a statement sealed in two wings is one theorem with two names) across **115 principles**, folded to receipt `394f7e5b-23ac-8a22-967c-10873580f39e`<!-- /LEDGER:CURRENT -->
