...
<!-- LEDGER:TODAY -->Today: **2441 distinct** (2524 keys, 83 deliberate re-namings), across 115 principles.<!-- /LEDGER:TODAY -->
...
<!-- LEDGER:CURRENT -->Ledger: **2441 distinct propositions** under **2524 keys** (83 re-namings — a statement sealed in two wings is one theorem with two names) across **115 principles**, folded to receipt `add2b10f-4817-824b-8f2a-c071e9580128`<!-- /LEDGER:CURRENT -->
